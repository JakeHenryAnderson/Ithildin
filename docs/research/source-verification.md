...
- v0.2 review should start from `docs/codex/v0.2-review-response-and-rc-cleanup.md`,
  ...
  `make release-packet` outputs. `make signed-evidence-demo` and `make review-packet-bundle`
  package the expected handoff files and non-production local signing demo summary.
