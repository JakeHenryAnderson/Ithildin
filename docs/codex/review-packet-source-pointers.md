...
| Signed evidence | `packages/audit-core/src/ithildin_audit_core/signing.py`, `apps/api/src/ithildin_api/app.py`, `apps/api/src/ithildin_api/manifest_lock.py` | local Ed25519 bundle verification, signed audit export routes, and optional signed manifest-lock enforcement |
