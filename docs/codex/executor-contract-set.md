...
| HTTP fetch | `http.fetch` | [http-executor-contract.md](http-executor-contract.md) | `apps/api/src/ithildin_api/http_tools.py`; `HttpFetchExecutor.fetch` | `tests/fixtures/http_canonicalization_corpus.json`; `tests/test_http_tools.py`; `tests/test_security_regressions.py` |
