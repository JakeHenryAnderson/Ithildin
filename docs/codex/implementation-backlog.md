...
| 229 - Review console internal proxy remediation | Done | `SUB-078` and `SUB-079` fixed approval-time binding review and patch diagnostics detail; `SUB-080` records the low deferred frontend interaction-test harness. GPT 5.5 Pro later closed the review-console/admin lane for local-preview only. |
