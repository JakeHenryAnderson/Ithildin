...
| 326 - Enterprise response normalization coverage | Done | [enterprise-response-normalization-coverage.md](enterprise-response-normalization-coverage.md), `make enterprise-response-normalization-coverage` |
| 327 - Enterprise all-lane response inbox | Done | [enterprise-response-inbox.md](enterprise-response-inbox.md), `make enterprise-response-inbox` |
| 328 - Enterprise response intake drill | Done | [enterprise-response-intake-drill.md](enterprise-response-intake-drill.md), `make enterprise-response-intake-drill` |
...
| 291A - Live demo Compose smoke evidence | Done | `make live-demo-compose-smoke-evidence`; records optional Docker Compose smoke posture without starting services or granting Docker authority to Ithildin. |
...
| 310 - Read-only project intelligence consolidation | Done | [read-only-project-intelligence.md](read-only-project-intelligence.md), `make read-only-project-intelligence`; records the eleven-tool project intelligence slice and preserves no-new-powers boundaries. |
...
| 313 - project.structure.summary implementation decision | Done | [v3-project-structure-summary-implementation.md](v3-project-structure-summary-implementation.md), `make project-structure-summary-implementation-gate`; records the bounded read-only runtime implementation boundary. |
...
| 318 - project.test.summary implementation decision | Done | [v3-project-test-summary-implementation.md](v3-project-test-summary-implementation.md), `make project-test-summary-implementation-gate`; records the bounded read-only runtime implementation boundary. |
| 319 - project.test.summary implementation and source-review handoff | Done | `project.test.summary` is implemented as a bounded read-only local project test-layout count tool with no test file names, test case names, raw paths, file contents, coverage data, command output, package-manager execution, registry/network access, test execution, or broad filesystem powers; [v3-project-test-summary-source-review.md](v3-project-test-summary-source-review.md), `make project-test-summary-source-review-bundle` prepares the focused handoff. |
| 320 - project.docs.summary design selection | Done | [v3-project-docs-summary-selection.md](v3-project-docs-summary-selection.md), [capability-proposals/project-docs-summary.md](capability-proposals/project-docs-summary.md), `make project-docs-summary-proposal-check`; design-only, implementation blocked. |
| 321 - project.docs.summary implementation plan | Done | [capability-implementation-plans/project-docs-summary.md](capability-implementation-plans/project-docs-summary.md), `make project-docs-summary-implementation-plan-check`; implementation-planning only, runtime blocked. |
| 322 - project.docs.summary implementation decision | Done | [v3-project-docs-summary-implementation.md](v3-project-docs-summary-implementation.md), `make project-docs-summary-implementation-gate`; records the bounded read-only runtime implementation boundary. |
| 323 - project.docs.summary implementation and source-review handoff | Done | `project.docs.summary` is implemented as a bounded read-only local project documentation count tool with no documentation file names, headings, raw paths, file contents, documentation build execution, command output, package-manager execution, registry/network access, or broad filesystem powers; [v3-project-docs-summary-source-review.md](v3-project-docs-summary-source-review.md), `make project-docs-summary-source-review-bundle` prepares the focused handoff. |
...
| Task | Status | Spec |
| --- | --- | --- |
| 305 - v3 next capability candidate evaluation 2 refresh | Done | [v3-next-capability-candidate-evaluation-2.md](v3-next-capability-candidate-evaluation-2.md), `make next-capability-candidate-evaluation-2-check`; historical selection for `project.release.summary`; no next candidate is currently selected. |
| 306 - project.release.summary proposal | Done | [capability-proposals/project-release-summary.md](capability-proposals/project-release-summary.md), `make project-release-summary-proposal-check`; historical proposal that preceded runtime implementation. |
| 307 - project.release.summary implementation plan | Done | [capability-implementation-plans/project-release-summary.md](capability-implementation-plans/project-release-summary.md), `make project-release-summary-implementation-plan-check`; historical implementation-planning packet retained as boundary evidence. |
| 308 - project.release.summary fixture plan | Done | [project-release-summary-fixture-plan.md](project-release-summary-fixture-plan.md), `make project-release-summary-preimplementation-check`; retained fixture/test contract for the implemented runtime tool. |
| 309 - project.release.summary design review packet | Done | `make project-release-summary-design-review-packet`; generates the historical release-summary design-review packet. |
| 310 - project.release.summary implementation decision | Done | [v3-project-release-summary-implementation.md](v3-project-release-summary-implementation.md), `make project-release-summary-implementation-gate`; records the approved implemented limited read-only boundary. |
| 311 - project.release.summary implementation gate | Done | `make project-release-summary-implementation-gate`; validates the implemented bounded read-only runtime wiring. |
...
| 315 - project.risk.summary selection | Done | [v3-project-risk-summary-selection.md](v3-project-risk-summary-selection.md), `make project-risk-summary-proposal-check`; historical risk-signal count metadata selection. |
...
| 317 - project.risk.summary implementation plan | Done | [capability-implementation-plans/project-risk-summary.md](capability-implementation-plans/project-risk-summary.md), `make project-risk-summary-implementation-plan-check`; historical implementation-planning packet retained as boundary evidence. |
| 318 - project.risk.summary design review packet | Done | `make project-risk-summary-design-review-packet`; generates the historical design-review packet for the selected candidate. |
| 319 - project.risk.summary implementation boundary | Done | [v3-project-risk-summary-implementation.md](v3-project-risk-summary-implementation.md), `make project-risk-summary-implementation-gate`; validates the implemented bounded read-only runtime wiring. |
| 320 - project.risk.summary fixture contract | Done | [project-risk-summary-fixture-plan.md](project-risk-summary-fixture-plan.md), `make project-risk-summary-preimplementation-check`; retains fixture scenarios and strict non-leak assertions for the implemented tool. |
| 321 - project.risk.summary review handoff skeleton | Done | [v3-project-risk-summary-source-review.md](v3-project-risk-summary-source-review.md), [project-risk-summary-negative-transcripts.md](project-risk-summary-negative-transcripts.md), `make project-risk-summary-review-handoff-check`; records source-review and negative transcript expectations for the implemented tool without claiming external closure. |
