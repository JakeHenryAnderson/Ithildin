...
| --- | --- | --- | --- | --- | --- |
| `PRD-MC-DISPLAY-001` | Mission Control display importer continuation | `approved_for_planning` | Prepare display-only schema, packet, static fixtures, and source-review handoff; include `mission-control-integration-implementation-ticket.md` before Mission Control-side implementation | `false` | Mission Control-side review packet, `mission-control-integration-implementation-ticket.md`, and implementation plan before runtime importer work |
