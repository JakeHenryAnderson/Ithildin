...
- `make project-release-summary-review-handoff-check` records the future source-review handoff,
  and `make project-release-summary-source-review-bundle` will package the future preimplementation
  review packet without pretending runtime source exists.
...
selection and planning. Runtime implementation remains absent. Its future source-review handoff is
[v3 project.release.summary Source Review Handoff](v3-project-release-summary-source-review.md)
and is checked with `make project-release-summary-review-handoff-check`. Its future source-review
