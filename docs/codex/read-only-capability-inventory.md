...
| `project.risk.summary` | project metadata | `read` | `project_risk` | `make project-risk-summary-implementation-gate`; `make project-risk-summary-source-review-bundle` |
...
| `project.risk.summary` | bounded read-only project risk-posture count metadata | `project_risk` | `make project-risk-summary-implementation-gate` | `make project-risk-summary-source-review-bundle` | source-review handoff prepared; reviewer intake still required for `EXT-RISK-SUMMARY-###` closure |
