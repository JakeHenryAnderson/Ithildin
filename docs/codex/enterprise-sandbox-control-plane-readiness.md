...
| `ERG-005` Trusted-host artifact promotion | `ready_for_limited_runtime_implementation_plan` | `trusted-host-promotion-source-review.md`, `trusted-host-promotion-disposition-packet.md`, `trusted-host-promotion-response-kit.md`, `trusted-host-promotion-disposition-closure-gate.md`, `trusted-host-promotion-response-dry-run.md`, `v3-trusted-host-promotion-internal-review.md`, `trusted-host-promotion-decision-record.md`, `trusted-host-promotion-implementation-gate-decision.md` | A future limited runtime implementation plan may be drafted after the previous `ready_for_implementation_planning_only` state; runtime trusted-host promotion, direct host writes, automatic promotion, and new powers remain blocked |
