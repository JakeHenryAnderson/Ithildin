...
| Policy preview/impact | Pass 1 complete; Task 096 parity harness added | Pending Wave 4 | Pending external review | None | No blocking finding open | Task 096 preview/runtime parity fixtures compare preview decision evidence with runtime `policy.evaluated` audit metadata; Task 097 OPA-positioning evidence remains pending |
