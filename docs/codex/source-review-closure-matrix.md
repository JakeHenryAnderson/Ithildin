...
| --- | --- | --- | --- | --- | --- | --- |
| `fs.read` | Pass 1 complete; Task 090 adversarial race harness added; pending contract enforcement | Pending Wave 2 | Pending external review | ISR-002 | No blocking finding open | Task 080 contract/check evidence; Task 090 symlink/hardlink swap coverage; future Task 091 contract enforcement evidence |
| `fs.patch.propose` | Pass 1 complete; Task 090 adversarial race harness added; pending contract enforcement | Pending Wave 2 | Pending external review | ISR-002 | No blocking finding open | Task 080 contract/check evidence; Task 090 symlink/hardlink swap coverage; future Task 091 contract enforcement evidence |
