...
| `http.fetch` | Pass 1 complete; Task 092 canonicalization suite and Task 093 executor contract added | Wave 3 subagent review complete | Pending external review | SUB-001 | High deferred finding recorded | Task 092 malformed port, obfuscated IP, IPv4-mapped IPv6, redirect allowlist coverage; Task 093 HTTP executor contract; SUB-001 records unresolved connect-time DNS pinning limitation |
