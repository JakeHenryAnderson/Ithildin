...
| `http.fetch` | Pass 1 complete; Task 092 canonicalization suite and Task 093 executor contract added | Wave 3 subagent review complete | Pending external review | SUB-001 | No blocking finding open | Task 092 malformed port, obfuscated IP, IPv4-mapped IPv6, redirect allowlist coverage; Task 093 HTTP executor contract; SUB-001 fixed internally by default pinned transport, unpinned transport rejection, and exact default scheme/port allowlist semantics; external/source review still pending |
| Audit export/signing | Pass 1 complete; Task 094 replay/substitution tests and Task 095 evidence versioning added | Wave 3 subagent review complete; Task 107 adversarial suite added | Pending external review | None | No blocking finding open | Task 094 wrong trusted public key and reordered-event substitution tests; trusted-public-key requirement; Task 095 evidence-contract versioning; Task 107 invalid-row, missing-row, duplicate-export, malformed-signature, and diagnostics coverage |
| Manifest-lock verification | Pass 1 complete; Task 094 replay/substitution tests and Task 095 evidence versioning added | Wave 3 subagent review complete; Task 105 validation suite added | Pending external review | None | No blocking finding open | Task 094 signature replay against different lock path; trusted-public-key requirement; Task 095 evidence-contract versioning; Task 105 manifest/lock negative validation suite |
...
| Review console evidence | v0.4 Task 139 grouped approval binding evidence UX complete | pending external review | none | pending | UI typecheck/build; `make release-check` | local admin UI is not production auth | external_pending |
