...
| `ERG-004` live-POC runtime implementation-gate prep | active resume checkpoint | yes | `make sandbox-vm-live-poc-runtime-ticket-internal-review-check`, `make sandbox-vm-live-poc-runtime-implementation-gate-check`, `make sandbox-vm-live-poc-runtime-descriptor-contract-check`, `make sandbox-vm-live-poc-runtime-descriptor-contract-internal-review-check`, `make sandbox-vm-live-poc-runtime-gate-readiness-review-bundle-check`, `make sandbox-vm-live-poc-runtime-gate-readiness-response-intake-check`, `make sandbox-vm-live-poc-runtime-gate-readiness-response-dry-run`, `make sandbox-vm-live-poc-runtime-gate-readiness-decision-record-skeleton-check` |
