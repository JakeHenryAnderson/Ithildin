...
| `ERG-005` trusted-host promotion review | active resume checkpoint | yes | `make trusted-host-promotion-decision-intake-check`, `make trusted-host-promotion-state-machine-check`, `make trusted-host-promotion-negative-fixtures-check`, `make trusted-host-promotion-zone-contract-check`, `make trusted-host-promotion-implementation-plan-check`, `make trusted-host-promotion-source-review-packet-check`, `make trusted-host-promotion-disposition-packet-check`, `make trusted-host-promotion-external-review-bundle-check`, `make trusted-host-promotion-response-kit-check`, `make no-new-powers-guardrail`, `make tool-surface-invariant-gate` |
