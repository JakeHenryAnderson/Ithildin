...
| `ERG-004` live-POC decision prep | active resume checkpoint | yes | `make sandbox-vm-live-poc-decision-packet-check`, `make sandbox-vm-live-poc-external-review-bundle-check` |
