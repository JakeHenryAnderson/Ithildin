...
The operator should prepare the separate PIS-002 entry decision record under the cleared PIS-001
contract. PIS-002 implementation and all dependency/runtime authority remain false.
...
not approve dependency changes, PIS-002 implementation, production identity, enterprise RBAC, remote
