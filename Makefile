...
.PHONY: accepted-risk-register-check admin-token-generate adversarial-corpus-check agent-run-correlation-packet agent-run-correlation-smoke agent-run-evidence-contract-check agent-run-evidence-export-check agent-run-evidence-export-implementation-gate agent-run-evidence-export-plan-check agent-run-evidence-packet agent-run-evidence-readiness agent-run-operations-readiness agent-run-timeline-packet agent-run-timeline-readiness audit-diagnostics audit-export-verify audit-keygen capability-decision-report capability-expansion-gate clean closure-matrix-evidence-sync compose-config compose-down compose-logs compose-smoke compose-up control-mapping-design-check control-mapping-readiness dashboard-evidence-checklist-check data-classification-design-check demo-evidence-packet demo-evidence-readiness demo-flow demo-flow-readiness demo-flow-result-check demo-observed-summary demo-operator-walkthrough demo-readiness-summary demo-reset-guide demo-scenario-pack demo-seed demo-workbench demo-workbench-smoke determinism-check docs-site evidence-confusion-gate evidence-contracts-check external-findings-intake-dry-run external-response-normalize external-response-template-check external-review-closure-gate filesystem-contract-check filesystem-source-review-bundle git-commit-metadata-implementation-gate git-commit-metadata-implementation-plan-check git-commit-metadata-proposal-check git-commit-metadata-source-review-bundle git-ref-summary-implementation-gate git-ref-summary-implementation-plan-check git-ref-summary-proposal-check git-ref-summary-source-review-bundle http-fetch-source-review-bundle incident-reconstruction-check internal-review-packet lint live-demo-evidence-summary live-demo-packet live-demo-preflight live-demo-smoke live-demo-status local-model-demo local-prompt-triage mcp-ingress-source-review-bundle mcp-inspector-recipes manifest-change-review manifest-lock manifest-lock-check manifest-lock-keygen manifest-lock-sign manifest-lock-signature-check negative-review-transcripts next-capability-readiness no-new-powers-guardrail observability-control-packet observability-readiness ollama-smoke operator-action-states-check operator-sandbox-dashboard-checklist operator-sandbox-demo-packet operator-sandbox-demo-readiness operator-sandbox-demo-smoke packet-redaction-scan policy-parity policy-registry-source-review-bundle policy-test project-dependency-summary-design-review-packet project-dependency-summary-implementation-gate project-dependency-summary-implementation-plan-check project-dependency-summary-proposal-check project-dependency-summary-source-review-bundle project-manifest-summary-implementation-gate project-manifest-summary-implementation-plan-check project-manifest-summary-proposal-check project-manifest-summary-source-review-bundle project-structure-summary-design-review-packet project-structure-summary-implementation-gate project-structure-summary-implementation-plan-check project-structure-summary-proposal-check project-structure-summary-source-review-bundle project-test-summary-design-review-packet project-test-summary-proposal-check read-only-capability-inventory-gate read-only-metadata-capability-check read-only-project-intelligence release-automation-source-review-bundle release-check release-context release-evidence release-evidence-gate release-evidence-validate release-guardrails release-packet resource-limit-check review-candidate review-console-source-review-bundle review-findings-summary review-findings-summary-write review-packet-bundle review-packet-consolidated review-packet-diff review-packet-diff-gate review-packet-source-pointers review-run-manifest-check reviewer-artifact-manifest reviewer-findings-check siem-evidence-design-check signed-evidence-demo signed-evidence-demo-verify signed-evidence-source-review-bundle source-review-transcript-packet test tool-surface-invariant-gate typecheck ui-dev ui-test v04-review-packet v05-boundary-decision-draft-check v05-handoff-packet-check v05-review-candidate v05-threat-model-delta-check v06-closure-readiness v06-final-handoff v06-lane-status v06-lane-status-write v06-patch-apply-review-packet v06-review-dispatch-packets v07-closure-prep v07-patch-apply-recheck-prep v08-capability-design-gate v08-final-decision-packet v08-public-preview-decision v08-status-reconciliation v09-design-only-gate v09-design-review-packet v3-next-capability-candidate-check workbench-evidence-packet workbench-readiness
