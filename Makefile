...
.PHONY: governed-artifact-transfer-lab governed-artifact-transfer-lab-check governed-artifact-transfer-stage2 governed-artifact-transfer-stage2-check hello-world-sandbox-demo-packet hello-world-sandbox-demo-packet-check hello-world-sandbox-demo-check sandbox-artifact-observed-demo sandbox-artifact-observed-demo-check sandbox-artifact-write-text-preimplementation-check sandbox-artifact-write-text-implementation-gate sandbox-artifact-write-text-negative-transcripts sandbox-artifact-write-text-source-review-bundle
