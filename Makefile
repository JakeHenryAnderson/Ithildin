...
.PHONY: sandbox-vm-static-preflight-response-dry-run sandbox-vm-static-preflight-triage-update-check sandbox-vm-static-preflight-response-application-record-check sandbox-vm-static-preflight-disposition-record-skeleton-check sandbox-vm-static-preflight-external-review-bundle sandbox-vm-static-preflight-external-review-bundle-check
