...
.PHONY: sandbox-vm-live-poc-preconditions-ready-check sandbox-vm-live-poc-post-erg003-handoff-check sandbox-vm-live-poc-decision-closure-check sandbox-vm-live-poc-decision-record-skeleton-check sandbox-vm-live-poc-decision-record-check sandbox-vm-live-poc-implementation-plan-check sandbox-vm-live-poc-runtime-proposal-check sandbox-vm-live-poc-runtime-ticket-check sandbox-vm-live-poc-runtime-ticket-internal-review-check sandbox-vm-live-poc-runtime-implementation-gate-check sandbox-vm-live-poc-runtime-descriptor-contract-check sandbox-vm-live-poc-runtime-descriptor-contract-internal-review-check sandbox-vm-live-poc-runtime-ticket-review-bundle sandbox-vm-live-poc-runtime-ticket-review-bundle-check sandbox-vm-live-poc-response-dry-run sandbox-vm-live-poc-prerequisite-disposition-dry-run sandbox-vm-live-poc-response-kit sandbox-vm-live-poc-response-kit-check sandbox-vm-live-poc-external-review-bundle sandbox-vm-live-poc-external-review-bundle-check sandbox-vm-live-poc-implementation-review-bundle sandbox-vm-live-poc-implementation-review-bundle-check sandbox-vm-live-poc-runtime-proposal-review-bundle sandbox-vm-live-poc-runtime-proposal-review-bundle-check
