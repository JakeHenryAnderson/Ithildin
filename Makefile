...
.PHONY: clean compose-config compose-down compose-logs compose-smoke compose-up demo-flow demo-seed docs-site lint local-model-demo manifest-lock manifest-lock-check ollama-smoke release-check release-guardrails test typecheck ui-dev
