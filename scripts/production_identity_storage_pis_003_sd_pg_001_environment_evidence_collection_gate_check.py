...
REVIEW_RECORD_COMMIT = "31c5653f04b1c7d20d2573cabfed2d0c677d6d4e"
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not review_record_exists or not review_record_is_ancestor:
        failures.append("PIS-003 environment evidence collection review-record ancestry is invalid")
