...
REQUIRED_V04_DONE_TASKS = [f"{task:03d}" for task in range(113, 131)]
REQUIRED_V04_METADATA_TASKS = [f"{task:03d}" for task in range(123, 131)]
V04_PLANNED_RANGE = "131-151"
...
def _check_v04_horizontal_gate_status() -> list[str]:
    ...
    if manifest.get("completed_range") != "113-130":
        failures.append("v0.4 manifest completed_range is not 113-130")
