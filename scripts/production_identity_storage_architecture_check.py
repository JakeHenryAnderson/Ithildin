...
REQUIRED_PHRASES = [
    ...
    "immutable external identity key is `(organization_id, provider_configuration_id, exact",
    "configured issuer, issuer returned by verified discovery, and token `iss`",
    "equivalent-looking forms are rejected",
    ...
    "Before `PIS-002` or any database dependency decision",
    "TLS with server-identity verification",
    "separate least-privilege runtime and migration roles",
...
REQUIRED_SAFE_EVIDENCE_PHRASES = [
    "privacy-safe principal reference and Ithildin principal ID",
    "privacy-safe organization/team/workspace references",
    "random `session_audit_id`",
    "cannot authenticate or retrieve a",
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    expected_contract: dict[str, Any] = {
        ...
        "human_issuer_validation": "configured_discovery_and_token_issuer_exact_match",
        "issuer_normalization_authoritative": False,
        ...
        "session_audit_reference": "random_non_authenticating_session_audit_id",
        ...
        "database_transport": "tls_server_identity_verification_required",
        "database_roles": "separate_least_privilege_runtime_and_migration",
        "database_credentials_custody": "external_secret_provider_or_equivalent",
        "database_backup_wal_encryption_required": True,
        "database_security_profile_required_before_pis_002": True,
