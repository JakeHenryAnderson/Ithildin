"""Validate the project.test.summary design-only capability proposal."""
...
PROPOSAL_DOC = ROOT / "docs/codex/capability-proposals/project-test-summary.md"
SELECTION_DOC = ROOT / "docs/codex/v3-project-test-summary-selection.md"
REQUIRED_PHRASES = [
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not proposal_path.exists():
        return _report(["project.test.summary proposal is missing"], {})
    ...
    if not selection_path.exists():
        failures.append("project.test.summary selection doc is missing")
    else:
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin project.test.summary proposal check",
