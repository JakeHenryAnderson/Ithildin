"""Validate the project.ci.summary design-only capability proposal."""
...
PROPOSAL_DOC = ROOT / "docs/codex/capability-proposals/project-ci-summary.md"
SELECTION_DOC = ROOT / "docs/codex/v3-project-ci-summary-selection.md"
REQUIRED_PHRASES = [
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not proposal_path.exists():
        return _report(["project.ci.summary proposal is missing"], {})
    ...
    if not selection_path.exists():
        failures.append("project.ci.summary selection doc is missing")
    else:
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin project.ci.summary proposal check",
