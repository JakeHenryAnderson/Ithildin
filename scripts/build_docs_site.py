...
DEFAULT_DOCS = [
    ...
    "docs/codex/command-center-product-direction-and-pilot-scope.md",
    "docs/codex/command-center-information-architecture.md",
    "docs/codex/command-center-golden-pilot-scenario.md",
    "docs/codex/command-center-initial-operator-uat-evidence.md",
    "docs/codex/command-center-terminology-and-state-contract.md",
    "docs/codex/command-center-pilot-epic-and-backlog.md",
    "docs/codex/command-center-cc-pilot-101-data-feasibility.md",
    "docs/codex/command-center-cc-pilot-101-implementation-handoff.md",
    "docs/codex/command-center-cc-pilot-102-data-feasibility.md",
    "docs/codex/command-center-cc-pilot-102-implementation-handoff.md",
    "docs/codex/command-center-cc-pilot-103-data-feasibility.md",
    "docs/codex/command-center-cc-pilot-103-implementation-handoff.md",
    "docs/codex/command-center-cc-pilot-104-data-feasibility.md",
    "docs/codex/command-center-cc-pilot-104-implementation-handoff.md",
    "docs/codex/command-center-cc-pilot-105-data-feasibility.md",
    ...
    "docs/codex/command-center-node-run-origin-evidence-parity-data-feasibility.md",
    ...
    "docs/codex/compliance-mapping-template-compatibility-fixtures.md",
    "docs/codex/compliance-mapping-template-compatibility-fixtures-internal-source-review.md",
    ...
    "docs/codex/v1.0-operator-trial-record.md",
    "docs/codex/v1.0-operator-trial-observed.md",
    ...
    "docs/codex/mission-command-control-plane-capability-decision.md",
    "docs/codex/mission-command-control-plane-architecture.md",
    "docs/codex/mission-command-control-plane-implementation-tickets.md",
    ...
    "docs/codex/track-b-node-observed-results.md",
    ...
    "docs/codex/track-b-node-governed-access-observed-results.md",
    "docs/codex/track-b-node-configuration-observed-results.md",
    ...
    "docs/codex/track-b-node-configuration-trust-rotation-observed-results.md",
    ...
    "docs/codex/production-identity-storage-pis-003-sd-pg-001-implementation-internal-source-review.md",
    "docs/codex/production-identity-storage-pis-003-sd-pg-001-connection-evidence-gate.md",
    "docs/codex/production-identity-storage-pis-003-sd-pg-001-connection-evidence-gate-internal-source-review.md",
