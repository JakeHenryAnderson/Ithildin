...
def _index_markdown(commit: str, readiness: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "11. `08_MISSION_CONTROL_DISPLAY_PROPOSAL.md`",
            "12. `09_MISSION_CONTROL_HANDOFF_SCHEMA.md`",
            "13. `10_MISSION_CONTROL_NEGATIVE_FIXTURES.md`",
            "14. `11_V1_RC_EXTERNAL_REVIEW_PROMPT.md`",
            "15. `12_V1_RC_FINAL_HANDOFF.md`",
            "16. `13_V1_RC_POST_REVIEW_TRIAGE.md`",
            "17. `14_V1_RC_ARTIFACTS.md`",
            "18. `15_V1_RC_COMMANDS.md`",
            "19. `v1-rc-artifact-hashes.json`",
            "",
