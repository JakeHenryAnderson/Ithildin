...
SOURCE_DOCS = [
    ...
    (
        ...
        ROOT / "docs/codex/enterprise-review-send-readiness.md",
    ),
    (
        "07B_ENTERPRISE_DUAL_REVIEW_HANDOFF.md",
        ROOT / "docs/codex/enterprise-dual-review-handoff.md",
    ),
    (
        "07C_ENTERPRISE_RESPONSE_STATUS_BOARD.md",
        ROOT / "docs/codex/enterprise-response-status-board.md",
    ),
    (
    ...
    (
        ...
        ROOT / "docs/codex/mission-control-handoff-fixture-pack.md",
    ),
    (
...
ARTIFACT_REFERENCES = [
    {
        "path": "var/review-packets/v1.0/operator-trial",
    ...
    {
        "path": "var/review-packets/v3/mission-control-handoff-fixtures",
        "purpose": "Mission Control display/import positive and negative handoff fixtures",
        "proves": "future importer tests can use concrete metadata-only payload fixtures",
