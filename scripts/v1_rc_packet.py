...
def _index_markdown(commit: str, readiness: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "16. `11_V1_RC_EXTERNAL_REVIEW_PROMPT.md`",
            "17. `12_V1_RC_FINAL_HANDOFF.md`",
            "18. `13_V1_RC_POST_REVIEW_TRIAGE.md`",
            "19. `14_V1_RC_ARTIFACTS.md`",
            "20. `15_V1_RC_COMMANDS.md`",
            "21. `v1-rc-artifact-hashes.json`",
            "",
