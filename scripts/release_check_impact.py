...
PATH_CATEGORY_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("docs/codex/sandbox-artifact-", "sandbox_artifact"),
    ("scripts/sandbox_artifact_", "sandbox_artifact"),
    ...
    ("docs/codex/post-rc-", "post_rc_decision"),
    ("scripts/post_rc_", "post_rc_decision"),
    ...
    ("docs/codex/agent-workflow-", "agent_workflow"),
    ("scripts/agent_workflow_", "agent_workflow"),
    ("docs/codex/low-implementer-", "agent_workflow"),
    ("scripts/low_implementer_", "agent_workflow"),
    ("docs/codex/governed-artifact-transfer-", "governed_artifact_transfer"),
    ("scripts/governed_artifact_transfer_", "governed_artifact_transfer"),
    ("docs/codex/hello-world-", "governed_artifact_transfer"),
    ("scripts/hello_world_", "governed_artifact_transfer"),
    ("docs/codex/data-classification-", "observability_control"),
    ("scripts/data_classification_", "observability_control"),
    ("docs/codex/control-mapping-", "observability_control"),
    ("scripts/control_mapping_", "observability_control"),
    ("docs/codex/incident-reconstruction-", "observability_control"),
    ("scripts/incident_reconstruction_", "observability_control"),
    ("docs/codex/observability-", "observability_control"),
    ("scripts/observability_", "observability_control"),
    ("docs/codex/accepted-risk-", "risk_findings"),
    ("scripts/accepted_risk_", "risk_findings"),
    ("scripts/external_findings_", "risk_findings"),
    ("docs/codex/technical-mvp-", "status_efficiency"),
    ("scripts/technical_mvp_", "status_efficiency"),
    ("docs/codex/development-efficiency-", "status_efficiency"),
    ("scripts/development_efficiency_", "status_efficiency"),
    ("docs/codex/v1-", "v1_rc"),
    ("scripts/v1_", "v1_rc"),
)
