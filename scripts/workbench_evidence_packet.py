...
def _demo_index(output_dir: Path, context: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "3. `07_WORKBENCH_DEMO_STORY.md` for the happy path narrative.",
        "4. `WORKBENCH_DEMO_SMOKE.md` for the operator flow transcript.",
        "5. `00_OPERATOR_WORKBENCH_INDEX.md` for the packet boundary.",
        "6. `02_OPERATOR_WORKBENCH_DOCS.md` for run evidence/export docs.",
        "7. `04_OPERATOR_WORKBENCH_ARTIFACT_POINTERS.md` for live-demo packet pointers.",
        "",
        "## Artifact Hashes",
        "",
    ]
