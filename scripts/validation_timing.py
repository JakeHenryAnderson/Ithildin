...
PROFILES: dict[str, list[str]] = {
    "capability": ["make capability-check"],
    "dev": ["make dev-check"],
    "docs": ["make docs-check"],
    "enterprise-send-refresh": ["make enterprise-review-send-refresh"],
    "enterprise-status": ["make enterprise-status-quick"],
    "evidence": ["make evidence-check"],
    "fast": ["make smart-check"],
    "handoff": ["make review-candidate"],
    "handoff-dry-run": [
...
PROFILE_BUDGET_SECONDS = {
    ...
    "dev": 60.0,
    "docs": 120.0,
    "enterprise-send-refresh": 600.0,
    "enterprise-status": 10.0,
    "evidence": 300.0,
    "fast": 60.0,
    "handoff": 2400.0,
    "handoff-dry-run": 180.0,
    "quick": 180.0,
    "readiness": 300.0,
}
