"""Exercise trusted-host promotion response closure without recording review."""
...
from scripts import trusted_host_promotion_disposition_closure_check as closure
from scripts.response_dry_run_lock import response_dry_run_lock

ROOT = Path(__file__).resolve().parents[1]
DOC_REL = "docs/codex/trusted-host-promotion-response-dry-run.md"
DOC_NAME = "trusted-host-promotion-response-dry-run.md"
    ...
    with response_dry_run_lock(repo_root, closure.NORMALIZED_RESPONSE_REL):
        ...
        try:
            ...
            cases["valid_response_accepts"] = (
                ...
                and valid_report["erg_005_status"] == "ready_for_design_only_decision_record"
            )
...
def _valid_response(
    *,
    ...
    reviewed_packet_hash: str = "sha256:" + "3" * 64,
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin trusted-host promotion response dry run",
