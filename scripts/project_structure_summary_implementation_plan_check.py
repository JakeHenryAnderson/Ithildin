"""Validate the project.structure.summary implementation-planning packet."""
...
from scripts import project_structure_summary_proposal_check, tool_surface_invariant_gate

ROOT = Path(__file__).resolve().parents[1]
PLAN_DOC = ROOT / "docs/codex/capability-implementation-plans/project-structure-summary.md"
REQUIRED_PHRASES = [
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not plan_path.exists():
        return _report(["project.structure.summary implementation plan is missing"], {})
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin project.structure.summary implementation-plan check",
