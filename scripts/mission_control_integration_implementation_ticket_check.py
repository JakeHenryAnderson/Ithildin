...
REQUIRED_INPUTS = [
    ...
    "enterprise-review-send-package.md",
    "enterprise-review-send-session-record.md",
...
REQUIRED_TESTS = [
    ...
    "`packet_paths.enterprise_review_send_package`",
    "`packet_paths.enterprise_review_send_session_record`",
    "treat the send package as review evidence",
    "send-session record as proof that a review",
