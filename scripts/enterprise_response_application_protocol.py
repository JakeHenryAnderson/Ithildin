...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        ...
        "legacy_route_scope: "
        f"{report.get('legacy_route_scope', report.get('route_scope', 'unknown'))}",
        "active_send_set: " + ", ".join(report.get("active_send_set") or []),
        "legacy_recommended_send_set: "
        + ", ".join(report.get("legacy_recommended_send_set") or []),
