"""Validate the project.docs.summary design-only capability proposal."""
...
PROPOSAL_DOC = ROOT / "docs/codex/capability-proposals/project-docs-summary.md"
SELECTION_DOC = ROOT / "docs/codex/v3-project-docs-summary-selection.md"
REQUIRED_PHRASES = [
...
FORBIDDEN_PHRASES = [
    ...
    "return documentation file names",
    "run documentation",
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not proposal_path.exists():
        return _report(["project.docs.summary proposal is missing"], {})
    ...
    if not selection_path.exists():
        failures.append("project.docs.summary selection doc is missing")
    else:
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin project.docs.summary proposal check",
