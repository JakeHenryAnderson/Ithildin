...
DISPATCH_AREAS: tuple[DispatchArea, ...] = (
    ...
    DispatchArea(
        ...
        source_files=(
            ...
            "tool-manifests/http-fetch.yaml",
    ...
    DispatchArea(
        ...
        source_files=(
            "packages/audit-core/src/ithildin_audit_core/__init__.py",
            ...
            "scripts/audit_signing.py",
            "scripts/manifest_lock_signing.py",
            "scripts/signed_evidence_demo.py",
            "scripts/signed_evidence_demo_verify.py",
            "scripts/evidence_confusion_gate.py",
        ...
        review_docs=(
            ...
            "docs/codex/findings/sub-010-signed-export-lifecycle-drift.md",
            "docs/codex/findings/sub-011-signed-export-embedded-verification.md",
            "docs/codex/findings/sub-012-audit-non-object-payload.md",
            "docs/codex/findings/sub-013-audit-export-events.md",
            "docs/codex/findings/sub-014-signed-demo-artifact-hashes.md",
            "docs/codex/findings/sub-048-signed-export-failure-evidence.md",
            "docs/codex/findings/sub-049-signed-export-metadata-validation.md",
            "docs/codex/findings/sub-050-signed-export-trusted-key-docs.md",
            "docs/codex/findings/sub-051-signed-export-non-object-bundle.md",
            "docs/codex/findings/sub-052-audit-list-corrupt-payload.md",
            "docs/codex/findings/sub-053-manifest-signature-lock-read-status.md",
            "docs/codex/findings/sub-054-release-evidence-signed-lock-required.md",
            "docs/codex/findings/sub-055-system-status-signature-startup-evidence.md",
            "docs/codex/findings/sub-056-manifest-signature-untrusted-key-id.md",
            "docs/codex/findings/sub-057-signed-demo-custom-lock-path.md",
            "docs/codex/findings/sub-058-signed-evidence-closure-traceability.md",
            "docs/codex/findings/sub-059-signed-evidence-dispatch-pointers.md",
            "docs/codex/findings/sub-060-review-artifact-staleness.md",
            "docs/codex/findings/sub-061-signed-demo-verification-transcript.md",
        ),
        commands=(
    ...
    DispatchArea(
        ...
        review_docs=(
            ...
            "docs/codex/findings/sub-084-patch-apply-missing-scope-approval.md",
        ),
        commands=(
    ...
    DispatchArea(
        ...
        source_files=(
            ...
            "scripts/reviewer_findings.py",
            "scripts/review_findings_collect.py",
            ...
            "scripts/no_new_powers_guardrail.py",
            "scripts/evidence_confusion_gate.py",
            "scripts/external_review_closure_gate.py",
        ...
        review_docs=(
            ...
            "docs/codex/findings/sub-022-review-packet-artifact-hash-gate.md",
            "docs/codex/findings/sub-023-review-bundle-json-transcripts.md",
            "docs/codex/findings/sub-024-release-evidence-transcript-binding.md",
            "docs/codex/findings/sub-025-review-finding-namespace-alignment.md",
            "docs/codex/findings/sub-026-finding-summary-check-mode.md",
            "docs/codex/findings/sub-054-release-evidence-signed-lock-required.md",
            "docs/codex/findings/sub-060-review-artifact-staleness.md",
            "docs/codex/findings/sub-061-signed-demo-verification-transcript.md",
            ...
            "docs/codex/findings/sub-085-release-automation-source-inventory.md",
            "docs/codex/findings/sub-086-release-transcript-doc-freshness.md",
        ),
        commands=(
