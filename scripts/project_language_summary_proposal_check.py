"""Validate the project.language.summary design-only capability proposal."""
...
PROPOSAL_DOC = ROOT / "docs/codex/capability-proposals/project-language-summary.md"
SELECTION_DOC = ROOT / "docs/codex/v3-project-language-summary-selection.md"
REQUIRED_PHRASES = [
...
FORBIDDEN_PHRASES = [
    ...
    "return language file names",
    "return raw extensions",
    "run language detectors",
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    if not proposal_path.exists():
        return _report(["project.language.summary proposal is missing"], {})
    ...
    if not selection_path.exists():
        failures.append("project.language.summary selection doc is missing")
    else:
...
def _report(failures: list[str], evidence: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "valid": not failures,
        "failures": failures,
        "proposal": "project.language.summary",
        "scope": "design_only",
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin project.language.summary proposal check",
