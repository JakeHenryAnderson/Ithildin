...
ATTEMPT_013_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-013-disposition.json"
)
ATTEMPT_013_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-013-disposition.md"
)
ATTEMPT_014_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-014-disposition.json"
)
ATTEMPT_014_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-014-disposition.md"
)
ATTEMPT_015_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-015-disposition.json"
)
ATTEMPT_015_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-015-disposition.md"
)
ATTEMPT_016_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-016-disposition.json"
)
ATTEMPT_016_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-016-disposition.md"
)
ATTEMPT_017_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-017-disposition.json"
)
ATTEMPT_017_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-017-disposition.md"
)
ATTEMPT_018_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-018-disposition.json"
)
ATTEMPT_018_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-018-disposition.md"
)
ATTEMPT_019_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-019-disposition.json"
)
ATTEMPT_019_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-019-disposition.md"
)
ATTEMPT_020_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-020-disposition.json"
)
ATTEMPT_020_DISPOSITION_DOCUMENT = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-020-disposition.md"
)
ATTEMPT_021_DISPOSITION_JSON = Path(
    "docs/codex/local-v1-lv1-003-o4-attempt-021-disposition.json"
)
ATTEMPT_021_DISPOSITION_DOCUMENT = Path(
...
SOCKET_PARENT_MODE_REVIEW = Path(
    "docs/codex/local-v1-lv1-003-o4-socket-parent-mode-exact-review.md"
)
GATEWAY_MISSION_PROJECTION_REVIEW = Path(
    "docs/codex/local-v1-lv1-003-o4-gateway-mission-projection-diagnostic-exact-review.md"
)
MISSION_CONVERGENCE_REVIEW = Path(
    "docs/codex/local-v1-lv1-003-o4-mission-convergence-exact-review.md"
)
...
ATTEMPT_013_ID = "LV1-003-O4-ATTEMPT-013"
ATTEMPT_013_REVIEW_TAG = "ithildin/lv1-003-o4-attempt013-reviewed"
ATTEMPT_013_PARENT_COMMIT = "27a4819213b78536aa0008bd0e62b7c6c7435aad"
ATTEMPT_013_PARENT_TREE = "1f984a114976d2c99b78a5e397318018092809fe"
ATTEMPT_013_PARENT_PARENT = "4972606a0677164d8de96a4b3e14ce5bead75033"
ATTEMPT_013_CANDIDATE_COMMIT = "8fa31904570d2179c5661fa44ff0ff3ca00eba43"
ATTEMPT_013_CANDIDATE_TREE = "27f5ccbe8b6153ab7dfbcd97c37193d63217a086"
ATTEMPT_013_RUN_IDENTITY_DIGEST = (
    "sha256:baf8e92b6d4a52c37cbce9a71a176fca523898476196d01f6be1ab373bfa29e6"
)
ATTEMPT_013_PROJECT_IDENTITY_DIGEST = (
    "sha256:96abd1a39e6c2ce325c31c6c53cca27185082e6daa1127b07802507cd22a12cb"
)
ATTEMPT_013_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt013-run-v1:"
ATTEMPT_013_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt013-project-v1:"
ATTEMPT_013_RAW_OUTPUT_DIGEST = (
    "sha256:fd9673eeb55fe747baba9605650183eea1691ec0ef555327431d83a8718b9445"
)
ATTEMPT_013_RAW_OUTPUT_SIZE = 160
ATTEMPT_013_DISPOSITION_JSON_DIGEST = (
    "sha256:30a91355ffc3ff16d0c2b830bd5750410e11024aa89d903762af605212a46f40"
)
ATTEMPT_013_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:480ed9fb8b711f4e51c5e5bfb1ef3eacc92b0567622e1fed19828ac3787827f7"
)
ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT = ATTEMPT_013_PARENT_PARENT
ATTEMPT_013_REVIEWED_IMPLEMENTATION_TREE = (
    "a7e5cbfb849f974a142c6861f79af26498bebb3d"
)
FIXED_BRIDGE_PHASE_DIAGNOSTIC_REJECTED_COMMIT = (
    "f8af8a0ec471f607490df094ce5df4f4de3e9381"
)
FIXED_BRIDGE_PHASE_DIAGNOSTIC_CONSUMED_BASELINE = (
    "5446b1d65c09df515592fc61799b368035bfad8f"
)
FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW_DIGEST = (
    "sha256:97c26627c81e19cdba4949a718ddc45b364377a550fb7af8db085bba50d1f51b"
)
FIXED_BRIDGE_PHASE_DIAGNOSTIC_PATH_DIGESTS: JsonObject = {
    "apps/node/src/ithildin_node/fixed_runner_bridge.py": (
        "sha256:19b9ef3f73066c826560283b0209c9eab20696b2be235c9c50a2f95fc01f6f35"
    ),
    "apps/node/src/ithildin_node/service.py": (
        "sha256:d61798ede4d11c149ddedd76339d2dc84b966ca9c2fd83b72396963c244d1fb9"
    ),
    "scripts/local_v1_lv1_003_o4_producer.py": (
        "sha256:241de5ef6da3e47d9e760001a7eb1a4a3281c96e3b3010a12c6f187d8e09dafc"
    ),
    "tests/test_node_fixed_runner_bridge.py": (
        "sha256:0852b55bf1ff216421030d796f7e3d68085877c7288728b2c7a8a995652bae8d"
    ),
    "tests/test_node_service.py": (
        "sha256:0ebd161d5e39234b829601e6ed9a7bb7c3e16b8cb1e7d9c78e933576ac77e2ff"
    ),
    "tests/test_local_v1_lv1_003_o4_producer.py": (
        "sha256:5cb506309d4a8e09142795ee11f603f3dd47bcba67da29ae7b9cf4a793287bd3"
    ),
}
FIXED_BRIDGE_PHASE_VALUES = [
...
FIXED_NODE_STATE_PROJECTION_KEYS = [
    "collection_status",
...
ATTEMPT_014_CANDIDATE_COMMIT = "bfb10f037c916a7c7bd5a15a5d748f3d4d3c3a44"
ATTEMPT_014_CANDIDATE_TREE = "191ca97beae3d4ba31ef3e22fb1533a8620e8347"
ATTEMPT_014_RUN_IDENTITY_DIGEST = (
    "sha256:bde3608954025334040e16549f8d7e661b36c7e39a897ce22c14e4c8a72e73ea"
)
ATTEMPT_014_PROJECT_IDENTITY_DIGEST = (
    "sha256:bd1a847bbb200e3cbf66d2597ff408383a811b7691c091184a3ec284a741ecef"
)
ATTEMPT_014_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt014-run-v1:"
ATTEMPT_014_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt014-project-v1:"
ATTEMPT_014_RAW_OUTPUT_DIGEST = ATTEMPT_013_RAW_OUTPUT_DIGEST
ATTEMPT_014_RAW_OUTPUT_SIZE = 160
ATTEMPT_014_DISPOSITION_JSON_DIGEST = (
    "sha256:afd14287356716c673a9c6083d17a8d4949cf3fb7fd42bf85fa5f95915970331"
)
ATTEMPT_014_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:948736c209ed106b551153dedfe5cc45ad694327f8b12c619b5b6f91b0ef31f4"
)
ATTEMPT_015_ID = "LV1-003-O4-ATTEMPT-015"
ATTEMPT_015_REVIEW_TAG = "ithildin/lv1-003-o4-attempt015-reviewed"
ATTEMPT_015_CANDIDATE_COMMIT = "5bda7496ad69cb9002b41292106a8dd080117400"
ATTEMPT_015_CANDIDATE_TREE = "e55b1d60a14bc8bf798b34df452377df8b0b9d7b"
ATTEMPT_015_RUN_IDENTITY_DIGEST = (
    "sha256:52cda6a5a9b1f54c40b93ec58ee71dd6f5d38e94cd978707c0e6d93aae62ada5"
)
ATTEMPT_015_PROJECT_IDENTITY_DIGEST = (
    "sha256:9ee88459706bbb7385af6474953e7d34c50c3ef876b9eb1759c97c474bafb889"
)
ATTEMPT_015_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt015-run-v1:"
ATTEMPT_015_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt015-project-v1:"
ATTEMPT_015_RAW_OUTPUT_DIGEST = (
    "sha256:a667ff635a76069c4725e36bf1ef0abe057e837bbda91dbdc2823eabc890d90d"
)
ATTEMPT_015_RAW_OUTPUT_SIZE = 171
ATTEMPT_015_DISPOSITION_JSON_DIGEST = (
    "sha256:ef0bc6545655c58a76410bb26c2106315ba4937392723620adb9d3afd3e76bb2"
)
ATTEMPT_015_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:1a1cc8dc6b56083913d494b6a6fac9400462387d681000eb587dfeeaaa600a5f"
)
ATTEMPT_016_ID = "LV1-003-O4-ATTEMPT-016"
ATTEMPT_016_REVIEW_TAG = "ithildin/lv1-003-o4-attempt016-reviewed"
ATTEMPT_016_CANDIDATE_COMMIT = "fef4205299c16da702f729ecfd7b66a1c0c5a6cf"
ATTEMPT_016_CANDIDATE_TREE = "f246c857c0bf0fa17513bf8d2b45db979d058db6"
...
ATTEMPT_016_DISPOSITION_JSON_DIGEST = (
    "sha256:3c8d0dead1609faf7eef2a42dbf7421766b053be7bdcc38c807e8ed221dc200d"
)
ATTEMPT_016_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:7713892c393545bbf63ad211fa1aeebaee0499074e3f5499df268b5e511d770c"
)
ATTEMPT_016_MANIFEST_RECEIPT_DIGEST = (
    "sha256:8079ac5100afe2fc99c9af07e0aa05dc700f67eb21ee5b82c1749fdd9750a070"
)
ATTEMPT_016_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:c6fae45136de76bb0638e80fc3d58220594e8e94ba3634ebbfb745c25e663b04"
)
ATTEMPT_016_DISPOSITION_RECEIPT_DIGEST = (
    "sha256:76111fb55e47a53554a22326499aa8a1b98fc9280ffb80b471e953cc4b645762"
)
ATTEMPT_016_MANIFEST_SIZE = 97421
ATTEMPT_016_DIAGNOSTIC_SIZE = 7545
ATTEMPT_016_DISPOSITION_SIZE = 136
ATTEMPT_016_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_017_ID = "LV1-003-O4-ATTEMPT-017"
ATTEMPT_017_REVIEW_TAG = "ithildin/lv1-003-o4-attempt017-reviewed"
ATTEMPT_017_CANDIDATE_COMMIT = "6ef2507f4cf8b296c3cf5a1044f75753ef2c697d"
ATTEMPT_017_CANDIDATE_TREE = "4231e0e0dc89ac723189dd95c619c40e75650913"
...
ATTEMPT_017_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt017-run-v1:"
ATTEMPT_017_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt017-project-v1:"
ATTEMPT_017_RAW_OUTPUT_DIGEST = ATTEMPT_016_RAW_OUTPUT_DIGEST
ATTEMPT_017_RAW_OUTPUT_SIZE = 171
ATTEMPT_017_DISPOSITION_JSON_DIGEST = (
    "sha256:f8785aa3210a6e3f02702f0f93c4e160e6574dbfc4d2221cea32ea917390f3a1"
)
ATTEMPT_017_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:81d11b6f73bfb3b10d08a342c568558250791c7cd1a48ebf0fa249322e7067f6"
)
...
ATTEMPT_017_DISPOSITION_RECEIPT_DIGEST = ATTEMPT_016_DISPOSITION_RECEIPT_DIGEST
ATTEMPT_017_MANIFEST_SIZE = 97421
ATTEMPT_017_DIAGNOSTIC_SIZE = 7953
ATTEMPT_017_DISPOSITION_SIZE = 136
ATTEMPT_017_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_018_ID = "LV1-003-O4-ATTEMPT-018"
ATTEMPT_018_REVIEW_TAG = "ithildin/lv1-003-o4-attempt018-reviewed"
ATTEMPT_018_CANDIDATE_COMMIT = "bae6be514b9c8d47e09a69fb413f097d9af1d7d4"
ATTEMPT_018_CANDIDATE_TREE = "2317226c58ea0000435e79b2d7c4efe6dce088e3"
ATTEMPT_018_RUN_IDENTITY_DIGEST = (
    "sha256:fe1e0bf962c4ec5fa4bda96d02033c074f584cbf4db65807730ebad657fb6ef6"
)
ATTEMPT_018_PROJECT_IDENTITY_DIGEST = (
    "sha256:1f7a4ce1caa4674ecb5d63822420bfdb18f76f0dfc3ac521655e80c793179511"
)
ATTEMPT_018_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt018-run-v1:"
ATTEMPT_018_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt018-project-v1:"
ATTEMPT_018_RAW_OUTPUT_DIGEST = ATTEMPT_017_RAW_OUTPUT_DIGEST
ATTEMPT_018_RAW_OUTPUT_SIZE = 171
ATTEMPT_018_DISPOSITION_JSON_DIGEST = (
    "sha256:7dffc76440806153bca091178497b04018fad5103b2e3342b7c64cf6dc3787f6"
)
ATTEMPT_018_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:7c2d54400e9f5f44c2e9b50116dd9faad2ee97f85dbb5a68de9bed4eafdb737d"
)
ATTEMPT_018_MANIFEST_RECEIPT_DIGEST = (
    "sha256:7faf7c164ded73aeb5fccfdc39940dfeedc3c3144d7b7590f7ad1dbd4c884f17"
)
ATTEMPT_018_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:cc6fb52aa23e60341e0fd54f7812f2ce88bfc1f4d78f1ee5c291939d75e53b32"
)
ATTEMPT_018_DISPOSITION_RECEIPT_DIGEST = ATTEMPT_017_DISPOSITION_RECEIPT_DIGEST
ATTEMPT_018_MANIFEST_SIZE = 97421
...
ATTEMPT_019_CANDIDATE_COMMIT = "ae94ec4b57ddd053d60ab8ffddd36b2026ac6184"
ATTEMPT_019_CANDIDATE_TREE = "4a5bcb797e7cc6ddb844469728db2bf3cb452360"
ATTEMPT_019_RUN_IDENTITY_DIGEST = (
    "sha256:d457ee920144aaeb9bb0dd8271c5e569574303bba0d4269a5c0cc506e9731de9"
)
ATTEMPT_019_PROJECT_IDENTITY_DIGEST = (
    "sha256:17f4845be1b0026285f8f645b5830cf9894495e23dead3a136ef5e7246950dec"
)
ATTEMPT_019_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt019-run-v1:"
ATTEMPT_019_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt019-project-v1:"
ATTEMPT_019_RAW_OUTPUT_DIGEST = (
    "sha256:11197c6a46d3faa625e50376cfed5926e706de664e6d057ce912861ce9b16fa5"
)
ATTEMPT_019_RAW_OUTPUT_SIZE = 163
ATTEMPT_019_DISPOSITION_JSON_DIGEST = (
    "sha256:6c89ae98ba852fa28fb999df4f1533461c9fcf3621a3297d5f7e1909f92c6eeb"
)
ATTEMPT_019_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:961e9bcf65aa6fdfbb750b930bb21d8570363cb84c4de20d0e6b419553c67d46"
)
ATTEMPT_019_MANIFEST_RECEIPT_DIGEST = (
    "sha256:6d07ee192b53b15877d79feb0f3b252dd007b0fc90f2502029c2124a490a88cb"
)
ATTEMPT_019_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:1efdf13c9ee8741bb357b2776a43cf12f4de640b748fa41c5ae48a317ea8f783"
)
ATTEMPT_019_DISPOSITION_RECEIPT_DIGEST = (
    "sha256:2a10f131d5c4e87270b674cd54a96a9d6a932d8b20e44b6f3ff206bd70afe573"
)
ATTEMPT_019_MANIFEST_SIZE = 97421
ATTEMPT_019_DIAGNOSTIC_SIZE = 7609
ATTEMPT_019_DISPOSITION_SIZE = 128
ATTEMPT_019_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_020_ID = "LV1-003-O4-ATTEMPT-020"
ATTEMPT_020_REVIEW_TAG = "ithildin/lv1-003-o4-attempt020-reviewed"
ATTEMPT_020_CANDIDATE_COMMIT = "506cc00267bcedbe00f0384b64a3bf11111bd752"
ATTEMPT_020_CANDIDATE_TREE = "6bfb7077a9af05f22095740114b39607b9d715c8"
ATTEMPT_020_RUN_IDENTITY_DIGEST = (
    "sha256:24284f1fb67d0e387be6864009f4be59779ec4e0143762a2efd76ff31e0cb02b"
)
ATTEMPT_020_PROJECT_IDENTITY_DIGEST = (
    "sha256:c5bd9d9f408d2a0959b157f191c07d50edee16a7e014620c44548574cb674298"
)
ATTEMPT_020_RUN_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt020-run-v1:"
ATTEMPT_020_PROJECT_DIGEST_PREFIX = "ithildin-lv1-003-o4-attempt020-project-v1:"
ATTEMPT_020_RAW_OUTPUT_DIGEST = (
    "sha256:11197c6a46d3faa625e50376cfed5926e706de664e6d057ce912861ce9b16fa5"
)
ATTEMPT_020_RAW_OUTPUT_SIZE = 163
ATTEMPT_020_DISPOSITION_JSON_DIGEST = (
    "sha256:d045a1d5359e45d22fe1cbd267e1f10b5ed43961c64762ac157cbce9036136f6"
)
ATTEMPT_020_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:fa5494b56169f80472246e9517025379c26ab0e06a524b94f1e5bd1c165b4974"
)
ATTEMPT_020_MANIFEST_RECEIPT_DIGEST = (
    "sha256:7f555ded398766c1e7de482db1612e7950835de754390aad618815367ee0e1b3"
)
ATTEMPT_020_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:51645f1ba272968200c8b77a759ae013fa464207e930ee68978c9e217ee90e39"
)
ATTEMPT_020_DISPOSITION_RECEIPT_DIGEST = (
    "sha256:2a10f131d5c4e87270b674cd54a96a9d6a932d8b20e44b6f3ff206bd70afe573"
)
ATTEMPT_020_MANIFEST_SIZE = 97421
...
ATTEMPT_021_CANDIDATE_COMMIT = "cd267b4454af3e28f71d0f7c2e065d6e28c2d55c"
ATTEMPT_021_CANDIDATE_TREE = "506c6f61041204debaeef339ec7d8a0fadf51346"
ATTEMPT_021_DISPOSITION_JSON_DIGEST = (
    "sha256:b92234b7164e40f42ca78d56667398e826f6c0d0e3bdd531d36fc0432dbd328e"
)
ATTEMPT_021_DISPOSITION_DOCUMENT_DIGEST = (
    "sha256:0675a56e5239799af85645c939bdcdde54e5ad5d99f39ad190b14db9bc45c4cc"
)
ATTEMPT_021_RECEIPT_FILES: dict[str, tuple[int, int, str]] = {
    "build-receipt.json": (
        0o600,
        1261,
        "sha256:40af436862e81322d4f44d9ca925346c31061efd08f0f0c45381667aa537a74b",
    ),
    "journey-receipt.json": (
        0o600,
        3502,
        "sha256:8edd6654765e3c7e5e14681aaa16a2c61813c5d1c85fd26c86527e37153ef6f8",
    ),
    "image-artifact-inventory.json": (
        0o600,
        7001,
        "sha256:cf62cd7ec8c2ac8359316feffb13b3754ddfc05da00bb54e1d1cc0642fdb70a4",
    ),
    "license-source-inventory.json": (
        0o600,
        586,
        "sha256:b0e07c5d6f565b582653c4d16a3e4035ad2c2758ca79e74f19b98563d673e8fa",
    ),
}
ATTEMPT_021_MANIFEST_SIZE = 97421
ATTEMPT_021_MANIFEST_DIGEST = (
    "sha256:273d2e55d03815ca2b782726e4aace5838b6755cebc80bc4636e12bc2ce82036"
)
ATTEMPT_021_RECEIPT_DISPOSITION_SIZE = 256
ATTEMPT_021_RECEIPT_DISPOSITION_DIGEST = (
    "sha256:adccc93530980c62c75b7cd09634d7a004e3c19de31708b356dfcdae0ddaf173"
)
ATTEMPT_021_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_021_REPORT_FILES: dict[str, tuple[int, int, str]] = {
    "report.json": (
        0o600,
        5362,
        "sha256:57becae2e56fecf015e3d06fbf23e420e216d157a6cf2ad94ba633c0616cecb5",
    ),
    "report.md": (
        0o600,
        844,
        "sha256:cba02987a6dcc0822a3fc7e363fca917cce2bae35b4874262613f55a4472e2da",
    ),
}
ATTEMPT_021_SUCCESS_RECORDED = True
...
AGENT_RUN_PROVENANCE_REPAIR_REVIEW_RECORD_COMMIT = (
    "cd36de5682d85f850770dedab61a5c11f444d2a5"
)
AGENT_RUN_PROVENANCE_REPAIR_REVIEW_RECORD_TREE = (
    "575b546845a8f7fa1afca089a11bf04aacdbb505"
)
AGENT_RUN_PROVENANCE_REPAIR_COMMIT = "73fb131f1f89e4b12374dac26a3f8efe231f5c31"
AGENT_RUN_PROVENANCE_REPAIR_TREE = "d64f5fb43e118c072b099ab2877a34cd287de695"
AGENT_RUN_PROVENANCE_REPAIR_PARENT_COMMIT = (
    "468ae2deaba2c55e05997662aeb20f58f3fa91cd"
)
AGENT_RUN_PROVENANCE_REPAIR_PATH_DIGESTS: JsonObject = {
    "scripts/local_v1_lv1_003_o4_producer.py": (
...
MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_COMMIT = (
    "30af9b4694c3826979c868eb7fb9cb2369bd92a9"
)
MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_TREE = (
    "e57c2e31c0a51e191e42c12580cf29813c56051b"
)
MISSION_LIVENESS_TERMINAL_REASON_COMMIT = (
    "694e464d79afd00bc6af7f847acd3c7901fa4086"
)
MISSION_LIVENESS_TERMINAL_REASON_TREE = (
    "2bdb9e12e9ae65ea71064e8caf20ae3ce5fcda58"
)
MISSION_LIVENESS_TERMINAL_REASON_PARENT_COMMIT = (
    "cfbaf448cbef89aa6a34f4339954051797f70afa"
)
MISSION_LIVENESS_TERMINAL_REASON_PATH_DIGESTS: JsonObject = {
    "apps/node/src/ithildin_node/fixed_runner_bridge.py": (
        "sha256:a0ff5355295b8b694539676c0241c6627320606f8c9d5a389830d7966184b896"
    ),
    "apps/node/src/ithildin_node/service.py": (
        "sha256:8b0487f803379e87471cdf15ca8cc42d7c18d390fb8ef0eb7d03a21b27b162f3"
    ),
    "docs/codex/mission-command-runner-bridge-capability-decision.md": (
        "sha256:cc702776aede4805f2e7539a1b20181e94af9ce42a9cf0f5ef3db1c28b02005b"
    ),
    "scripts/local_v1_lv1_003_o4_producer.py": (
        "sha256:798be3148b9a49837b3c2f8e8d50fa555be2295f663aac96ef814dee38be23ff"
    ),
    "scripts/mission_command_runner_bridge_decision_check.py": (
        "sha256:5010506fb7934cf628e59a56844c39659915a6389f9ed5fddad4861cdf577195"
    ),
    "tests/test_local_v1_lv1_003_o4_producer.py": (
        "sha256:c8260167e0be89a37adfe85559f11671da21cc2c2628b26779b46e0f4fe634a6"
    ),
    "tests/test_mission_command_runner_bridge_decision_check.py": (
        "sha256:5fecf5b3d16d29996ff722c93e6ab8f29affee3dc18bda497deebe4a641a18e3"
    ),
    "tests/test_node_client.py": (
        "sha256:28a14d7007a4a56024437aa9dc5d25ad3dd0e7d6b2f23497c35b68310e191aa8"
    ),
    "tests/test_node_fixed_runner_bridge.py": (
        "sha256:1e502f7e2630ed146c53d657d6ca81ea7fbcea8dc5ab8f522802dea07e9eb21d"
    ),
}
MISSION_CONVERGENCE_REVIEW_DIGEST = (
    "sha256:00f1511d352ca4cbf29dfd9032b3b3db1ca6a9c0be45ebae43b6159cb7498d9e"
)
MISSION_CONVERGENCE_REVIEW_RECORD_COMMIT = (
    "0ecdb532d364ee9cf53f343fbc1a9d3e3bf64f32"
)
MISSION_CONVERGENCE_REVIEW_RECORD_TREE = (
    "fc2156f9cabad4df04998fe533a4bc6a61a75a5a"
)
MISSION_CONVERGENCE_COMMIT = "f222091c86b71162a3eef5e7518ef0f032cc65ec"
MISSION_CONVERGENCE_TREE = "7683d2de4dbca2367189e2b807818e641f1e3e8b"
MISSION_CONVERGENCE_PARENT_COMMIT = "589c9bc721330e92e0298b86b873d007234b8c49"
MISSION_CONVERGENCE_PATH_DIGESTS: JsonObject = {
    "apps/mcp-server/src/ithildin_mcp_server/node_bridge.py": (
        "sha256:a6349d5a8556f53012594a6c254ce25153e4a089f210cc59008f26000a24ff17"
    ),
    "apps/node/src/ithildin_node/fixed_runner_bridge.py": (
        "sha256:f2db686b921b7fad5942d2c1881b1b5e25c3aee6af49dff09f85480cd4396d3c"
    ),
    "scripts/local_v1_lv1_003_o4_producer.py": (
        "sha256:bfbe59861cf4ccc8acb7bd2204010559aa8e43e2c730ad92a68aa20ada5e2e8e"
    ),
    "tests/test_local_v1_lv1_003_o4_producer.py": (
        "sha256:3c0e360b42bdcec2a5d3aeb4b533d31c257cff601ed1fb02c630bb8186660a99"
    ),
    "tests/test_node_client.py": (
        "sha256:7c7c0dcac8c505be40e60d7366498be49943a839986a92f370b7dc1ec15107ef"
    ),
    "tests/test_node_fixed_runner_bridge.py": (
        "sha256:7c2d50cf01ee6049e6af32167dd9d98ffd69b031e32cf340feff13a2094399b4"
    ),
    "tests/test_node_mcp_bridge.py": (
        "sha256:74175632afe0d8a3954de92b43a3830ec78bfa800888b90cf75a33e87dcc885a"
    ),
}
GATEWAY_MISSION_PROJECTION_REVIEW_DIGEST = (
    "sha256:6818b2f752d48f031a1ffaac13a6414ca2abf89337fa792a0561bba607a0a62c"
)
GATEWAY_MISSION_PROJECTION_REVIEW_RECORD_COMMIT = (
    "fb3d0ac5a495d39bf440755d86464de4db401ab3"
)
GATEWAY_MISSION_PROJECTION_REVIEW_RECORD_TREE = (
    "e86f7fe03e0bdb5076ded9e5baeb651910198cf6"
)
GATEWAY_MISSION_PROJECTION_COMMIT = "41f2eb11d8b1572ac428e024d5060faaf616af56"
GATEWAY_MISSION_PROJECTION_TREE = "26a4f89de85fd5fd21e29c313ef5dd4f57fe9166"
GATEWAY_MISSION_PROJECTION_PARENT_COMMIT = (
    "7908d2e2af15a0007bcbee1189b49f56f65c4206"
)
GATEWAY_MISSION_PROJECTION_PATH_DIGESTS: JsonObject = {
    "scripts/local_v1_lv1_003_o4_producer.py": (
...
SOCKET_PARENT_MODE_REVIEW_DIGEST = (
    "sha256:a2dec414e5dd5dbfb1eff972195d3450f8c36c73efcfbab5dc09dfeb665fe43b"
)
SOCKET_PARENT_MODE_REVIEW_RECORD_COMMIT = "c30aa3c43a0e51403c04696c473333fd3bc0551a"
SOCKET_PARENT_MODE_REVIEW_RECORD_TREE = "dbd58923a662977a61d1498cb14b0d1cec04895d"
SOCKET_PARENT_MODE_COMMIT = "8f2191a4b3a6b5559f5a9083973c8b2797fe7f45"
SOCKET_PARENT_MODE_TREE = "c5634835d7c2f2280ee2555866cf6c32c346f540"
SOCKET_PARENT_MODE_PARENT_COMMIT = "f889449420c865299f8d2a08fe62cc323a994fab"
SOCKET_PARENT_MODE_PATH_DIGESTS: JsonObject = {
    "apps/node/src/ithildin_node/fixed_runner_bridge.py": (
...
CANDIDATE_PARENT_COMMIT = ATTEMPT_021_CANDIDATE_COMMIT
CANDIDATE_PARENT_TREE = ATTEMPT_021_CANDIDATE_TREE
CANDIDATE_PARENT_PARENT = GATEWAY_SESSION_BINDING_REPAIR_REVIEW_RECORD_COMMIT
...
ATTEMPT_013_DISPOSITION_BYTES = ATTEMPT_010_DISPOSITION_BYTES
ATTEMPT_013_DISPOSITION_RECEIPT_DIGEST = ATTEMPT_010_DISPOSITION_RECEIPT_DIGEST
ATTEMPT_013_DISPOSITION_SIZE = ATTEMPT_010_DISPOSITION_SIZE
ATTEMPT_013_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:fadafe39c3dd17ac428c11e44fbb0239649106bbb32bc412fcb613f4aa2ad0b9"
)
ATTEMPT_013_DIAGNOSTIC_SIZE = 7754
ATTEMPT_013_MANIFEST_RECEIPT_DIGEST = (
    "sha256:e4ee51fab03ced9515490873b8f401d45a963ac419625888c5832cb1db2e4890"
)
ATTEMPT_013_MANIFEST_SIZE = 97421
ATTEMPT_013_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_014_DISPOSITION_BYTES = ATTEMPT_010_DISPOSITION_BYTES
ATTEMPT_014_DISPOSITION_RECEIPT_DIGEST = ATTEMPT_010_DISPOSITION_RECEIPT_DIGEST
ATTEMPT_014_DISPOSITION_SIZE = ATTEMPT_010_DISPOSITION_SIZE
ATTEMPT_014_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:91fb82f3128149388854f0ae788a5518631346c02d669e19163cdde6ddf99e3e"
)
ATTEMPT_014_DIAGNOSTIC_SIZE = 7774
ATTEMPT_014_MANIFEST_RECEIPT_DIGEST = (
    "sha256:769472b7a2cb6d60a7ee852ed5d4688446b3aa657c860d4d3bff1d8afadedce6"
)
ATTEMPT_014_MANIFEST_SIZE = 97421
ATTEMPT_014_SNAPSHOT_FILE_COUNT = 668
ATTEMPT_015_DISPOSITION_BYTES = (
    b'{"failure_code":"gateway_mission_projection_invalid","release_allowed":false,'
    b'"status":"quarantined_not_published","uat_complete":false}\n'
)
ATTEMPT_015_DISPOSITION_RECEIPT_DIGEST = (
    "sha256:76111fb55e47a53554a22326499aa8a1b98fc9280ffb80b471e953cc4b645762"
)
ATTEMPT_015_DISPOSITION_SIZE = 136
ATTEMPT_015_DIAGNOSTIC_RECEIPT_DIGEST = (
    "sha256:b23558b7bc6391bc8b028fe8b463d189a054df004e06aeb986a2a8ecf6b8e642"
)
ATTEMPT_015_DIAGNOSTIC_SIZE = 7171
ATTEMPT_015_MANIFEST_RECEIPT_DIGEST = (
...
ATTEMPT_017_DISPOSITION_BYTES = ATTEMPT_016_DISPOSITION_BYTES
ATTEMPT_018_DISPOSITION_BYTES = ATTEMPT_017_DISPOSITION_BYTES
ATTEMPT_019_DISPOSITION_BYTES = (
    b'{"failure_code":"gateway_run_detail_invalid","release_allowed":false,'
    b'"status":"quarantined_not_published","uat_complete":false}\n'
)
ATTEMPT_020_DISPOSITION_BYTES = ATTEMPT_019_DISPOSITION_BYTES
...
ATTEMPT_013_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_013_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_013_DISPOSITION_JSON.as_posix(),
    ATTEMPT_013_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
...
ATTEMPT_014_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_014_DISPOSITION_JSON.as_posix(),
    ATTEMPT_014_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
]
ATTEMPT_015_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_015_RUNTIME_PATHS = list(SOCKET_PARENT_MODE_PATH_DIGESTS)
ATTEMPT_015_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_015_DISPOSITION_JSON.as_posix(),
    ATTEMPT_015_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
]
ATTEMPT_016_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_016_RUNTIME_PATHS = list(GATEWAY_MISSION_PROJECTION_PATH_DIGESTS)
ATTEMPT_016_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_016_DISPOSITION_JSON.as_posix(),
...
ATTEMPT_016_CLOSURE_REPAIR_COMMIT = "589c9bc721330e92e0298b86b873d007234b8c49"
ATTEMPT_016_CLOSURE_REPAIR_TREE = "560d9c8d07a03c4f83372677175e6b2a922d3b99"
ATTEMPT_016_CLOSURE_REPAIR_CONTROL_PATH_ALLOWLIST = [
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
]
ATTEMPT_017_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_017_RUNTIME_PATHS = list(MISSION_CONVERGENCE_PATH_DIGESTS)
ATTEMPT_017_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_017_DISPOSITION_JSON.as_posix(),
    ATTEMPT_017_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
...
ATTEMPT_018_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_018_RUNTIME_PATHS = list(MISSION_LIVENESS_TERMINAL_REASON_PATH_DIGESTS)
ATTEMPT_018_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_018_DISPOSITION_JSON.as_posix(),
    ATTEMPT_018_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
...
ATTEMPT_019_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_019_DISPOSITION_JSON.as_posix(),
    ATTEMPT_019_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
]
ATTEMPT_020_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
ATTEMPT_020_RUNTIME_PATHS = list(AGENT_RUN_PROVENANCE_REPAIR_PATH_DIGESTS)
ATTEMPT_020_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_020_DISPOSITION_JSON.as_posix(),
    ATTEMPT_020_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
    "scripts/local_v1_lv1_003_o4_execution_authorization_check.py",
    "tests/test_local_v1_lv1_003_o4_execution_authorization_check.py",
...
ATTEMPT_021_CLOSURE_CONTROL_PATH_ALLOWLIST = [
    "Makefile",
    "README.md",
    ATTEMPT_021_DISPOSITION_JSON.as_posix(),
    ATTEMPT_021_DISPOSITION_DOCUMENT.as_posix(),
    CONTRACT.as_posix(),
    DOCUMENT.as_posix(),
...
TOP_LEVEL_FIELDS = {
    ...
    "attempt_012_retry_authorized",
    "attempt_012_authority",
    "fixed_bridge_phase_diagnostic_review_record",
    "fixed_bridge_phase_diagnostic_review_sha256",
    "fixed_bridge_phase_diagnostic_review_record_commit",
    "fixed_bridge_phase_diagnostic_review_record_tree",
    "fixed_bridge_phase_diagnostic_commit",
    "fixed_bridge_phase_diagnostic_tree",
    "fixed_bridge_phase_diagnostic_rejected_commit",
    "fixed_bridge_phase_diagnostic_consumed_baseline",
    "fixed_bridge_phase_diagnostic_path_digests",
    "fixed_bridge_phase_diagnostic_review_disposition",
    "fixed_bridge_phase_diagnostic_review_findings",
    "attempt_013_id",
    "attempt_013_candidate_parent_commit",
    "attempt_013_candidate_parent_tree",
    "attempt_013_operator_command",
    "attempt_013_module_command",
    "attempt_013_kind",
    "attempt_013_run_identity_source",
    "attempt_013_execution_authorized",
    "attempt_013_automatic_retry_authorized",
    "attempt_013_concurrent_invocation_authorized",
    "attempt_013_post_attempt_retry_authorized",
    "attempt_013_review_tag",
    "attempt_013_fixed_node_wait_failure_projection_only",
    "attempt_013_success_not_predicted",
    "attempt_013_immediate_consumed_disposition_required",
    "attempt_013_authority_derived_from_history_or_recovery",
    "attempt_013_attempted_candidate_commit",
    "attempt_013_attempted_candidate_tree",
    "attempt_013_make_exit_code",
    "attempt_013_producer_exit_code",
    "attempt_013_failure_code",
    "attempt_013_primary_failure_code",
    "attempt_013_highest_completed_stage",
    "attempt_013_base_build_completed",
    "attempt_013_bridge_build_completed",
    "attempt_013_bound_image_identity_count",
    "attempt_013_cleanup_failure_codes",
    "attempt_013_recovery_required",
    "attempt_013_run_identity_sha256",
    "attempt_013_compose_project_identity_sha256",
    "attempt_013_raw_invocation_output_sha256",
    "attempt_013_raw_invocation_output_size",
    "attempt_013_diagnostic_projection",
    "attempt_013_root_cause_proven",
    "attempt_013_disposition_json",
    "attempt_013_disposition_json_sha256",
    "attempt_013_disposition_document",
    "attempt_013_disposition_document_sha256",
    "attempt_013_runtime_root_absent",
    "attempt_013_public_report_root_absent",
    ...
    "attempt_014_attempted_candidate_commit",
    "attempt_014_attempted_candidate_tree",
    "attempt_014_make_exit_code",
    "attempt_014_producer_exit_code",
    "attempt_014_failure_code",
    "attempt_014_primary_failure_code",
    "attempt_014_highest_completed_stage",
    "attempt_014_base_build_completed",
    "attempt_014_bridge_build_completed",
    "attempt_014_bound_image_identity_count",
    "attempt_014_cleanup_failure_codes",
    "attempt_014_recovery_required",
    "attempt_014_run_identity_sha256",
    "attempt_014_compose_project_identity_sha256",
    "attempt_014_raw_invocation_output_sha256",
    "attempt_014_raw_invocation_output_size",
    "attempt_014_diagnostic_projection",
    "attempt_014_root_cause_proven",
    "attempt_014_disposition_json",
    "attempt_014_disposition_json_sha256",
    "attempt_014_disposition_document",
    "attempt_014_disposition_document_sha256",
    "attempt_014_runtime_root_absent",
    "attempt_014_public_report_root_absent",
    "attempt_014_public_report_base_absent_point_in_time",
    "socket_parent_mode_review_record",
    "socket_parent_mode_review_sha256",
    "socket_parent_mode_review_record_commit",
    "socket_parent_mode_review_record_tree",
    "socket_parent_mode_commit",
    "socket_parent_mode_tree",
    "socket_parent_mode_parent_commit",
    "socket_parent_mode_path_digests",
    "socket_parent_mode_review_disposition",
    "socket_parent_mode_review_findings",
    "attempt_015_id",
    "attempt_015_candidate_parent_commit",
    "attempt_015_candidate_parent_tree",
    "attempt_015_operator_command",
    "attempt_015_module_command",
    "attempt_015_kind",
    "attempt_015_run_identity_source",
    "attempt_015_execution_authorized",
    "attempt_015_automatic_retry_authorized",
    "attempt_015_concurrent_invocation_authorized",
    "attempt_015_post_attempt_retry_authorized",
    "attempt_015_review_tag",
    "attempt_015_deterministic_source_contradiction_repaired",
    "attempt_015_success_not_predicted",
    "attempt_015_immediate_consumed_disposition_required",
    "attempt_015_authority_derived_from_history_or_recovery",
    "attempt_015_attempted_candidate_commit",
    "attempt_015_attempted_candidate_tree",
    "attempt_015_make_exit_code",
    "attempt_015_producer_exit_code",
    "attempt_015_failure_code",
    "attempt_015_primary_failure_code",
    "attempt_015_highest_completed_stage",
    "attempt_015_base_build_completed",
    "attempt_015_bridge_build_completed",
    "attempt_015_bound_image_identity_count",
    "attempt_015_cleanup_failure_codes",
    "attempt_015_recovery_required",
    "attempt_015_run_identity_sha256",
    "attempt_015_compose_project_identity_sha256",
    "attempt_015_raw_invocation_output_sha256",
    "attempt_015_raw_invocation_output_size",
    "attempt_015_root_cause_proven",
    "attempt_015_disposition_json",
    "attempt_015_disposition_json_sha256",
    "attempt_015_disposition_document",
    "attempt_015_disposition_document_sha256",
    "attempt_015_runtime_root_absent",
    "attempt_015_public_report_root_absent",
    "attempt_015_public_report_base_absent_point_in_time",
    "gateway_mission_projection_review_record",
    "gateway_mission_projection_review_sha256",
    "gateway_mission_projection_review_record_commit",
    "gateway_mission_projection_review_record_tree",
    "gateway_mission_projection_commit",
    "gateway_mission_projection_tree",
    "gateway_mission_projection_parent_commit",
    "gateway_mission_projection_path_digests",
    "gateway_mission_projection_review_disposition",
    "gateway_mission_projection_review_findings",
    "attempt_016_id",
    "attempt_016_candidate_parent_commit",
    "attempt_016_candidate_parent_tree",
    "attempt_016_operator_command",
    "attempt_016_module_command",
    "attempt_016_kind",
    "attempt_016_run_identity_source",
    "attempt_016_execution_authorized",
    "attempt_016_automatic_retry_authorized",
    "attempt_016_concurrent_invocation_authorized",
    "attempt_016_post_attempt_retry_authorized",
    "attempt_016_review_tag",
    "attempt_016_identity_free_gateway_mission_projection_only",
    "attempt_016_success_not_predicted",
    "attempt_016_immediate_consumed_disposition_required",
    "attempt_016_authority_derived_from_history_or_recovery",
    "attempt_016_attempted_candidate_commit",
    "attempt_016_attempted_candidate_tree",
    "attempt_016_make_exit_code",
    "attempt_016_producer_exit_code",
    "attempt_016_failure_code",
    "attempt_016_primary_failure_code",
    "attempt_016_highest_completed_stage",
    "attempt_016_base_build_completed",
    "attempt_016_bridge_build_completed",
    "attempt_016_bound_image_identity_count",
    "attempt_016_cleanup_failure_codes",
    "attempt_016_recovery_required",
    "attempt_016_run_identity_sha256",
    "attempt_016_compose_project_identity_sha256",
    "attempt_016_raw_invocation_output_sha256",
    "attempt_016_raw_invocation_output_size",
    "attempt_016_identity_free_gateway_mission_projection",
    "attempt_016_root_cause_proven",
    "attempt_016_disposition_json",
    "attempt_016_disposition_json_sha256",
    "attempt_016_disposition_document",
    "attempt_016_disposition_document_sha256",
    "attempt_016_runtime_root_absent",
    "attempt_016_public_report_root_absent",
    "attempt_016_public_report_base_absent_point_in_time",
    "mission_convergence_review_record",
    "mission_convergence_review_sha256",
    "mission_convergence_review_record_commit",
    "mission_convergence_review_record_tree",
    "mission_convergence_commit",
    "mission_convergence_tree",
    "mission_convergence_parent_commit",
    "mission_convergence_path_digests",
    "mission_convergence_review_disposition",
    "mission_convergence_review_findings",
    "attempt_017_id",
    "attempt_017_candidate_parent_commit",
    "attempt_017_candidate_parent_tree",
    "attempt_017_operator_command",
    "attempt_017_module_command",
    "attempt_017_kind",
    "attempt_017_run_identity_source",
    "attempt_017_execution_authorized",
    "attempt_017_automatic_retry_authorized",
    "attempt_017_concurrent_invocation_authorized",
    "attempt_017_post_attempt_retry_authorized",
    "attempt_017_review_tag",
    "attempt_017_mission_convergence_semantics_only",
    "attempt_017_success_not_predicted",
    "attempt_017_immediate_consumed_disposition_required",
    "attempt_017_authority_derived_from_history_or_recovery",
    "attempt_017_attempted_candidate_commit",
    "attempt_017_attempted_candidate_tree",
    "attempt_017_make_exit_code",
    "attempt_017_producer_exit_code",
    "attempt_017_failure_code",
    "attempt_017_primary_failure_code",
    "attempt_017_highest_completed_stage",
    "attempt_017_base_build_completed",
    "attempt_017_bridge_build_completed",
    "attempt_017_bound_image_identity_count",
    "attempt_017_cleanup_failure_codes",
    "attempt_017_recovery_required",
    "attempt_017_run_identity_sha256",
    "attempt_017_compose_project_identity_sha256",
    "attempt_017_raw_invocation_output_sha256",
    "attempt_017_raw_invocation_output_size",
    "attempt_017_identity_free_gateway_mission_projection",
    "attempt_017_identity_free_node_receipt_projection",
    "attempt_017_root_cause_proven",
    "attempt_017_disposition_json",
    "attempt_017_disposition_json_sha256",
    "attempt_017_disposition_document",
    "attempt_017_disposition_document_sha256",
    "attempt_017_runtime_root_absent",
    "attempt_017_public_report_root_absent",
    "attempt_017_public_report_base_absent_point_in_time",
    "mission_liveness_terminal_reason_review_record",
    "mission_liveness_terminal_reason_review_sha256",
    "mission_liveness_terminal_reason_review_record_commit",
    "mission_liveness_terminal_reason_review_record_tree",
    "mission_liveness_terminal_reason_commit",
    "mission_liveness_terminal_reason_tree",
    "mission_liveness_terminal_reason_parent_commit",
    "mission_liveness_terminal_reason_path_digests",
    "mission_liveness_terminal_reason_review_disposition",
    "mission_liveness_terminal_reason_review_findings",
    "attempt_018_id",
    "attempt_018_candidate_parent_commit",
    "attempt_018_candidate_parent_tree",
    "attempt_018_operator_command",
    "attempt_018_module_command",
    "attempt_018_kind",
    "attempt_018_run_identity_source",
    "attempt_018_execution_authorized",
    "attempt_018_automatic_retry_authorized",
    "attempt_018_concurrent_invocation_authorized",
    "attempt_018_post_attempt_retry_authorized",
    "attempt_018_review_tag",
    "attempt_018_liveness_and_terminal_reason_semantics_only",
    "attempt_018_success_not_predicted",
    "attempt_018_immediate_consumed_disposition_required",
    "attempt_018_authority_derived_from_history_or_recovery",
    "attempt_018_attempted_candidate_commit",
    "attempt_018_attempted_candidate_tree",
    "attempt_018_make_exit_code",
    "attempt_018_producer_exit_code",
    "attempt_018_failure_code",
    "attempt_018_primary_failure_code",
    "attempt_018_highest_completed_stage",
    "attempt_018_base_build_completed",
    "attempt_018_bridge_build_completed",
    "attempt_018_bound_image_identity_count",
    "attempt_018_cleanup_failure_codes",
    "attempt_018_recovery_required",
    "attempt_018_run_identity_sha256",
    "attempt_018_compose_project_identity_sha256",
    "attempt_018_raw_invocation_output_sha256",
    "attempt_018_raw_invocation_output_size",
    "attempt_018_identity_free_gateway_mission_projection",
    "attempt_018_identity_free_node_receipt_projection",
    "attempt_018_root_cause_proven",
    "attempt_018_disposition_json",
    "attempt_018_disposition_json_sha256",
    "attempt_018_disposition_document",
    "attempt_018_disposition_document_sha256",
    ...
    "attempt_019_attempted_candidate_commit",
    "attempt_019_attempted_candidate_tree",
    "attempt_019_make_exit_code",
    "attempt_019_producer_exit_code",
    "attempt_019_failure_code",
    "attempt_019_primary_failure_code",
    "attempt_019_highest_completed_stage",
    "attempt_019_base_build_completed",
    "attempt_019_bridge_build_completed",
    "attempt_019_bound_image_identity_count",
    "attempt_019_cleanup_failure_codes",
    "attempt_019_recovery_required",
    "attempt_019_run_identity_sha256",
    "attempt_019_compose_project_identity_sha256",
    "attempt_019_raw_invocation_output_sha256",
    "attempt_019_raw_invocation_output_size",
    "attempt_019_terminal_mission_projection_gate_passed_control_flow_only",
    "attempt_019_identity_free_node_receipt_projection",
    "attempt_019_root_cause_proven",
    "attempt_019_disposition_json",
    "attempt_019_disposition_json_sha256",
    "attempt_019_disposition_document",
    "attempt_019_disposition_document_sha256",
    "attempt_019_runtime_root_absent",
    "attempt_019_public_report_root_absent",
    "attempt_019_public_report_base_absent_point_in_time",
    "agent_run_provenance_repair_review_record",
    "agent_run_provenance_repair_review_sha256",
    "agent_run_provenance_repair_review_record_commit",
    "agent_run_provenance_repair_review_record_tree",
    "agent_run_provenance_repair_commit",
    "agent_run_provenance_repair_tree",
    "agent_run_provenance_repair_parent_commit",
    "agent_run_provenance_repair_path_digests",
    "agent_run_provenance_repair_review_disposition",
    "agent_run_provenance_repair_review_findings",
    "attempt_020_id",
    "attempt_020_candidate_parent_commit",
    "attempt_020_candidate_parent_tree",
    "attempt_020_operator_command",
    "attempt_020_module_command",
    "attempt_020_kind",
    "attempt_020_execution_authorized",
    "attempt_020_automatic_retry_authorized",
    "attempt_020_concurrent_invocation_authorized",
    "attempt_020_post_attempt_retry_authorized",
    "attempt_020_recovery_authorized",
    "attempt_020_cleanup_authorized",
    "attempt_020_review_tag",
    "attempt_020_success_not_predicted",
    "attempt_020_immediate_consumed_disposition_required",
    "attempt_020_authority_derived_from_history_or_recovery",
    "attempt_020_attempted_candidate_commit",
    "attempt_020_attempted_candidate_tree",
    "attempt_020_make_exit_code",
    "attempt_020_producer_exit_code",
    "attempt_020_failure_code",
    "attempt_020_primary_failure_code",
    "attempt_020_highest_completed_stage",
    "attempt_020_base_build_completed",
    "attempt_020_bridge_build_completed",
    "attempt_020_bound_image_identity_count",
    "attempt_020_cleanup_failure_codes",
    "attempt_020_recovery_required",
    "attempt_020_run_identity_sha256",
    "attempt_020_compose_project_identity_sha256",
    "attempt_020_raw_invocation_output_sha256",
    "attempt_020_raw_invocation_output_size",
    "attempt_020_identity_free_node_receipt_projection",
    "attempt_020_root_cause_proven",
    "attempt_020_disposition_json",
    "attempt_020_disposition_json_sha256",
    "attempt_020_disposition_document",
    "attempt_020_disposition_document_sha256",
    ...
    "attempt_021_attempted_candidate_commit",
    "attempt_021_attempted_candidate_tree",
    "attempt_021_make_exit_code",
    "attempt_021_producer_exit_code",
    "attempt_021_disposition_json",
    "attempt_021_disposition_json_sha256",
    "attempt_021_disposition_document",
    "attempt_021_disposition_document_sha256",
    "attempt_021_o4_complete",
    "attempt_021_lv1_003_complete",
    "attempt_021_o5_authorized",
...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    attempt_013_disposition = _read_contract(
        repo_root / ATTEMPT_013_DISPOSITION_JSON,
        failures,
    )
    attempt_013_disposition_document = _read_text(
        repo_root / ATTEMPT_013_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_014_disposition = _read_contract(
        repo_root / ATTEMPT_014_DISPOSITION_JSON,
        failures,
    )
    attempt_014_disposition_document = _read_text(
        repo_root / ATTEMPT_014_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_015_disposition = _read_contract(
        repo_root / ATTEMPT_015_DISPOSITION_JSON,
        failures,
    )
    attempt_015_disposition_document = _read_text(
        repo_root / ATTEMPT_015_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_016_disposition = _read_contract(
        repo_root / ATTEMPT_016_DISPOSITION_JSON,
        failures,
    )
    attempt_016_disposition_document = _read_text(
        repo_root / ATTEMPT_016_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_017_disposition = _read_contract(
        repo_root / ATTEMPT_017_DISPOSITION_JSON,
        failures,
    )
    attempt_017_disposition_document = _read_text(
        repo_root / ATTEMPT_017_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_018_disposition = _read_contract(
        repo_root / ATTEMPT_018_DISPOSITION_JSON,
        failures,
    )
    attempt_018_disposition_document = _read_text(
        repo_root / ATTEMPT_018_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_019_disposition = _read_contract(
        repo_root / ATTEMPT_019_DISPOSITION_JSON,
        failures,
    )
    attempt_019_disposition_document = _read_text(
        repo_root / ATTEMPT_019_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_020_disposition = _read_contract(
        repo_root / ATTEMPT_020_DISPOSITION_JSON,
        failures,
    )
    attempt_020_disposition_document = _read_text(
        repo_root / ATTEMPT_020_DISPOSITION_DOCUMENT,
        failures,
    )
    attempt_021_disposition = _read_contract(
        repo_root / ATTEMPT_021_DISPOSITION_JSON,
        failures,
    )
    attempt_021_disposition_document = _read_text(
        repo_root / ATTEMPT_021_DISPOSITION_DOCUMENT,
        failures,
    )
    ...
    fixed_bridge_phase_diagnostic_review = _read_text(
    ...
    socket_parent_mode_review = _read_text(
        repo_root / SOCKET_PARENT_MODE_REVIEW,
        failures,
    )
    gateway_mission_projection_review = _read_text(
        repo_root / GATEWAY_MISSION_PROJECTION_REVIEW,
        failures,
    )
    mission_convergence_review = _read_text(
        repo_root / MISSION_CONVERGENCE_REVIEW,
        failures,
    )
    mission_liveness_terminal_reason_review = _read_text(
    ...
    agent_run_provenance_repair_review = _read_text(
    ...
    _validate_attempt_013_disposition(
        attempt_013_disposition,
        attempt_013_disposition_document,
        failures,
    )
    _validate_attempt_014_disposition(
        attempt_014_disposition,
        attempt_014_disposition_document,
        failures,
    )
    _validate_attempt_015_disposition(
        attempt_015_disposition,
        attempt_015_disposition_document,
        failures,
    )
    _validate_attempt_016_disposition(
        attempt_016_disposition,
        attempt_016_disposition_document,
        failures,
    )
    _validate_attempt_017_disposition(
        attempt_017_disposition,
        attempt_017_disposition_document,
        failures,
    )
    _validate_attempt_018_disposition(
        attempt_018_disposition,
        attempt_018_disposition_document,
        failures,
    )
    _validate_attempt_019_disposition(
        attempt_019_disposition,
        attempt_019_disposition_document,
        failures,
    )
    _validate_attempt_020_disposition(
        attempt_020_disposition,
        attempt_020_disposition_document,
        failures,
    )
    _validate_attempt_021_disposition(
        attempt_021_disposition,
        attempt_021_disposition_document,
        failures,
    )
    ...
    _validate_fixed_bridge_phase_diagnostic_review(
        repo_root,
    ...
    _validate_socket_parent_mode_review(
        repo_root,
        socket_parent_mode_review,
        failures,
    )
    _validate_gateway_mission_projection_review(
        repo_root,
        gateway_mission_projection_review,
        failures,
    )
    _validate_mission_convergence_review(
        repo_root,
        mission_convergence_review,
        failures,
    )
    _validate_mission_liveness_terminal_reason_review(
        repo_root,
    ...
    _validate_agent_run_provenance_repair_review(
        repo_root,
    ...
    _validate_attempt_017_receipts(repo_root, failures)
    _validate_attempt_018_receipts(repo_root, failures)
    _validate_attempt_019_receipts(repo_root, failures)
    _validate_attempt_020_receipts(repo_root, failures)
    _validate_attempt_021_receipts(repo_root, failures)
    ...
    execution_checkout = _validate_execution_checkout(
        ...
        reviewed_commit=ATTEMPT_021_CANDIDATE_COMMIT,
        runtime_paths=ATTEMPT_021_RUNTIME_PATHS,
        control_paths=ATTEMPT_021_CLOSURE_CONTROL_PATH_ALLOWLIST,
        candidate_ref="HEAD",
    ...
    _validate_attempt_013_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_013_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_013_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_014_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_014_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_014_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_015_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_015_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_015_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_016_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_016_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_016_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_017_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_017_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_017_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_018_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_018_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_018_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_019_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_019_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_019_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_020_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_020_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_020_CANDIDATE_TREE,
        failures=failures,
    )
    _validate_attempt_021_review_binding(
        repo_root,
        candidate_commit=ATTEMPT_021_CANDIDATE_COMMIT,
        candidate_tree=ATTEMPT_021_CANDIDATE_TREE,
        failures=failures,
    )
    valid = not failures
    ...
    return {
        ...
        "attempted_candidate_commit": ATTEMPT_021_CANDIDATE_COMMIT,
        "attempted_candidate_tree": ATTEMPT_021_CANDIDATE_TREE,
        ...
        "attempt_014_consumed": True,
        "attempt_015_consumed": True,
        ...
        "next_action": "pause_after_o4_lv1_003_complete_do_not_start_lv1_004_or_o5",
        "producer_code_authorized": (
        ...
        "live_execution_authorized": (
            bool(TRUE_AUTHORITY_FIELDS)
            and all(authority.get(field) is True for field in TRUE_AUTHORITY_FIELDS)
            if valid
            else False
        ),
        "docker_lifecycle_authorized": (
...
def _validate_contract(contract: JsonObject, failures: list[str]) -> None:
    ...
    expected = {
        ...
        "fixed_node_state_projection_contract": {
            "retained_keys": cast(list[JsonValue], FIXED_NODE_STATE_PROJECTION_KEYS),
            "observation_semantics": "sequential_container_then_mission",
            "collection_maximum": 1,
            "fixed_bridge_last_entered_phase_values": cast(
                list[JsonValue],
                FIXED_BRIDGE_PHASE_VALUES,
            ),
            "raw_exit_identity_or_output_retained": False,
            "sequential_nonatomic_noncausal": True,
            "phase_grants_authority": False,
            "phase_predicts_success": False,
            "root_cause_claimed": False,
        ...
        "attempt_012_attempt_consumed": True,
        "attempt_012_execution_attempt_budget": 0,
        "attempt_012_retry_authorized": False,
        "attempt_012_authority": CLOSED_AUTHORITY,
        "fixed_bridge_phase_diagnostic_review_record": (
            FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW.as_posix()
        ),
        "fixed_bridge_phase_diagnostic_review_sha256": (
            FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW_DIGEST
        ),
        "fixed_bridge_phase_diagnostic_review_record_commit": ATTEMPT_013_PARENT_COMMIT,
        "fixed_bridge_phase_diagnostic_review_record_tree": ATTEMPT_013_PARENT_TREE,
        "fixed_bridge_phase_diagnostic_commit": ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT,
        "fixed_bridge_phase_diagnostic_tree": ATTEMPT_013_REVIEWED_IMPLEMENTATION_TREE,
        "fixed_bridge_phase_diagnostic_rejected_commit": (
            FIXED_BRIDGE_PHASE_DIAGNOSTIC_REJECTED_COMMIT
        ),
        "fixed_bridge_phase_diagnostic_consumed_baseline": (
        ...
        "fixed_bridge_phase_diagnostic_review_disposition": "GO_CODE_ONLY",
        "fixed_bridge_phase_diagnostic_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_013_id": ATTEMPT_013_ID,
        "attempt_013_candidate_parent_commit": ATTEMPT_013_PARENT_COMMIT,
        "attempt_013_candidate_parent_tree": ATTEMPT_013_PARENT_TREE,
        "attempt_013_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_013_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_013_kind": (
            "fresh_separately_authorized_diagnostic_successor_"
        ...
        "attempt_013_execution_authorized": True,
        "attempt_013_automatic_retry_authorized": False,
        "attempt_013_concurrent_invocation_authorized": False,
        "attempt_013_post_attempt_retry_authorized": False,
        "attempt_013_review_tag": ATTEMPT_013_REVIEW_TAG,
        "attempt_013_fixed_node_wait_failure_projection_only": True,
        "attempt_013_success_not_predicted": True,
        "attempt_013_immediate_consumed_disposition_required": True,
        "attempt_013_authority_derived_from_history_or_recovery": False,
        "attempt_013_attempted_candidate_commit": ATTEMPT_013_CANDIDATE_COMMIT,
        "attempt_013_attempted_candidate_tree": ATTEMPT_013_CANDIDATE_TREE,
        "attempt_013_make_exit_code": 2,
        "attempt_013_producer_exit_code": 1,
        "attempt_013_failure_code": "fixed_node_start_failed",
        "attempt_013_primary_failure_code": "fixed_node_start_failed",
        "attempt_013_highest_completed_stage": 11,
        "attempt_013_base_build_completed": True,
        "attempt_013_bridge_build_completed": True,
        "attempt_013_bound_image_identity_count": 4,
        "attempt_013_cleanup_failure_codes": [],
        "attempt_013_recovery_required": False,
        "attempt_013_run_identity_sha256": ATTEMPT_013_RUN_IDENTITY_DIGEST,
        "attempt_013_compose_project_identity_sha256": (
            ATTEMPT_013_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_013_raw_invocation_output_sha256": ATTEMPT_013_RAW_OUTPUT_DIGEST,
        "attempt_013_raw_invocation_output_size": ATTEMPT_013_RAW_OUTPUT_SIZE,
        "attempt_013_diagnostic_projection": {
            "collection_status": "complete",
            "collection_reason_code": "fixed_node_start_state_collected",
            "classification": "fixed_node_exited_observation_noncanonical",
        ...
        "attempt_013_root_cause_proven": False,
        "attempt_013_disposition_json": ATTEMPT_013_DISPOSITION_JSON.as_posix(),
        "attempt_013_disposition_json_sha256": ATTEMPT_013_DISPOSITION_JSON_DIGEST,
        "attempt_013_disposition_document": (
            ATTEMPT_013_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_013_disposition_document_sha256": (
        ...
        "attempt_013_runtime_root_absent": True,
        "attempt_013_public_report_root_absent": True,
        ...
        "attempt_014_attempted_candidate_commit": ATTEMPT_014_CANDIDATE_COMMIT,
        "attempt_014_attempted_candidate_tree": ATTEMPT_014_CANDIDATE_TREE,
        "attempt_014_make_exit_code": 2,
        "attempt_014_producer_exit_code": 1,
        "attempt_014_failure_code": "fixed_node_start_failed",
        "attempt_014_primary_failure_code": "fixed_node_start_failed",
        "attempt_014_highest_completed_stage": 11,
        "attempt_014_base_build_completed": True,
        "attempt_014_bridge_build_completed": True,
        "attempt_014_bound_image_identity_count": 4,
        "attempt_014_cleanup_failure_codes": [],
        "attempt_014_recovery_required": False,
        "attempt_014_run_identity_sha256": ATTEMPT_014_RUN_IDENTITY_DIGEST,
        "attempt_014_compose_project_identity_sha256": (
            ATTEMPT_014_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_014_raw_invocation_output_sha256": ATTEMPT_014_RAW_OUTPUT_DIGEST,
        "attempt_014_raw_invocation_output_size": ATTEMPT_014_RAW_OUTPUT_SIZE,
        "attempt_014_diagnostic_projection": {
            "collection_status": "complete",
            "collection_reason_code": "fixed_node_start_state_collected",
            "classification": "fixed_node_exited_observation_noncanonical",
            ...
            "delivery_state": "claim_delivered",
            "evidence_state": "complete",
            "fixed_bridge_last_entered_phase": "socket_parent_validation_entered",
        },
        "attempt_014_root_cause_proven": False,
        "attempt_014_disposition_json": ATTEMPT_014_DISPOSITION_JSON.as_posix(),
        "attempt_014_disposition_json_sha256": ATTEMPT_014_DISPOSITION_JSON_DIGEST,
        "attempt_014_disposition_document": (
            ATTEMPT_014_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_014_disposition_document_sha256": (
        ...
        "attempt_014_runtime_root_absent": True,
        "attempt_014_public_report_root_absent": True,
        "attempt_014_public_report_base_absent_point_in_time": True,
        "socket_parent_mode_review_record": SOCKET_PARENT_MODE_REVIEW.as_posix(),
        "socket_parent_mode_review_sha256": SOCKET_PARENT_MODE_REVIEW_DIGEST,
        "socket_parent_mode_review_record_commit": (
            SOCKET_PARENT_MODE_REVIEW_RECORD_COMMIT
        ),
        "socket_parent_mode_review_record_tree": SOCKET_PARENT_MODE_REVIEW_RECORD_TREE,
        "socket_parent_mode_commit": SOCKET_PARENT_MODE_COMMIT,
        "socket_parent_mode_tree": SOCKET_PARENT_MODE_TREE,
        "socket_parent_mode_parent_commit": SOCKET_PARENT_MODE_PARENT_COMMIT,
        "socket_parent_mode_path_digests": SOCKET_PARENT_MODE_PATH_DIGESTS,
        "socket_parent_mode_review_disposition": "GO_CODE_ONLY",
        "socket_parent_mode_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_015_id": ATTEMPT_015_ID,
        "attempt_015_candidate_parent_commit": SOCKET_PARENT_MODE_REVIEW_RECORD_COMMIT,
        "attempt_015_candidate_parent_tree": SOCKET_PARENT_MODE_REVIEW_RECORD_TREE,
        "attempt_015_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_015_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_015_kind": (
            "fresh_separately_authorized_diagnostic_successor_"
            "not_retry_recovery_repair_or_cleanup"
        ),
        ...
        "attempt_015_execution_authorized": False,
        "attempt_015_automatic_retry_authorized": False,
        "attempt_015_concurrent_invocation_authorized": False,
        "attempt_015_post_attempt_retry_authorized": False,
        "attempt_015_review_tag": ATTEMPT_015_REVIEW_TAG,
        "attempt_015_deterministic_source_contradiction_repaired": True,
        "attempt_015_success_not_predicted": True,
        "attempt_015_immediate_consumed_disposition_required": True,
        "attempt_015_authority_derived_from_history_or_recovery": False,
        "attempt_015_attempted_candidate_commit": ATTEMPT_015_CANDIDATE_COMMIT,
        "attempt_015_attempted_candidate_tree": ATTEMPT_015_CANDIDATE_TREE,
        "attempt_015_make_exit_code": 2,
        "attempt_015_producer_exit_code": 1,
        "attempt_015_failure_code": "gateway_mission_projection_invalid",
        "attempt_015_primary_failure_code": "gateway_mission_projection_invalid",
        "attempt_015_highest_completed_stage": 13,
        "attempt_015_base_build_completed": True,
        "attempt_015_bridge_build_completed": True,
        "attempt_015_bound_image_identity_count": 4,
        "attempt_015_cleanup_failure_codes": [],
        "attempt_015_recovery_required": False,
        "attempt_015_run_identity_sha256": ATTEMPT_015_RUN_IDENTITY_DIGEST,
        "attempt_015_compose_project_identity_sha256": (
            ATTEMPT_015_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_015_raw_invocation_output_sha256": ATTEMPT_015_RAW_OUTPUT_DIGEST,
        "attempt_015_raw_invocation_output_size": ATTEMPT_015_RAW_OUTPUT_SIZE,
        "attempt_015_root_cause_proven": False,
        "attempt_015_disposition_json": ATTEMPT_015_DISPOSITION_JSON.as_posix(),
        "attempt_015_disposition_json_sha256": ATTEMPT_015_DISPOSITION_JSON_DIGEST,
        "attempt_015_disposition_document": (
            ATTEMPT_015_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_015_disposition_document_sha256": (
        ...
        "attempt_015_runtime_root_absent": True,
        "attempt_015_public_report_root_absent": True,
        "attempt_015_public_report_base_absent_point_in_time": True,
        "gateway_mission_projection_review_record": (
            GATEWAY_MISSION_PROJECTION_REVIEW.as_posix()
        ),
        "gateway_mission_projection_review_sha256": (
            GATEWAY_MISSION_PROJECTION_REVIEW_DIGEST
        ),
        ...
        "gateway_mission_projection_commit": GATEWAY_MISSION_PROJECTION_COMMIT,
        "gateway_mission_projection_tree": GATEWAY_MISSION_PROJECTION_TREE,
        "gateway_mission_projection_parent_commit": (
            GATEWAY_MISSION_PROJECTION_PARENT_COMMIT
        ),
        "gateway_mission_projection_path_digests": (
        ...
        "gateway_mission_projection_review_disposition": "GO_CODE_ONLY",
        "gateway_mission_projection_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_016_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_016_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_016_kind": (
            "fresh_separately_authorized_identity_free_gateway_mission_projection_"
            "diagnostic_not_retry_recovery_repair_or_cleanup"
        ),
        "attempt_016_run_identity_source": (
            "producer_generated_fresh_run_project_suffix_runtime_receipt_and_evidence_paths"
        ),
        "attempt_016_execution_authorized": False,
        "attempt_016_automatic_retry_authorized": False,
        "attempt_016_concurrent_invocation_authorized": False,
        "attempt_016_post_attempt_retry_authorized": False,
        "attempt_016_review_tag": ATTEMPT_016_REVIEW_TAG,
        "attempt_016_identity_free_gateway_mission_projection_only": True,
        "attempt_016_success_not_predicted": True,
        "attempt_016_immediate_consumed_disposition_required": True,
        "attempt_016_authority_derived_from_history_or_recovery": False,
        "attempt_016_attempted_candidate_commit": ATTEMPT_016_CANDIDATE_COMMIT,
        "attempt_016_attempted_candidate_tree": ATTEMPT_016_CANDIDATE_TREE,
        "attempt_016_make_exit_code": 2,
        "attempt_016_producer_exit_code": 1,
        "attempt_016_failure_code": "gateway_mission_projection_invalid",
        "attempt_016_primary_failure_code": "gateway_mission_projection_invalid",
        "attempt_016_highest_completed_stage": 13,
        "attempt_016_base_build_completed": True,
        "attempt_016_bridge_build_completed": True,
        "attempt_016_bound_image_identity_count": 4,
        "attempt_016_cleanup_failure_codes": [],
        "attempt_016_recovery_required": False,
        "attempt_016_run_identity_sha256": ATTEMPT_016_RUN_IDENTITY_DIGEST,
        "attempt_016_compose_project_identity_sha256": (
            ATTEMPT_016_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_016_raw_invocation_output_sha256": ATTEMPT_016_RAW_OUTPUT_DIGEST,
        "attempt_016_raw_invocation_output_size": ATTEMPT_016_RAW_OUTPUT_SIZE,
        "attempt_016_identity_free_gateway_mission_projection": {
            "collection_status": "complete",
        ...
        "attempt_016_root_cause_proven": False,
        "attempt_016_disposition_json": ATTEMPT_016_DISPOSITION_JSON.as_posix(),
        "attempt_016_disposition_json_sha256": ATTEMPT_016_DISPOSITION_JSON_DIGEST,
        "attempt_016_disposition_document": (
            ATTEMPT_016_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_016_disposition_document_sha256": (
        ...
        "attempt_016_runtime_root_absent": True,
        "attempt_016_public_report_root_absent": True,
        "attempt_016_public_report_base_absent_point_in_time": True,
        "mission_convergence_review_record": MISSION_CONVERGENCE_REVIEW.as_posix(),
        "mission_convergence_review_sha256": MISSION_CONVERGENCE_REVIEW_DIGEST,
        "mission_convergence_review_record_commit": (
            MISSION_CONVERGENCE_REVIEW_RECORD_COMMIT
        ),
        "mission_convergence_review_record_tree": MISSION_CONVERGENCE_REVIEW_RECORD_TREE,
        "mission_convergence_commit": MISSION_CONVERGENCE_COMMIT,
        "mission_convergence_tree": MISSION_CONVERGENCE_TREE,
        "mission_convergence_parent_commit": MISSION_CONVERGENCE_PARENT_COMMIT,
        "mission_convergence_path_digests": MISSION_CONVERGENCE_PATH_DIGESTS,
        "mission_convergence_review_disposition": "GO_CODE_ONLY",
        "mission_convergence_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_017_id": ATTEMPT_017_ID,
        "attempt_017_candidate_parent_commit": MISSION_CONVERGENCE_REVIEW_RECORD_COMMIT,
        "attempt_017_candidate_parent_tree": MISSION_CONVERGENCE_REVIEW_RECORD_TREE,
        "attempt_017_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_017_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_017_kind": (
            "fresh_separately_authorized_mission_convergence_successor_"
            "not_retry_recovery_repair_or_cleanup"
        ),
        "attempt_017_run_identity_source": (
            "producer_generated_fresh_run_project_suffix_runtime_receipt_and_evidence_paths"
        ),
        "attempt_017_execution_authorized": False,
        "attempt_017_automatic_retry_authorized": False,
        "attempt_017_concurrent_invocation_authorized": False,
        "attempt_017_post_attempt_retry_authorized": False,
        "attempt_017_review_tag": ATTEMPT_017_REVIEW_TAG,
        "attempt_017_mission_convergence_semantics_only": True,
        "attempt_017_success_not_predicted": True,
        "attempt_017_immediate_consumed_disposition_required": True,
        "attempt_017_authority_derived_from_history_or_recovery": False,
        "attempt_017_attempted_candidate_commit": ATTEMPT_017_CANDIDATE_COMMIT,
        "attempt_017_attempted_candidate_tree": ATTEMPT_017_CANDIDATE_TREE,
        "attempt_017_make_exit_code": 2,
        "attempt_017_producer_exit_code": 1,
        "attempt_017_failure_code": "gateway_mission_projection_invalid",
        "attempt_017_primary_failure_code": "gateway_mission_projection_invalid",
        "attempt_017_highest_completed_stage": 13,
        "attempt_017_base_build_completed": True,
        "attempt_017_bridge_build_completed": True,
        "attempt_017_bound_image_identity_count": 4,
        "attempt_017_cleanup_failure_codes": [],
        "attempt_017_recovery_required": False,
        "attempt_017_run_identity_sha256": ATTEMPT_017_RUN_IDENTITY_DIGEST,
        "attempt_017_compose_project_identity_sha256": (
            ATTEMPT_017_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_017_raw_invocation_output_sha256": ATTEMPT_017_RAW_OUTPUT_DIGEST,
        "attempt_017_raw_invocation_output_size": ATTEMPT_017_RAW_OUTPUT_SIZE,
        "attempt_017_identity_free_gateway_mission_projection": {
            "collection_status": "complete",
            "collection_reason_code": "gateway_mission_projection_state_collected",
            "mission_identity_binding": "matched",
        ...
        "attempt_017_root_cause_proven": False,
        "attempt_017_disposition_json": ATTEMPT_017_DISPOSITION_JSON.as_posix(),
        "attempt_017_disposition_json_sha256": ATTEMPT_017_DISPOSITION_JSON_DIGEST,
        "attempt_017_disposition_document": (
            ATTEMPT_017_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_017_disposition_document_sha256": (
        ...
        "attempt_017_runtime_root_absent": True,
        "attempt_017_public_report_root_absent": True,
        "attempt_017_public_report_base_absent_point_in_time": True,
        "mission_liveness_terminal_reason_review_record": (
            MISSION_LIVENESS_TERMINAL_REASON_REVIEW.as_posix()
        ),
        "mission_liveness_terminal_reason_review_sha256": (
            MISSION_LIVENESS_TERMINAL_REASON_REVIEW_DIGEST
        ),
        ...
        "mission_liveness_terminal_reason_tree": MISSION_LIVENESS_TERMINAL_REASON_TREE,
        "mission_liveness_terminal_reason_parent_commit": (
            MISSION_LIVENESS_TERMINAL_REASON_PARENT_COMMIT
        ),
        "mission_liveness_terminal_reason_path_digests": (
        ...
        "mission_liveness_terminal_reason_review_disposition": "GO_CODE_ONLY",
        "mission_liveness_terminal_reason_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_018_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_018_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_018_kind": (
            "fresh_separately_authorized_liveness_terminal_reason_successor_"
            "not_retry_recovery_repair_or_cleanup"
        ),
        "attempt_018_run_identity_source": (
            "producer_generated_fresh_run_project_suffix_runtime_receipt_and_evidence_paths"
        ),
        "attempt_018_execution_authorized": False,
        "attempt_018_automatic_retry_authorized": False,
        "attempt_018_concurrent_invocation_authorized": False,
        "attempt_018_post_attempt_retry_authorized": False,
        "attempt_018_review_tag": ATTEMPT_018_REVIEW_TAG,
        "attempt_018_liveness_and_terminal_reason_semantics_only": True,
        "attempt_018_success_not_predicted": True,
        "attempt_018_immediate_consumed_disposition_required": True,
        "attempt_018_authority_derived_from_history_or_recovery": False,
        "attempt_018_attempted_candidate_commit": ATTEMPT_018_CANDIDATE_COMMIT,
        "attempt_018_attempted_candidate_tree": ATTEMPT_018_CANDIDATE_TREE,
        "attempt_018_make_exit_code": 2,
        "attempt_018_producer_exit_code": 1,
        "attempt_018_failure_code": "gateway_mission_projection_invalid",
        "attempt_018_primary_failure_code": "gateway_mission_projection_invalid",
        "attempt_018_highest_completed_stage": 13,
        "attempt_018_base_build_completed": True,
        "attempt_018_bridge_build_completed": True,
        "attempt_018_bound_image_identity_count": 4,
        "attempt_018_cleanup_failure_codes": [],
        "attempt_018_recovery_required": False,
        "attempt_018_run_identity_sha256": ATTEMPT_018_RUN_IDENTITY_DIGEST,
        "attempt_018_compose_project_identity_sha256": (
            ATTEMPT_018_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_018_raw_invocation_output_sha256": ATTEMPT_018_RAW_OUTPUT_DIGEST,
        "attempt_018_raw_invocation_output_size": ATTEMPT_018_RAW_OUTPUT_SIZE,
        "attempt_018_identity_free_gateway_mission_projection": {
            "collection_status": "complete",
            "collection_reason_code": "gateway_mission_projection_state_collected",
            "mission_identity_binding": "matched",
        ...
        "attempt_018_identity_free_node_receipt_projection": {
            ...
            "next_operation": "completion_pending",
            "last_closed_status": "failed_closed",
            "last_closed_reason_code": "bridge_disconnected",
        },
        "attempt_018_root_cause_proven": False,
        "attempt_018_disposition_json": ATTEMPT_018_DISPOSITION_JSON.as_posix(),
        "attempt_018_disposition_json_sha256": ATTEMPT_018_DISPOSITION_JSON_DIGEST,
        "attempt_018_disposition_document": (
            ATTEMPT_018_DISPOSITION_DOCUMENT.as_posix()
        ),
        "attempt_018_disposition_document_sha256": (
        ...
        "attempt_019_candidate_parent_tree": TWO_OPERATION_TERMINAL_REPAIR_REVIEW_RECORD_TREE,
        ...
        "attempt_019_execution_authorized": False,
        ...
        "attempt_019_attempted_candidate_commit": ATTEMPT_019_CANDIDATE_COMMIT,
        "attempt_019_attempted_candidate_tree": ATTEMPT_019_CANDIDATE_TREE,
        "attempt_019_make_exit_code": 2,
        "attempt_019_producer_exit_code": 1,
        "attempt_019_failure_code": "gateway_run_detail_invalid",
        "attempt_019_primary_failure_code": "gateway_run_detail_invalid",
        "attempt_019_highest_completed_stage": 13,
        "attempt_019_base_build_completed": True,
        "attempt_019_bridge_build_completed": True,
        "attempt_019_bound_image_identity_count": 4,
        "attempt_019_cleanup_failure_codes": [],
        "attempt_019_recovery_required": False,
        "attempt_019_run_identity_sha256": ATTEMPT_019_RUN_IDENTITY_DIGEST,
        "attempt_019_compose_project_identity_sha256": (
            ATTEMPT_019_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_019_raw_invocation_output_sha256": ATTEMPT_019_RAW_OUTPUT_DIGEST,
        "attempt_019_raw_invocation_output_size": ATTEMPT_019_RAW_OUTPUT_SIZE,
        "attempt_019_terminal_mission_projection_gate_passed_control_flow_only": True,
        "attempt_019_identity_free_node_receipt_projection": {
            "collection_status": "complete",
            "collection_reason_code": "node_receipt_projection_state_collected",
            "receipt_shape": "exact",
            ...
            "envelope_binding": "valid_digest",
            "handoff_nonce_binding": "valid_digest",
            "next_operation": "completion_recorded",
            "last_closed_status": "runner_reported_succeeded",
            "last_closed_reason_code": "none",
        },
        "attempt_019_root_cause_proven": False,
        "attempt_019_disposition_json": ATTEMPT_019_DISPOSITION_JSON.as_posix(),
        "attempt_019_disposition_json_sha256": ATTEMPT_019_DISPOSITION_JSON_DIGEST,
        "attempt_019_disposition_document": ATTEMPT_019_DISPOSITION_DOCUMENT.as_posix(),
        "attempt_019_disposition_document_sha256": (
            ATTEMPT_019_DISPOSITION_DOCUMENT_DIGEST
        ),
        "attempt_019_runtime_root_absent": True,
        "attempt_019_public_report_root_absent": True,
        "attempt_019_public_report_base_absent_point_in_time": True,
        "agent_run_provenance_repair_review_record": (
            AGENT_RUN_PROVENANCE_REPAIR_REVIEW.as_posix()
        ),
        "agent_run_provenance_repair_review_sha256": (
            AGENT_RUN_PROVENANCE_REPAIR_REVIEW_DIGEST
        ),
        ...
        "agent_run_provenance_repair_commit": AGENT_RUN_PROVENANCE_REPAIR_COMMIT,
        "agent_run_provenance_repair_tree": AGENT_RUN_PROVENANCE_REPAIR_TREE,
        "agent_run_provenance_repair_parent_commit": (
            AGENT_RUN_PROVENANCE_REPAIR_PARENT_COMMIT
        ),
        "agent_run_provenance_repair_path_digests": (
        ...
        "agent_run_provenance_repair_review_disposition": "GO",
        "agent_run_provenance_repair_review_findings": {
            "critical": 0,
            "high": 0,
            "medium": 0,
        ...
        "attempt_020_operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "attempt_020_module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_020_kind": (
            "fresh_separately_authorized_agent_run_provenance_successor_"
            "not_retry_recovery_cleanup_or_continuation"
        ),
        "attempt_020_execution_authorized": False,
        "attempt_020_automatic_retry_authorized": False,
        "attempt_020_concurrent_invocation_authorized": False,
        "attempt_020_post_attempt_retry_authorized": False,
        "attempt_020_recovery_authorized": False,
        "attempt_020_cleanup_authorized": False,
        "attempt_020_review_tag": ATTEMPT_020_REVIEW_TAG,
        "attempt_020_success_not_predicted": True,
        "attempt_020_immediate_consumed_disposition_required": True,
        "attempt_020_authority_derived_from_history_or_recovery": False,
        "attempt_020_attempted_candidate_commit": ATTEMPT_020_CANDIDATE_COMMIT,
        "attempt_020_attempted_candidate_tree": ATTEMPT_020_CANDIDATE_TREE,
        "attempt_020_make_exit_code": 2,
        "attempt_020_producer_exit_code": 1,
        "attempt_020_failure_code": "gateway_run_detail_invalid",
        "attempt_020_primary_failure_code": "gateway_run_detail_invalid",
        "attempt_020_highest_completed_stage": 13,
        "attempt_020_base_build_completed": True,
        "attempt_020_bridge_build_completed": True,
        "attempt_020_bound_image_identity_count": 4,
        "attempt_020_cleanup_failure_codes": [],
        "attempt_020_recovery_required": False,
        "attempt_020_run_identity_sha256": ATTEMPT_020_RUN_IDENTITY_DIGEST,
        "attempt_020_compose_project_identity_sha256": (
            ATTEMPT_020_PROJECT_IDENTITY_DIGEST
        ),
        "attempt_020_raw_invocation_output_sha256": ATTEMPT_020_RAW_OUTPUT_DIGEST,
        "attempt_020_raw_invocation_output_size": ATTEMPT_020_RAW_OUTPUT_SIZE,
        "attempt_020_identity_free_node_receipt_projection": {
            "collection_status": "complete",
            "collection_reason_code": "node_receipt_projection_state_collected",
            "receipt_shape": "exact",
        ...
        "attempt_020_root_cause_proven": False,
        "attempt_020_disposition_json": ATTEMPT_020_DISPOSITION_JSON.as_posix(),
        "attempt_020_disposition_json_sha256": ATTEMPT_020_DISPOSITION_JSON_DIGEST,
        "attempt_020_disposition_document": ATTEMPT_020_DISPOSITION_DOCUMENT.as_posix(),
        "attempt_020_disposition_document_sha256": (
            ATTEMPT_020_DISPOSITION_DOCUMENT_DIGEST
        ),
        ...
        "attempt_021_execution_authorized": False,
        ...
        "attempt_021_attempted_candidate_commit": ATTEMPT_021_CANDIDATE_COMMIT,
        "attempt_021_attempted_candidate_tree": ATTEMPT_021_CANDIDATE_TREE,
        "attempt_021_make_exit_code": 0,
        "attempt_021_producer_exit_code": 0,
        "attempt_021_disposition_json": ATTEMPT_021_DISPOSITION_JSON.as_posix(),
        "attempt_021_disposition_json_sha256": ATTEMPT_021_DISPOSITION_JSON_DIGEST,
        "attempt_021_disposition_document": ATTEMPT_021_DISPOSITION_DOCUMENT.as_posix(),
        "attempt_021_disposition_document_sha256": (
            ATTEMPT_021_DISPOSITION_DOCUMENT_DIGEST
        ),
        "attempt_021_o4_complete": True,
        "attempt_021_lv1_003_complete": True,
        "attempt_021_o5_authorized": False,
        "mcc_authorization_index_reconciliation_review_record": (
            MCC_AUTHORIZATION_INDEX_RECONCILIATION_REVIEW.as_posix()
        ),
        "mcc_authorization_index_reconciliation_review_sha256": (
...
def _validate_document(document: str, failures: list[str]) -> None:
    ...
    for phrase in (
        "Status: `ATTEMPT_021_CONSUMED_SUCCESS_O4_LV1_003_COMPLETE_"
        "NO_LIVE_AUTHORITY`",
        ATTEMPT_021_ID,
        ATTEMPT_021_REVIEW_TAG,
        GATEWAY_SESSION_BINDING_REPAIR_REVIEW_RECORD_COMMIT,
        ...
        AGENT_RUN_PROVENANCE_REPAIR_PARENT_COMMIT,
        AGENT_RUN_PROVENANCE_REPAIR_REVIEW_DIGEST,
        "Attempt 020 was a fresh successor",
        "immediate consumed disposition is recorded",
        "All 19 authority fields are false",
        "completion_recorded",
        "runner_reported_succeeded",
        "proves no root cause",
        "no Attempt 021",
        ATTEMPT_019_ID,
        ATTEMPT_019_REVIEW_TAG,
        ATTEMPT_019_CANDIDATE_COMMIT,
        ATTEMPT_019_CANDIDATE_TREE,
        ATTEMPT_019_RUN_IDENTITY_DIGEST,
        ATTEMPT_019_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_019_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_019_DIAGNOSTIC_RECEIPT_DIGEST,
        ...
        "completion_recorded",
        "runner_reported_succeeded",
        "No Gateway mission projection is stored or reproduced",
        "not proof of overall O4 success",
        "no Attempt 020",
        ATTEMPT_018_ID,
        ATTEMPT_018_REVIEW_TAG,
        ATTEMPT_018_CANDIDATE_COMMIT,
        ATTEMPT_018_CANDIDATE_TREE,
        ATTEMPT_018_RUN_IDENTITY_DIGEST,
        ATTEMPT_018_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_018_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_018_DIAGNOSTIC_RECEIPT_DIGEST,
        ATTEMPT_018_DISPOSITION_RECEIPT_DIGEST,
        ATTEMPT_018_DISPOSITION_JSON.as_posix(),
        MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_COMMIT,
        MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_TREE,
        MISSION_LIVENESS_TERMINAL_REASON_COMMIT,
        ...
        "bridge_disconnected",
        "Attempt 019 was a fresh successor",
        ATTEMPT_017_ID,
        ATTEMPT_017_REVIEW_TAG,
        ATTEMPT_017_CANDIDATE_COMMIT,
        ATTEMPT_017_CANDIDATE_TREE,
        ATTEMPT_017_RUN_IDENTITY_DIGEST,
        ATTEMPT_017_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_017_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_017_DIAGNOSTIC_RECEIPT_DIGEST,
        ATTEMPT_017_DISPOSITION_RECEIPT_DIGEST,
        ATTEMPT_017_DISPOSITION_JSON.as_posix(),
        MISSION_CONVERGENCE_REVIEW_RECORD_COMMIT,
        MISSION_CONVERGENCE_REVIEW_RECORD_TREE,
        MISSION_CONVERGENCE_COMMIT,
        ...
        "not Attempt 018 or repair authority",
        ATTEMPT_016_ID,
        ATTEMPT_016_REVIEW_TAG,
        ATTEMPT_016_CANDIDATE_COMMIT,
        ATTEMPT_016_CANDIDATE_TREE,
        ATTEMPT_016_RUN_IDENTITY_DIGEST,
        ATTEMPT_016_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_016_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_016_DIAGNOSTIC_RECEIPT_DIGEST,
        ...
        GATEWAY_MISSION_PROJECTION_TREE,
        "runner_reported_running",
        "future separately reviewed bounded convergence or polling design",
        "proves no root cause",
        "all 19 authority fields are false",
        "not Attempt 017 or repair authority",
        ATTEMPT_015_ID,
        ATTEMPT_015_REVIEW_TAG,
        ATTEMPT_015_CANDIDATE_COMMIT,
        ATTEMPT_015_CANDIDATE_TREE,
        ATTEMPT_015_RUN_IDENTITY_DIGEST,
        ATTEMPT_015_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_015_RAW_OUTPUT_DIGEST,
        ATTEMPT_015_MANIFEST_RECEIPT_DIGEST,
        ...
        "highest completed stage was `13`",
        "Attempt budget is zero",
        "`attempt_consumed` is true",
        "All 19 authority fields are false",
        "separately reviewed bounded source diagnosis or repair",
        SOCKET_PARENT_MODE_REVIEW.as_posix(),
        SOCKET_PARENT_MODE_REVIEW_DIGEST,
        SOCKET_PARENT_MODE_REVIEW_RECORD_COMMIT,
        SOCKET_PARENT_MODE_REVIEW_RECORD_TREE,
        SOCKET_PARENT_MODE_COMMIT,
        ...
        "Critical 0, High 0, Medium 0, Low 0",
        ATTEMPT_014_CANDIDATE_COMMIT,
        ATTEMPT_014_CANDIDATE_TREE,
        ATTEMPT_014_RUN_IDENTITY_DIGEST,
        ATTEMPT_014_PROJECT_IDENTITY_DIGEST,
        ATTEMPT_014_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_014_DIAGNOSTIC_RECEIPT_DIGEST,
        ATTEMPT_014_DISPOSITION_RECEIPT_DIGEST,
        ATTEMPT_014_DISPOSITION_JSON.as_posix(),
        "phase `socket_parent_validation_entered`",
        "Attempt budget is zero",
        "`attempt_consumed` is true",
        "All 19 authority fields are false",
        "separately reviewed bounded source diagnosis or repair",
        ...
        ATTEMPT_013_PARENT_COMMIT,
        ATTEMPT_013_PARENT_TREE,
        ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT,
        ATTEMPT_013_REVIEWED_IMPLEMENTATION_TREE,
        FIXED_BRIDGE_PHASE_DIAGNOSTIC_REJECTED_COMMIT,
        FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW.as_posix(),
        FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW_DIGEST,
        ...
        ATTEMPT_013_MANIFEST_RECEIPT_DIGEST,
        ATTEMPT_013_DIAGNOSTIC_RECEIPT_DIGEST,
        ATTEMPT_013_DISPOSITION_RECEIPT_DIGEST,
        ATTEMPT_013_DISPOSITION_JSON.as_posix(),
        ...
        "cleanup completed under reviewed producer semantics",
        "phase `not_reported`",
        "sequential, nonatomic, and noncausal",
        "proves no root cause, repair, safe retry, success, or authority",
        "Attempt 013 observed health `unhealthy`",
        "does not explain the underlying fixed-Node exit",
        "Attempt budget is zero",
        "`attempt_consumed` is true",
        "All 19 authority fields are false",
        "separately reviewed source repair or decision",
        "not a fixed-Node root-cause claim, a retry, or successor authorization",
        ...
        "to the Attempt 013 review-record parent",
...
def _validate_attempt_013_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 013 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_013_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 013 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
...
def _validate_attempt_015_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 015 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_015_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 015 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
    ...
    if (
        ...
        failures.append("O4 Attempt 015 annotated review tag does not peel to the exact candidate")


def _validate_attempt_016_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 016 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_016_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 016 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
    ...
    if (
        ...
        failures.append("O4 Attempt 016 annotated review tag does not peel to the exact candidate")


def _validate_attempt_017_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 017 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_017_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 017 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
    ...
    if (
        ...
        failures.append("O4 Attempt 017 annotated review tag does not peel to the exact candidate")


def _validate_attempt_018_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 018 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_018_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 018 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
...
def _validate_attempt_020_review_binding(
    repo_root: Path,
    *,
    candidate_commit: str | None,
    candidate_tree: str | None,
    ...
    if candidate_commit is None or candidate_tree is None:
        failures.append("O4 Attempt 020 review binding has no exact execution candidate")
        return
    reference = f"refs/tags/{ATTEMPT_020_REVIEW_TAG}"
    object_type = subprocess.run(
        ["git", "-C", str(repo_root), "cat-file", "-t", reference],
        check=False,
        capture_output=True,
    ...
    if object_type.returncode != 0 or object_type.stdout.strip() != "tag":
        failures.append("O4 Attempt 020 review tag is missing or not annotated")
        return
    tagged_commit = subprocess.run(
        ["git", "-C", str(repo_root), "rev-parse", f"{reference}^{{commit}}"],
        check=False,
...
def _validate_fixed_bridge_phase_diagnostic_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        if phrase not in normalized:
            failures.append(f"O4 fixed-bridge phase review is missing phrase: {phrase}")
    if _digest(document) != FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW_DIGEST:
        failures.append("O4 fixed-bridge phase review digest is invalid")

    for commit, expected_tree, expected_parents, label in (
        (
            ATTEMPT_013_PARENT_COMMIT,
            ATTEMPT_013_PARENT_TREE,
            [ATTEMPT_013_PARENT_PARENT],
            "review record",
        ),
        (
            ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT,
        ...
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 fixed-bridge phase {label} lineage is invalid")
    ...
    if sorted(changed) != sorted(ATTEMPT_013_RUNTIME_PATHS):
        failures.append("O4 fixed-bridge phase changed paths are not the exact six-path set")
    for path, expected_digest in FIXED_BRIDGE_PHASE_DIAGNOSTIC_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            [
                "git",
                ...
                str(repo_root),
                "show",
                f"{ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT}:{path}",
            ],
            check=False,
            capture_output=True,
        )
...
def _validate_socket_parent_mode_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        "Medium: 0",
        "Low: 0",
        "exact member of that set",
        "group-write or world-write permission bits are rejected",
        "dir_fd",
        "exactly `{0o770}`",
        "governed tool count remains exactly 24",
        "does not authorize another O4 execution",
    ):
        if phrase not in normalized:
            failures.append(f"O4 socket-parent mode review is missing phrase: {phrase}")
    if _digest(document) != SOCKET_PARENT_MODE_REVIEW_DIGEST:
        failures.append("O4 socket-parent mode review digest is invalid")
    for commit, expected_tree, expected_parents, label in (
        (
            SOCKET_PARENT_MODE_REVIEW_RECORD_COMMIT,
            SOCKET_PARENT_MODE_REVIEW_RECORD_TREE,
        ...
        parents = _git(repo_root, ["show", "-s", "--format=%P", commit], failures).split()
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 socket-parent mode {label} lineage is invalid")
    changed = _git(
        repo_root,
        [
            "diff-tree",
    ...
    if changed != ATTEMPT_015_RUNTIME_PATHS:
        failures.append("O4 socket-parent mode changed paths are not exact")
    for path, expected_digest in SOCKET_PARENT_MODE_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            ["git", "-C", str(repo_root), "show", f"{SOCKET_PARENT_MODE_COMMIT}:{path}"],
            check=False,
            capture_output=True,
        )
        observed = "sha256:" + hashlib.sha256(result.stdout).hexdigest()
        if result.returncode != 0 or observed != expected_digest:
            failures.append(f"O4 socket-parent mode digest is invalid: {path}")


def _validate_gateway_mission_projection_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        "Medium: 0",
        "Low: 0",
        "closed, identity-free observations",
        "gateway_mission_projection_invalid",
        "successful journey predicate remains semantically unchanged",
        "governed tool count remains exactly 24",
        "does not prove the Attempt015 root cause",
        "predict Attempt016 success",
        "No execution authority exists in this record",
    ):
        if phrase not in normalized:
            failures.append(
                f"O4 Gateway mission projection review is missing phrase: {phrase}"
            )
    if _digest(document) != GATEWAY_MISSION_PROJECTION_REVIEW_DIGEST:
        failures.append("O4 Gateway mission projection review digest is invalid")
    for commit, expected_tree, expected_parents, label in (
        (
            GATEWAY_MISSION_PROJECTION_REVIEW_RECORD_COMMIT,
            GATEWAY_MISSION_PROJECTION_REVIEW_RECORD_TREE,
        ...
        parents = _git(repo_root, ["show", "-s", "--format=%P", commit], failures).split()
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 Gateway mission projection {label} lineage is invalid")
    changed = _git(
        repo_root,
        [
            "diff-tree",
    ...
    if changed != ATTEMPT_016_RUNTIME_PATHS:
        failures.append("O4 Gateway mission projection changed paths are not exact")
    for path, expected_digest in GATEWAY_MISSION_PROJECTION_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            [
                "git",
                ...
                str(repo_root),
                "show",
                f"{GATEWAY_MISSION_PROJECTION_COMMIT}:{path}",
            ],
            check=False,
            capture_output=True,
        )
        observed = "sha256:" + hashlib.sha256(result.stdout).hexdigest()
        if result.returncode != 0 or observed != expected_digest:
            failures.append(f"O4 Gateway mission projection digest is invalid: {path}")


def _validate_mission_convergence_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        "Gateway lifecycle truth remains Gateway-owned",
        "governed tool count remains exactly 24",
        "does not prove why Attempt 016 remained running",
        "No execution authority exists in this record",
    ):
        if phrase not in normalized:
            failures.append(f"O4 mission-convergence review is missing phrase: {phrase}")
    if _digest(document) != MISSION_CONVERGENCE_REVIEW_DIGEST:
        failures.append("O4 mission-convergence review digest is invalid")
    for commit, expected_tree, expected_parents, label in (
        (
            MISSION_CONVERGENCE_REVIEW_RECORD_COMMIT,
            MISSION_CONVERGENCE_REVIEW_RECORD_TREE,
        ...
        parents = _git(repo_root, ["show", "-s", "--format=%P", commit], failures).split()
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 mission-convergence {label} lineage is invalid")
    changed = _git(
        repo_root,
        [
            "diff-tree",
    ...
    if changed != ATTEMPT_017_RUNTIME_PATHS:
        failures.append("O4 mission-convergence changed paths are not exact")
    for path, expected_digest in MISSION_CONVERGENCE_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            ["git", "-C", str(repo_root), "show", f"{MISSION_CONVERGENCE_COMMIT}:{path}"],
            check=False,
            capture_output=True,
        )
        observed = "sha256:" + hashlib.sha256(result.stdout).hexdigest()
        if result.returncode != 0 or observed != expected_digest:
            failures.append(f"O4 mission-convergence digest is invalid: {path}")


def _validate_mission_liveness_terminal_reason_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        "Attempt017 remains permanently consumed",
        "do not authorize Attempt018",
    ):
        if phrase not in normalized:
            failures.append(
                f"O4 mission-liveness terminal-reason review is missing phrase: {phrase}"
            )
    if _digest(document) != MISSION_LIVENESS_TERMINAL_REASON_REVIEW_DIGEST:
        failures.append("O4 mission-liveness terminal-reason review digest is invalid")
    for commit, expected_tree, expected_parents, label in (
        (
            MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_COMMIT,
            MISSION_LIVENESS_TERMINAL_REASON_REVIEW_RECORD_TREE,
        ...
        parents = _git(repo_root, ["show", "-s", "--format=%P", commit], failures).split()
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 mission-liveness terminal-reason {label} lineage is invalid")
    changed = _git(
        repo_root,
        [
            "diff",
            ...
            f"{MISSION_LIVENESS_TERMINAL_REASON_COMMIT}",
        ],
        failures,
    ).splitlines()
    if changed != ATTEMPT_018_RUNTIME_PATHS:
        failures.append("O4 mission-liveness terminal-reason changed paths are not exact")
    for path, expected_digest in MISSION_LIVENESS_TERMINAL_REASON_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            [
                "git",
                ...
                str(repo_root),
                "show",
                f"{MISSION_LIVENESS_TERMINAL_REASON_COMMIT}:{path}",
            ],
            check=False,
            capture_output=True,
        )
...
def _validate_agent_run_provenance_repair_review(
    repo_root: Path,
    document: str,
    failures: list[str],
) -> None:
    ...
    for phrase in (
        ...
        "authoritative AgentRun record",
        "permits preparation of a separate exact Attempt 020 one-shot authorization gate only",
        "does not create a review tag",
    ):
        if phrase not in normalized:
            failures.append(
                f"O4 AgentRun provenance repair review is missing phrase: {phrase}"
            )
    if _digest(document) != AGENT_RUN_PROVENANCE_REPAIR_REVIEW_DIGEST:
        failures.append("O4 AgentRun provenance repair review digest is invalid")
    for commit, expected_tree, expected_parents, label in (
        (
            AGENT_RUN_PROVENANCE_REPAIR_REVIEW_RECORD_COMMIT,
            AGENT_RUN_PROVENANCE_REPAIR_REVIEW_RECORD_TREE,
        ...
        parents = _git(repo_root, ["show", "-s", "--format=%P", commit], failures).split()
        if tree != expected_tree or parents != expected_parents:
            failures.append(f"O4 AgentRun provenance repair {label} lineage is invalid")
    changed = _git(
        repo_root,
        [
            "diff-tree",
    ...
    if changed != ATTEMPT_020_RUNTIME_PATHS:
        failures.append("O4 AgentRun provenance repair changed paths are not exact")
    for path, expected_digest in AGENT_RUN_PROVENANCE_REPAIR_PATH_DIGESTS.items():
        assert isinstance(expected_digest, str)
        result = subprocess.run(
            [
                "git",
                ...
                str(repo_root),
                "show",
                f"{AGENT_RUN_PROVENANCE_REPAIR_COMMIT}:{path}",
            ],
            check=False,
            capture_output=True,
        )
...
def _validate_attempt_013_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    if set(disposition) != {
        ...
        failures.append("O4 Attempt 013 disposition fields are not closed")
    expected_scalars: JsonObject = {
        "schema_version": "1",
        "record_type": "local_v1_lv1_003_o4_attempt_013_disposition",
        "record_status": (
            "ATTEMPT_013_CONSUMED_FIXED_NODE_PHASE_NOT_REPORTED_"
            "CLEANUP_COMPLETE_NO_LIVE_AUTHORITY"
        ),
        "attempt_id": ATTEMPT_013_ID,
        "execution_candidate_commit": ATTEMPT_013_CANDIDATE_COMMIT,
        "execution_candidate_tree": ATTEMPT_013_CANDIDATE_TREE,
        "review_tag": ATTEMPT_013_REVIEW_TAG,
        "operator_command": ATTEMPT_002_OPERATOR_COMMAND,
        "module_command": PRODUCER_MODULE_INVOCATION,
        "attempt_contract": {
            "execution_attempt_budget": 0,
        ...
        "authority": CLOSED_AUTHORITY,
        "next_action": (
            "prepare_separately_reviewed_source_repair_or_decision_for_terminal_"
            "health_phase_projection_not_fixed_node_root_cause_or_retry_authority"
        ),
        "tool_count": 24,
    }
    for key, expected in expected_scalars.items():
        if not _exact_json_equal(disposition.get(key), expected):
            failures.append(f"O4 Attempt 013 disposition {key} is not exact")
    invocation = disposition.get("invocation")
    if invocation != {
        "make_exit_code": 2,
        "producer_exit_code": 1,
        "run_identity_sha256": ATTEMPT_013_RUN_IDENTITY_DIGEST,
        "compose_project_identity_sha256": ATTEMPT_013_PROJECT_IDENTITY_DIGEST,
        "raw_invocation_output_sha256": ATTEMPT_013_RAW_OUTPUT_DIGEST,
        "raw_invocation_output_size": ATTEMPT_013_RAW_OUTPUT_SIZE,
        "raw_run_project_or_output_recorded": False,
    }:
        failures.append("O4 Attempt 013 invocation binding is not exact")
    projection = disposition.get("normalized_fixed_node_start_diagnostic")
    if projection != {
        "collection_status": "complete",
        "collection_reason_code": "fixed_node_start_state_collected",
        "classification": "fixed_node_exited_observation_noncanonical",
        ...
        failures.append("O4 Attempt 013 diagnostic projection is not exact")
    if disposition.get("bounded_result") != {
        "outward_failure_code": "fixed_node_start_failed",
        "primary_failure_code": "fixed_node_start_failed",
        "highest_completed_stage": 11,
        "base_build_completed": True,
        ...
        failures.append("O4 Attempt 013 bounded result is not exact")
    if disposition.get("diagnostic_claims") != {
        "atomic_snapshot_claimed": False,
        "causality_claimed": False,
        "root_cause_proven": False,
        "repair_or_safe_retry_proven": False,
        "raw_exit_identity_or_output_recorded": False,
    }:
        failures.append("O4 Attempt 013 diagnostic claims are not closed")
    if disposition.get("retained_receipt_binding") != {
        "root_identity_sha256": ATTEMPT_013_RUN_IDENTITY_DIGEST,
        "root_mode": "0700",
        "entries": [
            {
                "path": "candidate",
                "mode": "0500",
                "kind": "directory",
                "file_count": ATTEMPT_013_SNAPSHOT_FILE_COUNT,
            },
            {
                "path": "candidate-manifest.json",
                "mode": "0600",
                "size": ATTEMPT_013_MANIFEST_SIZE,
                "sha256": ATTEMPT_013_MANIFEST_RECEIPT_DIGEST,
            },
            {
                "path": "diagnostic.json",
                "mode": "0600",
                "size": ATTEMPT_013_DIAGNOSTIC_SIZE,
                "sha256": ATTEMPT_013_DIAGNOSTIC_RECEIPT_DIGEST,
            },
            {
                "path": "disposition.json",
                "mode": "0600",
                "size": ATTEMPT_013_DISPOSITION_SIZE,
                "sha256": ATTEMPT_013_DISPOSITION_RECEIPT_DIGEST,
            },
        ],
        "disposition_fields": {
            "status": "quarantined_not_published",
        ...
        failures.append("O4 Attempt 013 retained receipt binding is not exact")
    if disposition.get("bounded_absence_observations") != {
        "exact_run_runtime_root_absent": True,
        "exact_public_report_root_absent": True,
        "public_report_base_absent_point_in_time": True,
        "generic_runtime_absence_claimed": False,
        ...
        failures.append("O4 Attempt 013 bounded absence observations are not exact")
    normalized = " ".join(document.split())
    for phrase in (
        ...
        "not proof of root cause, repair, safe retry, success, or authority",
        "Attempt 013 observed health `unhealthy`",
        "does not explain the underlying fixed-Node exit",
        "Attempt budget is zero",
        "All 19 authority fields are false",
        "separately reviewed source repair or decision",
        "not a fixed-Node root-cause claim, retry authority, or successor authorization",
        "governed tool count remains exactly 24",
        "grants no execution authority",
    ):
        if phrase not in normalized:
            failures.append(f"O4 Attempt 013 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_013_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 013 disposition document digest is invalid")


def _validate_attempt_014_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_014_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_014_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_014_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_014_REVIEW_TAG
        or disposition.get("attempt_contract")
        != {
            "execution_attempt_budget": 0,
            "attempt_consumed": True,
            "retry_authorized": False,
        ...
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 014 disposition fields are not closed and exact")
    projection = disposition.get("normalized_fixed_node_start_diagnostic")
    if not isinstance(projection, dict) or projection.get(
        "fixed_bridge_last_entered_phase"
    ) != "socket_parent_validation_entered":
        failures.append("O4 Attempt 014 phase projection is not exact")
    invocation = disposition.get("invocation")
    if (
        not isinstance(invocation, dict)
        or invocation.get("run_identity_sha256") != ATTEMPT_014_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_014_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_014_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_014_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
    ):
        failures.append("O4 Attempt 014 invocation binding is not exact")
    normalized = " ".join(document.split())
    for phrase in (
        ...
        if phrase not in normalized:
            failures.append(f"O4 Attempt 014 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_014_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 014 disposition document digest is invalid")


def _validate_attempt_015_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_015_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_015_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_015_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_015_REVIEW_TAG
        or disposition.get("attempt_contract") != expected_attempt
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 015 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    if (
        not isinstance(invocation, dict)
        or invocation.get("make_exit_code") != 2
        or invocation.get("producer_exit_code") != 1
        or invocation.get("run_identity_sha256") != ATTEMPT_015_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_015_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_015_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_015_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
    ):
        failures.append("O4 Attempt 015 invocation binding is not exact")
    bounded = disposition.get("bounded_result")
    if (
        not isinstance(bounded, dict)
        or bounded.get("outward_failure_code") != "gateway_mission_projection_invalid"
        or bounded.get("primary_failure_code") != "gateway_mission_projection_invalid"
        or bounded.get("highest_completed_stage") != 13
        or bounded.get("base_build_completed") is not True
        or bounded.get("bridge_build_completed") is not True
        or bounded.get("bound_image_identity_count") != 4
        or bounded.get("cleanup_failure_codes") != []
        or bounded.get("recovery_required") is not False
    ):
        failures.append("O4 Attempt 015 bounded result is not exact")
    receipt = disposition.get("retained_receipt_binding")
    if (
        not isinstance(receipt, dict)
        or receipt.get("root_identity_sha256") != ATTEMPT_015_RUN_IDENTITY_DIGEST
        or receipt.get("root_mode") != "0700"
        or receipt.get("private_contents_reproduced") is not False
        or receipt.get("entries")
        != [
            {
                "path": "candidate",
                "mode": "0500",
                "kind": "directory",
                "file_count": ATTEMPT_015_SNAPSHOT_FILE_COUNT,
            },
            {
                "path": "candidate-manifest.json",
                "mode": "0600",
                "size": ATTEMPT_015_MANIFEST_SIZE,
                "sha256": ATTEMPT_015_MANIFEST_RECEIPT_DIGEST,
            },
            {
                "path": "diagnostic.json",
                "mode": "0600",
                "size": ATTEMPT_015_DIAGNOSTIC_SIZE,
                "sha256": ATTEMPT_015_DIAGNOSTIC_RECEIPT_DIGEST,
            },
            {
                "path": "disposition.json",
                "mode": "0600",
                "size": ATTEMPT_015_DISPOSITION_SIZE,
                "sha256": ATTEMPT_015_DISPOSITION_RECEIPT_DIGEST,
            },
        ]
        or receipt.get("disposition_fields")
        != {
            "status": "quarantined_not_published",
            "failure_code": "gateway_mission_projection_invalid",
            "release_allowed": False,
            "uat_complete": False,
        }
    ):
        failures.append("O4 Attempt 015 retained receipt binding is not exact")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_015_CANDIDATE_COMMIT,
        ...
        if phrase not in normalized:
            failures.append(f"O4 Attempt 015 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_015_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 015 disposition document digest is invalid")


def _validate_attempt_016_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    expected_status = (
        "ATTEMPT_016_CONSUMED_GATEWAY_MISSION_PROJECTION_INVALID_"
        "CLEANUP_COMPLETE_NO_LIVE_AUTHORITY"
    )
    projection = {
        "collection_status": "complete",
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_016_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_016_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_016_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_016_REVIEW_TAG
        or disposition.get("identity_free_gateway_mission_projection") != projection
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 016 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    if (
        not isinstance(invocation, dict)
        or invocation.get("run_identity_sha256") != ATTEMPT_016_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_016_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_016_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_016_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
    ):
        failures.append("O4 Attempt 016 invocation binding is not exact")
    claims = disposition.get("diagnostic_claims")
    if (
        not isinstance(claims, dict)
        or claims.get("root_cause_proven") is not False
        or claims.get("future_convergence_or_polling_design_supported") is not True
        or claims.get("future_convergence_or_polling_authorized") is not False
        or claims.get("attempt_017_authorized") is not False
        or claims.get("raw_identity_or_private_content_recorded") is not False
    ):
        failures.append("O4 Attempt 016 diagnostic claims are not bounded")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_016_CANDIDATE_COMMIT,
        ...
        "runner_reported_running",
        "proves no root cause",
        "authorizes no Attempt 017 or repair",
        "all 19 authority fields are false",
        "exactly 24",
    ):
        if phrase not in normalized:
            failures.append(f"O4 Attempt 016 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_016_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 016 disposition document digest is invalid")


def _validate_attempt_017_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_017_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_017_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_017_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_017_REVIEW_TAG
        or disposition.get("identity_free_gateway_mission_projection")
        != gateway_projection
        or disposition.get("identity_free_node_receipt_projection") != node_projection
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 017 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    if (
        not isinstance(invocation, dict)
        or invocation.get("make_exit_code") != 2
        or invocation.get("producer_exit_code") != 1
        or invocation.get("run_identity_sha256") != ATTEMPT_017_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_017_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_017_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_017_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
    ):
        failures.append("O4 Attempt 017 invocation binding is not exact")
    claims = disposition.get("diagnostic_claims")
    attempt_contract = disposition.get("attempt_contract")
    if (
        not isinstance(claims, dict)
        or claims.get("root_cause_proven") is not False
        or claims.get("repair_or_safe_retry_proven") is not False
        or claims.get("success_proven") is not False
        or claims.get("bounded_completion_failure_diagnosis_supported") is not True
        or claims.get("bounded_completion_failure_diagnosis_authorized") is not False
        or claims.get("attempt_018_authorized") is not False
        or claims.get("raw_identity_or_private_content_recorded") is not False
        or not isinstance(attempt_contract, dict)
        or attempt_contract.get("execution_attempt_budget") != 0
        or attempt_contract.get("attempt_consumed") is not True
        or any(
            attempt_contract.get(field) is not False
            for field in (
                "retry_authorized",
                "automatic_retry_authorized",
                "concurrent_invocation_authorized",
                "post_attempt_retry_authorized",
                "successor_attempt_authorized",
            )
        )
    ):
        failures.append("O4 Attempt 017 diagnostic and attempt claims are not bounded")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_017_CANDIDATE_COMMIT,
        ...
        "completion_pending",
        "failed_closed",
        "prove no exact root cause",
        "authorize no Attempt 018 or repair",
        "all 19 authority fields are false",
        "exactly 24",
    ):
        if phrase not in normalized:
            failures.append(f"O4 Attempt 017 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_017_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 017 disposition document digest is invalid")


def _validate_attempt_018_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_018_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_018_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_018_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_018_REVIEW_TAG
        or disposition.get("identity_free_gateway_mission_projection")
        != gateway_projection
        or disposition.get("identity_free_node_receipt_projection") != node_projection
        or disposition.get("authority") != CLOSED_AUTHORITY
        ...
        failures.append("O4 Attempt 018 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    if (
        not isinstance(invocation, dict)
        or invocation.get("make_exit_code") != 2
        or invocation.get("producer_exit_code") != 1
        or invocation.get("run_identity_sha256") != ATTEMPT_018_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_018_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_018_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_018_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
    ):
        failures.append("O4 Attempt 018 invocation binding is not exact")
    claims = disposition.get("diagnostic_claims")
    attempt_contract = disposition.get("attempt_contract")
    if (
        not isinstance(claims, dict)
        or claims.get("root_cause_proven") is not False
        or claims.get("terminal_reason_is_bounded_runner_receipt_evidence_only") is not True
        or claims.get("repair_or_safe_retry_proven") is not False
        or claims.get("success_proven") is not False
        or claims.get("bounded_liveness_terminal_reason_diagnosis_supported") is not True
        or claims.get("bounded_liveness_terminal_reason_diagnosis_authorized") is not False
        or claims.get("attempt_019_authorized") is not False
        or claims.get("raw_identity_or_private_content_recorded") is not False
        or not isinstance(attempt_contract, dict)
        or attempt_contract.get("execution_attempt_budget") != 0
        or attempt_contract.get("attempt_consumed") is not True
        ...
        failures.append("O4 Attempt 018 diagnostic and attempt claims are not bounded")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_018_CANDIDATE_COMMIT,
        ...
        "authorize no Attempt 019 or repair",
        "all 19 authority fields are false",
        "exactly 24",
    ):
        if phrase not in normalized:
            failures.append(f"O4 Attempt 018 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_018_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 018 disposition document digest is invalid")


def _validate_attempt_019_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_019_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_019_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_019_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_019_REVIEW_TAG
        or disposition.get("identity_free_node_receipt_projection") != node_projection
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 019 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    control_flow = disposition.get("bounded_control_flow_evidence")
    claims = disposition.get("diagnostic_claims")
    attempt_contract = disposition.get("attempt_contract")
    if (
        not isinstance(invocation, dict)
        or invocation.get("make_exit_code") != 2
        or invocation.get("producer_exit_code") != 1
        or invocation.get("run_identity_sha256") != ATTEMPT_019_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_019_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_019_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_019_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
        or not isinstance(control_flow, dict)
        or control_flow.get("terminal_mission_projection_gate_passed_before_failure")
        is not True
        or control_flow.get("gateway_mission_projection_reproduced") is not False
        or control_flow.get("overall_o4_success_proven") is not False
        or not isinstance(claims, dict)
        or claims.get("root_cause_proven") is not False
        or claims.get("repair_or_safe_retry_proven") is not False
        or claims.get("success_proven") is not False
        or claims.get("bounded_gateway_run_detail_diagnosis_supported") is not True
        or claims.get("bounded_gateway_run_detail_diagnosis_authorized") is not False
        or claims.get("attempt_020_authorized") is not False
        or not isinstance(attempt_contract, dict)
        or attempt_contract.get("execution_attempt_budget") != 0
        or attempt_contract.get("attempt_consumed") is not True
        or any(
        ...
        failures.append("O4 Attempt 019 invocation, evidence, or claims are not bounded")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_019_CANDIDATE_COMMIT,
        ...
        if phrase not in normalized:
            failures.append(f"O4 Attempt 019 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_019_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 019 disposition document digest is invalid")


def _validate_attempt_020_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    ...
    if (
        disposition.get("record_status") != expected_status
        or disposition.get("attempt_id") != ATTEMPT_020_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_020_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_020_CANDIDATE_TREE
        or disposition.get("review_tag") != ATTEMPT_020_REVIEW_TAG
        or disposition.get("identity_free_node_receipt_projection") != node_projection
        or disposition.get("authority") != CLOSED_AUTHORITY
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 020 disposition fields are not closed and exact")
    invocation = disposition.get("invocation")
    claims = disposition.get("diagnostic_claims")
    attempt_contract = disposition.get("attempt_contract")
    if (
        ...
        or invocation.get("make_exit_code") != 2
        or invocation.get("producer_exit_code") != 1
        or invocation.get("run_identity_sha256") != ATTEMPT_020_RUN_IDENTITY_DIGEST
        or invocation.get("compose_project_identity_sha256")
        != ATTEMPT_020_PROJECT_IDENTITY_DIGEST
        or invocation.get("raw_invocation_output_sha256") != ATTEMPT_020_RAW_OUTPUT_DIGEST
        or invocation.get("raw_invocation_output_size") != ATTEMPT_020_RAW_OUTPUT_SIZE
        or invocation.get("raw_run_project_or_output_recorded") is not False
        or not isinstance(claims, dict)
        or claims.get("root_cause_proven") is not False
        or claims.get("repair_or_safe_retry_proven") is not False
        or claims.get("success_proven") is not False
        or claims.get("generic_absence_proven") is not False
        or claims.get("bounded_gateway_run_detail_diagnosis_supported") is not True
        or claims.get("bounded_gateway_run_detail_diagnosis_authorized") is not False
        or claims.get("attempt_021_authorized") is not False
        or not isinstance(attempt_contract, dict)
        or attempt_contract.get("execution_attempt_budget") != 0
        or attempt_contract.get("attempt_consumed") is not True
        or any(
        ...
        failures.append("O4 Attempt 020 invocation, evidence, or claims are not bounded")
    normalized = " ".join(document.split())
    for phrase in (
        f"Status: `{expected_status}`",
        ATTEMPT_020_CANDIDATE_COMMIT,
        ...
        if phrase not in normalized:
            failures.append(f"O4 Attempt 020 disposition doc is missing phrase: {phrase}")
    if _digest(document) != ATTEMPT_020_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 020 disposition document digest is invalid")


def _validate_attempt_021_disposition(
    disposition: JsonObject,
    document: str,
    failures: list[str],
) -> None:
    if (
        ...
        != "ATTEMPT_021_CONSUMED_SUCCESS_O4_LV1_003_COMPLETE_NO_LIVE_AUTHORITY"
        or disposition.get("attempt_id") != ATTEMPT_021_ID
        or disposition.get("execution_candidate_commit") != ATTEMPT_021_CANDIDATE_COMMIT
        or disposition.get("execution_candidate_tree") != ATTEMPT_021_CANDIDATE_TREE
        or disposition.get("execution_candidate_parent")
        != GATEWAY_SESSION_BINDING_REPAIR_REVIEW_RECORD_COMMIT
        or disposition.get("review_tag") != ATTEMPT_021_REVIEW_TAG
        or disposition.get("tool_count") != 24
    ):
        failures.append("O4 Attempt 021 consumed-success disposition identity is invalid")
    invocation = disposition.get("invocation")
    attempt_contract = disposition.get("attempt_contract")
    authority = disposition.get("authority")
    closure = disposition.get("closure")
    evidence = disposition.get("bounded_evidence")
    limits = disposition.get("evidence_limits")
    if not isinstance(invocation, dict) or (
        invocation.get("make_exit_code") != 0
        or invocation.get("producer_exit_code") != 0
        or invocation.get("raw_invocation_output_size") != 195
        or invocation.get("raw_invocation_output_sha256")
        != "sha256:98f74c1020caa3ed27258e0a27170236bde61cff0f5a71baa8f35b4860746e73"
        or invocation.get("raw_output_reproduced") is not False
    ):
        failures.append("O4 Attempt 021 invocation binding is invalid")
    if not _exact_json_equal(
        attempt_contract,
        {
            "execution_attempt_budget": 0,
            ...
            "retry_authorized": False,
            "automatic_retry_authorized": False,
            "concurrent_invocation_authorized": False,
            "post_attempt_retry_authorized": False,
            "recovery_authorized": False,
            "cleanup_authorized": False,
            "successor_attempt_authorized": False,
        },
    ):
        failures.append("O4 Attempt 021 consumed attempt contract is invalid")
    if not _exact_json_equal(authority, CLOSED_AUTHORITY):
        failures.append("O4 Attempt 021 authority is not fully closed")
    if not isinstance(closure, dict) or (
        closure.get("o4_complete") is not True
        or closure.get("lv1_003_complete") is not True
        or closure.get("o5_authorized") is not False
        or closure.get("active_next_action") != "LV1-004"
        or closure.get("next_action_started") is not False
        or closure.get("pause_reason") != "user_directed_pause_after_o4"
    ):
        failures.append("O4 Attempt 021 closure boundary is invalid")
    if not isinstance(evidence, dict) or (
        evidence.get("gateway_lifecycle_status") != "runner_reported_succeeded"
        or evidence.get("runner_state_authority") != "runner_reported_only"
        or evidence.get("model_provider_state_known") is not False
        or evidence.get("tool_call_count") != 2
    ):
        failures.append("O4 Attempt 021 bounded evidence is invalid")
    if not isinstance(limits, dict) or any(value is not False for value in limits.values()):
        failures.append("O4 Attempt 021 evidence limits are not fully false")
    if _digest(document) != ATTEMPT_021_DISPOSITION_DOCUMENT_DIGEST:
        failures.append("O4 Attempt 021 disposition document digest is invalid")
...
def _validate_repo_relative_absence(
    ...
    *,
    ...
    if ATTEMPT_021_SUCCESS_RECORDED and relative == ATTEMPT_002_REPORT_BASE:
        # Earlier dispositions bind the report base's absence at their observation
        # time. Successful Attempt 021 legitimately created the first published
        # report; its exact owner-only contents are validated separately.
        return
    if not _safe_snapshot_relative_path(relative.as_posix()):
        failures.append(f"{label} path is not a safe repository-relative path")
        return
...
def _validate_attempt_diagnostic_bytes(
    ...
    *,
    ...
    if attempt in {16, 17, 18}:
        expected_fields.add("gateway_mission_projection_diagnostic")
    if attempt in {17, 18, 19, 20}:
        expected_fields.add("node_receipt_projection_diagnostic")
    ...
    attempt_019_scalars: JsonObject = {
        "schema_version": "1",
        "record_type": "local_v1_lv1_003_o4_producer_failure_diagnostic",
        "base_build_completed": True,
        "bridge_build_completed": True,
        "cleanup_failure_codes": [],
        "highest_completed_stage": 13,
        "outward_failure_code": "gateway_run_detail_invalid",
        "primary_failure_code": "gateway_run_detail_invalid",
        "recovery_required": False,
    }
    expected_scalars = (
        attempt_019_scalars
        if attempt in {19, 20}
        else attempt_016_scalars
        if attempt in {16, 17, 18}
    ...
    if attempt == 13 and not _exact_json_equal(
        diagnostic.get("fixed_node_start_diagnostic"),
        {
            "collection_status": "complete",
            "collection_reason_code": "fixed_node_start_state_collected",
        ...
        failures.append("O4 Attempt 013 fixed-Node diagnostic projection is not exact")
    if attempt == 14 and not _exact_json_equal(
        diagnostic.get("fixed_node_start_diagnostic"),
        {
            "collection_status": "complete",
            "collection_reason_code": "fixed_node_start_state_collected",
    ...
    if attempt in {16, 17, 18} and not _exact_json_equal(
        ...
        failures.append(f"O4 Attempt {attempt:03d} Gateway mission projection is not exact")
    if attempt == 17 and not _exact_json_equal(
        diagnostic.get("node_receipt_projection_diagnostic"),
        {
            "collection_status": "complete",
            "collection_reason_code": "node_receipt_projection_state_collected",
        ...
        failures.append("O4 Attempt 017 Node receipt projection is not exact")
    if attempt == 18 and not _exact_json_equal(
        diagnostic.get("node_receipt_projection_diagnostic"),
        {
            "collection_status": "complete",
            "collection_reason_code": "node_receipt_projection_state_collected",
        ...
        failures.append("O4 Attempt 018 Node receipt projection is not exact")
    if attempt in {19, 20} and not _exact_json_equal(
        diagnostic.get("node_receipt_projection_diagnostic"),
        {
            "collection_status": "complete",
            "collection_reason_code": "node_receipt_projection_state_collected",
            ...
            "envelope_identity_state": "valid_digest",
            "handoff_nonce_digest_state": "valid_digest",
            "next_operation_state": "completion_recorded",
            "last_closed_status": "runner_reported_succeeded",
            "last_closed_reason_code": "none",
        },
    ):
        failures.append(f"O4 Attempt {attempt:03d} Node receipt projection is not exact")
    ...
    if not isinstance(identities, list) or len(identities) != 4:
        ...
        return
    if attempt in {12, 13, 14, 16, 17, 18, 19, 20}:
        identity_fields = {
            "reference",
            "image_id",
            "project",
        ...
        for identity in identities:
            if (
                ...
                failures.append(
                    f"O4 Attempt {attempt:03d} bound diagnostic identity schema is not exact"
                )
                return
        return
    observed = [
...
def _validate_retained_attempt_receipt(
    ...
    *,
    ...
    disposition_size: int | None = None,
    additional_receipt_files: dict[str, tuple[int, int, str]] | None = None,
    ...
    try:
        try:
            ...
            if additional_receipt_files is not None:
                expected_entries.extend(additional_receipt_files)
        ...
        expected_disposition_size = (
            len(disposition_bytes)
            if disposition_bytes is not None
            else disposition_size
        )
        if expected_disposition_size is None:
            failures.append(f"{label} disposition size expectation is missing")
            return
        disposition = _read_owned_child_file(
            receipt_root,
            "disposition.json",
            mode=0o600,
            size=expected_disposition_size,
            digest=disposition_digest,
            label=f"{label} quarantine disposition",
            failures=failures,
        )
        if (
            disposition_bytes is not None
            and disposition is not None
            and disposition != disposition_bytes
        ):
            failures.append(f"{label} quarantine disposition content is not exact")
        if additional_receipt_files is not None:
            for name, (mode, size, digest) in additional_receipt_files.items():
                _read_owned_child_file(
                    receipt_root,
                    name,
                    mode=mode,
                    size=size,
...
def _private_attempt_013_run_name(
    receipt_base: int,
    failures: list[str],
) -> str | None:
    try:
        ...
        failures.append("O4 Attempt 013 private receipt selection is unavailable")
        return None
    matching: list[str] = []
    for candidate in candidates:
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is None:
            continue
        observed = _domain_identity_digest(ATTEMPT_013_RUN_DIGEST_PREFIX, candidate)
        if observed == ATTEMPT_013_RUN_IDENTITY_DIGEST:
            matching.append(candidate)
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 013 private receipt selection did not resolve exactly one root"
        )
        return None
    run_name = matching[0]
    project_name = f"ithildin-local-v1-o4-{run_name.rpartition('-')[2]}"
    project_digest = _domain_identity_digest(
        ATTEMPT_013_PROJECT_DIGEST_PREFIX,
        project_name,
    )
    if project_digest != ATTEMPT_013_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 013 private project binding is not exact")
        return None
    return run_name


def _validate_attempt_013_receipts(
    repo_root: Path,
    failures: list[str],
) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 013 receipt base",
            failures=failures,
        )
        if receipt_base is not None:
            run_name = _private_attempt_013_run_name(receipt_base, failures)
        if run_name is not None and receipt_base is not None:
            receipt_root = _open_owned_child_directory(
                receipt_base,
                run_name,
                0o700,
                "O4 Attempt 013 receipt root",
                failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 013 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 013 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 013 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        try:
            if sorted(os.listdir(receipt_root)) != [
                ...
                failures.append("O4 Attempt 013 receipt entries are not exact")
        except OSError:
            failures.append("O4 Attempt 013 receipt root cannot be enumerated")
        diagnostic = _read_owned_child_file(
            receipt_root,
            "diagnostic.json",
            mode=0o600,
            size=ATTEMPT_013_DIAGNOSTIC_SIZE,
            digest=ATTEMPT_013_DIAGNOSTIC_RECEIPT_DIGEST,
            label="O4 Attempt 013 diagnostic",
            failures=failures,
        )
        disposition = _read_owned_child_file(
            receipt_root,
            ...
            mode=0o600,
            size=ATTEMPT_013_DISPOSITION_SIZE,
            digest=ATTEMPT_013_DISPOSITION_RECEIPT_DIGEST,
            label="O4 Attempt 013 disposition",
            failures=failures,
        )
    finally:
        os.close(receipt_root)
    if diagnostic is None:
        failures.append("O4 Attempt 013 diagnostic is unavailable")
    else:
        _validate_attempt_diagnostic_bytes(diagnostic, failures, attempt=13)
    if disposition is None:
        failures.append("O4 Attempt 013 disposition is unavailable")
    elif disposition != ATTEMPT_013_DISPOSITION_BYTES:
        failures.append("O4 Attempt 013 disposition bytes are not closed and exact")
    else:
        try:
            parsed = json.loads(
                disposition.decode("utf-8"),
            ...
            failures.append("O4 Attempt 013 disposition JSON is ambiguous")
        else:
            if parsed != {
                "status": "quarantined_not_published",
                "failure_code": "fixed_node_start_failed",
                ...
                failures.append("O4 Attempt 013 disposition JSON fields are not exact")


def _private_attempt_014_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 014 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_014_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_014_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 014 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_014_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_014_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 014 private project binding is not exact")
    return matching[0]


def _validate_attempt_014_receipts(repo_root: Path, failures: list[str]) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 014 receipt base",
            failures=failures,
        )
        if receipt_base is not None:
            run_name = _private_attempt_014_run_name(receipt_base, failures)
        if run_name is not None and receipt_base is not None:
            receipt_root = _open_owned_child_directory(
                receipt_base,
                run_name,
                0o700,
                "O4 Attempt 014 receipt root",
                failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 014 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 014 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 014 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        try:
            if sorted(os.listdir(receipt_root)) != [
                ...
                failures.append("O4 Attempt 014 receipt entries are not exact")
        except OSError:
            failures.append("O4 Attempt 014 receipt root cannot be enumerated")
        diagnostic = _read_owned_child_file(
            receipt_root,
            "diagnostic.json",
            mode=0o600,
            size=ATTEMPT_014_DIAGNOSTIC_SIZE,
            digest=ATTEMPT_014_DIAGNOSTIC_RECEIPT_DIGEST,
            label="O4 Attempt 014 diagnostic",
            failures=failures,
        )
        disposition = _read_owned_child_file(
            receipt_root,
            "disposition.json",
            mode=0o600,
            size=ATTEMPT_014_DISPOSITION_SIZE,
            digest=ATTEMPT_014_DISPOSITION_RECEIPT_DIGEST,
            label="O4 Attempt 014 disposition",
            failures=failures,
        )
    finally:
        os.close(receipt_root)
    if diagnostic is None:
        failures.append("O4 Attempt 014 diagnostic is unavailable")
    else:
        _validate_attempt_diagnostic_bytes(diagnostic, failures, attempt=14)
    if disposition != ATTEMPT_014_DISPOSITION_BYTES:
        failures.append("O4 Attempt 014 disposition bytes are not closed and exact")


def _private_attempt_015_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 015 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_015_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_015_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 015 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_015_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_015_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 015 private project binding is not exact")
    return matching[0]
...
def _private_attempt_017_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 017 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_017_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_017_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 017 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_017_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_017_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 017 private project binding is not exact")
    return matching[0]


def _private_attempt_018_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 018 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_018_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_018_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 018 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_018_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_018_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 018 private project binding is not exact")
    return matching[0]


def _private_attempt_019_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 019 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_019_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_019_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 019 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_019_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_019_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 019 private project binding is not exact")
    return matching[0]


def _private_attempt_020_run_name(receipt_base: int, failures: list[str]) -> str | None:
    try:
        candidates = os.listdir(receipt_base)
    except OSError:
        failures.append("O4 Attempt 020 private receipt selection is unavailable")
        return None
    matching = [
        candidate
        for candidate in candidates
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is not None
        and _domain_identity_digest(ATTEMPT_020_RUN_DIGEST_PREFIX, candidate)
        == ATTEMPT_020_RUN_IDENTITY_DIGEST
    ]
    if len(matching) != 1:
        failures.append(
            "O4 Attempt 020 private receipt selection did not resolve exactly one root"
        )
        return None
    project_digest = _domain_identity_digest(
        ATTEMPT_020_PROJECT_DIGEST_PREFIX,
        f"ithildin-local-v1-o4-{matching[0].rsplit('-', 1)[-1]}",
    )
    if project_digest != ATTEMPT_020_PROJECT_IDENTITY_DIGEST:
        failures.append("O4 Attempt 020 private project binding is not exact")
    return matching[0]


def _owned_child_file_matches(
    parent_descriptor: int,
    name: str,
    *,
    mode: int,
    ...
    try:
        ...
        descriptor = os.open(name, _file_open_flags(), dir_fd=parent_descriptor)
        opened = os.fstat(descriptor)
        if not _same_inode(details, opened):
            return False
        content = bytearray()
        while len(content) <= size:
            chunk = os.read(descriptor, min(65536, size + 1 - len(content)))
        ...
        if descriptor >= 0:
            os.close(descriptor)
    return (
        _same_inode(opened, after)
        and len(content) == size
        and "sha256:" + hashlib.sha256(content).hexdigest() == digest
    )


def _private_root_matching_file(
    base_descriptor: int,
    *,
    file_name: str,
    mode: int,
    ...
    try:
        candidates = os.listdir(base_descriptor)
    except OSError:
        failures.append(f"{label} private root selection is unavailable")
        return None
    matching: list[str] = []
    for candidate in candidates:
        if re.fullmatch(r"[0-9]{8}T[0-9]{6}Z-[0-9a-f]{8}", candidate) is None:
        ...
        try:
            ...
            os.close(child)
    if len(matching) != 1:
        failures.append(f"{label} private root selection did not resolve exactly one root")
        return None
    return matching[0]
...
def _validate_attempt_015_receipts(repo_root: Path, failures: list[str]) -> None:
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 015 receipt base",
            failures=failures,
        )
        run_name = (
            _private_attempt_015_run_name(receipt_base, failures)
            if receipt_base is not None
            else None
        )
        if run_name is not None and receipt_base is not None:
            ...
            _validate_repo_relative_absence(
                ...
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 015 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 015 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 015 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        try:
            if sorted(os.listdir(receipt_root)) != [
                ...
                failures.append("O4 Attempt 015 receipt entries are not exact")
        except OSError:
            failures.append("O4 Attempt 015 receipt root cannot be enumerated")
        diagnostic = _read_owned_child_file(
            receipt_root,
            "diagnostic.json",
            mode=0o600,
            size=ATTEMPT_015_DIAGNOSTIC_SIZE,
            digest=ATTEMPT_015_DIAGNOSTIC_RECEIPT_DIGEST,
            label="O4 Attempt 015 diagnostic",
            failures=failures,
        )
        disposition = _read_owned_child_file(
            receipt_root,
            ...
            mode=0o600,
            size=ATTEMPT_015_DISPOSITION_SIZE,
            digest=ATTEMPT_015_DISPOSITION_RECEIPT_DIGEST,
            label="O4 Attempt 015 disposition",
            failures=failures,
        )
    finally:
        os.close(receipt_root)
    if diagnostic is None:
        failures.append("O4 Attempt 015 diagnostic is unavailable")
    if disposition != ATTEMPT_015_DISPOSITION_BYTES:
...
def _validate_attempt_017_receipts(repo_root: Path, failures: list[str]) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 017 receipt base",
            failures=failures,
        )
        run_name = (
            _private_attempt_017_run_name(receipt_base, failures)
            if receipt_base is not None
            else None
        )
        if run_name is not None:
            _validate_repo_relative_absence(
                ...
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 017 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 017 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 017 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        if run_name is not None:
            _validate_retained_attempt_receipt(
                ...
                receipt_base,
                failures,
                label="O4 Attempt 017",
                run_id=run_name,
                disposition_bytes=ATTEMPT_017_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_017_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_017_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_017_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_017_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_017_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_017_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_017_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_017_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=17,
            )
    finally:
        os.close(receipt_base)


def _validate_attempt_018_receipts(repo_root: Path, failures: list[str]) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 018 receipt base",
            failures=failures,
        )
        run_name = (
            _private_attempt_018_run_name(receipt_base, failures)
            if receipt_base is not None
            else None
        )
        if run_name is not None:
            _validate_repo_relative_absence(
                ...
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 018 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 018 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 018 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        if run_name is not None:
            _validate_retained_attempt_receipt(
                ...
                receipt_base,
                failures,
                label="O4 Attempt 018",
                run_id=run_name,
                disposition_bytes=ATTEMPT_018_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_018_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_018_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_018_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_018_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_018_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_018_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_018_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_018_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=18,
            )
    finally:
        os.close(receipt_base)


def _validate_attempt_019_receipts(repo_root: Path, failures: list[str]) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 019 receipt base",
            failures=failures,
        )
        run_name = (
            _private_attempt_019_run_name(receipt_base, failures)
            if receipt_base is not None
            else None
        )
        if run_name is not None:
            _validate_repo_relative_absence(
                ...
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 019 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 019 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 019 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        if run_name is not None:
            _validate_retained_attempt_receipt(
                ...
                receipt_base,
                failures,
                label="O4 Attempt 019",
                run_id=run_name,
                disposition_bytes=ATTEMPT_019_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_019_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_019_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_019_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_019_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_019_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_019_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_019_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_019_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=19,
            )
    finally:
        os.close(receipt_base)


def _validate_attempt_020_receipts(repo_root: Path, failures: list[str]) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 020 receipt base",
            failures=failures,
        )
        run_name = (
            _private_attempt_020_run_name(receipt_base, failures)
            if receipt_base is not None
            else None
        )
        if run_name is not None:
            _validate_repo_relative_absence(
                ...
                ATTEMPT_002_RUNTIME_BASE / run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 exact Attempt 020 runtime root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE / run_name,
                expected_parent_modes={},
                label="O4 exact Attempt 020 public report root",
                failures=failures,
            )
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_REPORT_BASE,
                expected_parent_modes={},
                label="O4 Attempt 020 point-in-time public report base",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    ...
    try:
        if run_name is not None:
            _validate_retained_attempt_receipt(
                ...
                receipt_base,
                failures,
                label="O4 Attempt 020",
                run_id=run_name,
                disposition_bytes=ATTEMPT_020_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_020_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_020_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_020_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_020_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_020_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_020_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_020_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_020_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=20,
            )
    finally:
        os.close(receipt_base)


def _validate_attempt_021_receipts(
    repo_root: Path,
    failures: list[str],
) -> None:
    repository_descriptor = _open_repository_root(repo_root, failures)
    if repository_descriptor is None:
        return
    receipt_base: int | None = None
    report_base: int | None = None
    receipt_run_name: str | None = None
    ...
    try:
        receipt_base = _open_repo_relative_directory(
            ...
            ATTEMPT_002_RECEIPT_BASE,
            expected_modes={ATTEMPT_002_RECEIPT_BASE.as_posix(): 0o700},
            label="O4 Attempt 021 receipt base",
            failures=failures,
        )
        report_base = _open_repo_relative_directory(
            repository_descriptor,
            ATTEMPT_002_REPORT_BASE,
            expected_modes={ATTEMPT_002_REPORT_BASE.as_posix(): 0o700},
            label="O4 Attempt 021 report base",
            failures=failures,
        )
        if receipt_base is not None:
            receipt_run_name = _private_root_matching_file(
                receipt_base,
                file_name="candidate-manifest.json",
                mode=0o600,
                size=ATTEMPT_021_MANIFEST_SIZE,
                digest=ATTEMPT_021_MANIFEST_DIGEST,
                label="O4 Attempt 021 receipt",
                failures=failures,
            )
        if report_base is not None:
            report_mode, report_size, report_digest = ATTEMPT_021_REPORT_FILES[
                "report.json"
            ]
            report_run_name = _private_root_matching_file(
                report_base,
                file_name="report.json",
                mode=report_mode,
                size=report_size,
                digest=report_digest,
                label="O4 Attempt 021 report",
                failures=failures,
            )
        if receipt_run_name is not None:
            _validate_repo_relative_absence(
                repository_descriptor,
                ATTEMPT_002_RUNTIME_BASE / receipt_run_name,
                expected_parent_modes={ATTEMPT_002_RUNTIME_BASE.as_posix(): 0o700},
                label="O4 Attempt 021 runtime root",
                failures=failures,
            )
    finally:
        os.close(repository_descriptor)
    if receipt_base is not None and receipt_run_name is not None:
        _validate_retained_attempt_receipt(
            repo_root,
            receipt_base,
            failures,
            label="O4 Attempt 021",
            run_id=receipt_run_name,
            disposition_bytes=None,
            disposition_size=ATTEMPT_021_RECEIPT_DISPOSITION_SIZE,
            disposition_digest=ATTEMPT_021_RECEIPT_DISPOSITION_DIGEST,
            manifest_size=ATTEMPT_021_MANIFEST_SIZE,
            manifest_digest=ATTEMPT_021_MANIFEST_DIGEST,
            candidate_commit=ATTEMPT_021_CANDIDATE_COMMIT,
            candidate_tree=ATTEMPT_021_CANDIDATE_TREE,
            snapshot_file_count=ATTEMPT_021_SNAPSHOT_FILE_COUNT,
            additional_receipt_files=ATTEMPT_021_RECEIPT_FILES,
        )
    if receipt_base is not None:
        os.close(receipt_base)
    if report_base is None:
        return
    try:
        if report_run_name is None:
            return
        try:
            if sorted(os.listdir(report_base)) != [report_run_name]:
                failures.append("O4 Attempt 021 report base entries are not exact")
        except OSError:
            failures.append("O4 Attempt 021 report base cannot be enumerated")
        report_root = _open_owned_child_directory(
            report_base,
            report_run_name,
            0o700,
            "O4 Attempt 021 report root",
            failures,
        )
        ...
        try:
            try:
                if sorted(os.listdir(report_root)) != sorted(ATTEMPT_021_REPORT_FILES):
                    failures.append("O4 Attempt 021 report entries are not exact")
            except OSError:
                failures.append("O4 Attempt 021 report root cannot be enumerated")
            for name, (mode, size, digest) in ATTEMPT_021_REPORT_FILES.items():
                _read_owned_child_file(
                    report_root,
                    name,
                    mode=mode,
                    size=size,
                    digest=digest,
                    label=f"O4 Attempt 021 {name}",
                    failures=failures,
                )
        finally:
            os.close(report_root)
    finally:
        os.close(report_base)
...
def _validate_retained_attempt_evidence(
    ...
    attempt_017_run_name = _private_attempt_017_run_name(receipt_base, failures)
    attempt_018_run_name = _private_attempt_018_run_name(receipt_base, failures)
    attempt_019_run_name = _private_attempt_019_run_name(receipt_base, failures)
    attempt_020_run_name = _private_attempt_020_run_name(receipt_base, failures)
    attempt_021_run_name = _private_root_matching_file(
        receipt_base,
        file_name="candidate-manifest.json",
        mode=0o600,
        size=ATTEMPT_021_MANIFEST_SIZE,
    ...
    try:
        try:
            expected_runs = sorted(
                [
                    ...
                    *(
                        [attempt_013_run_name]
                        if attempt_013_run_name is not None
                        else []
                    ),
                    *(
                        [attempt_014_run_name]
                        if attempt_014_run_name is not None
                        else []
                    ),
                    *(
                    ...
                    *(
                        [attempt_017_run_name]
                        if attempt_017_run_name is not None
                        else []
                    ),
                    *(
                        [attempt_018_run_name]
                        if attempt_018_run_name is not None
                        else []
                    ),
                    *(
                        [attempt_019_run_name]
                        if attempt_019_run_name is not None
                        else []
                    ),
                    *(
                        [attempt_020_run_name]
                        if attempt_020_run_name is not None
                        else []
                    ),
                    *(
                        [attempt_021_run_name]
                        if attempt_021_run_name is not None
                        else []
                    ),
                ]
            )
        ...
        if attempt_013_run_name is not None:
            _validate_retained_attempt_receipt(
                ...
                receipt_base,
                failures,
                label="O4 Attempt 013",
                run_id=attempt_013_run_name,
                disposition_bytes=ATTEMPT_013_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_013_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_013_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_013_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_013_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_013_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_013_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_013_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_013_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=13,
            )
        if attempt_014_run_name is not None:
            _validate_retained_attempt_receipt(
                repo_root,
                receipt_base,
                failures,
                label="O4 Attempt 014",
                run_id=attempt_014_run_name,
                disposition_bytes=ATTEMPT_014_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_014_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_014_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_014_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_014_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_014_CANDIDATE_TREE,
                snapshot_file_count=ATTEMPT_014_SNAPSHOT_FILE_COUNT,
                diagnostic_size=ATTEMPT_014_DIAGNOSTIC_SIZE,
                diagnostic_digest=ATTEMPT_014_DIAGNOSTIC_RECEIPT_DIGEST,
                diagnostic_attempt=14,
            )
        if attempt_015_run_name is not None:
            _validate_retained_attempt_receipt(
                repo_root,
                receipt_base,
                failures,
                label="O4 Attempt 015",
                run_id=attempt_015_run_name,
                disposition_bytes=ATTEMPT_015_DISPOSITION_BYTES,
                disposition_digest=ATTEMPT_015_DISPOSITION_RECEIPT_DIGEST,
                manifest_size=ATTEMPT_015_MANIFEST_SIZE,
                manifest_digest=ATTEMPT_015_MANIFEST_RECEIPT_DIGEST,
                candidate_commit=ATTEMPT_015_CANDIDATE_COMMIT,
                candidate_tree=ATTEMPT_015_CANDIDATE_TREE,
...
def _validate_bound_documents(repo_root: Path, failures: list[str]) -> None:
    for path, expected, label in (
        ...
        (
            ATTEMPT_013_DISPOSITION_JSON,
            ATTEMPT_013_DISPOSITION_JSON_DIGEST,
            "Attempt 013 disposition JSON",
        ),
        (
            ATTEMPT_013_DISPOSITION_DOCUMENT,
            ATTEMPT_013_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 013 disposition document",
        ),
        (
            ATTEMPT_014_DISPOSITION_JSON,
            ATTEMPT_014_DISPOSITION_JSON_DIGEST,
            "Attempt 014 disposition JSON",
        ),
        (
            ATTEMPT_014_DISPOSITION_DOCUMENT,
            ATTEMPT_014_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 014 disposition document",
        ),
        (
            ATTEMPT_015_DISPOSITION_JSON,
            ATTEMPT_015_DISPOSITION_JSON_DIGEST,
            "Attempt 015 disposition JSON",
        ),
        (
            ATTEMPT_015_DISPOSITION_DOCUMENT,
            ATTEMPT_015_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 015 disposition document",
        ),
        (
            ATTEMPT_016_DISPOSITION_JSON,
            ATTEMPT_016_DISPOSITION_JSON_DIGEST,
            "Attempt 016 disposition JSON",
        ),
        (
            ATTEMPT_016_DISPOSITION_DOCUMENT,
            ATTEMPT_016_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 016 disposition document",
        ),
        (
            ATTEMPT_017_DISPOSITION_JSON,
            ATTEMPT_017_DISPOSITION_JSON_DIGEST,
            "Attempt 017 disposition JSON",
        ),
        (
            ATTEMPT_017_DISPOSITION_DOCUMENT,
            ATTEMPT_017_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 017 disposition document",
        ),
        (
            ATTEMPT_018_DISPOSITION_JSON,
            ATTEMPT_018_DISPOSITION_JSON_DIGEST,
            "Attempt 018 disposition",
        ),
        (
            ATTEMPT_018_DISPOSITION_DOCUMENT,
            ATTEMPT_018_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 018 disposition document",
        ),
        (
            ATTEMPT_019_DISPOSITION_JSON,
            ATTEMPT_019_DISPOSITION_JSON_DIGEST,
            "Attempt 019 disposition",
        ),
        (
            ATTEMPT_019_DISPOSITION_DOCUMENT,
            ATTEMPT_019_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 019 disposition document",
        ),
        (
            ATTEMPT_020_DISPOSITION_JSON,
            ATTEMPT_020_DISPOSITION_JSON_DIGEST,
            "Attempt 020 disposition",
        ),
        (
            ATTEMPT_020_DISPOSITION_DOCUMENT,
            ATTEMPT_020_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 020 disposition document",
        ),
        (
            ATTEMPT_021_DISPOSITION_JSON,
            ATTEMPT_021_DISPOSITION_JSON_DIGEST,
            "Attempt 021 disposition",
        ),
        (
            ATTEMPT_021_DISPOSITION_DOCUMENT,
            ATTEMPT_021_DISPOSITION_DOCUMENT_DIGEST,
            "Attempt 021 disposition document",
        ),
        (
            SOCKET_PARENT_MODE_REVIEW,
            SOCKET_PARENT_MODE_REVIEW_DIGEST,
            "socket-parent mode exact review",
        ),
        (
            GATEWAY_MISSION_PROJECTION_REVIEW,
            GATEWAY_MISSION_PROJECTION_REVIEW_DIGEST,
            "Gateway mission projection diagnostic exact review",
        ),
        (
            MISSION_CONVERGENCE_REVIEW,
            MISSION_CONVERGENCE_REVIEW_DIGEST,
        ...
        (
            FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW,
            FIXED_BRIDGE_PHASE_DIAGNOSTIC_REVIEW_DIGEST,
            "fixed-bridge phase diagnostic exact review",
        ),
        (
...
def _validate_execution_checkout(
    ...
    *,
    ...
    reviewed_commit: str = ATTEMPT_013_REVIEWED_IMPLEMENTATION_COMMIT,
    ...
    runtime_paths = (
        ATTEMPT_013_RUNTIME_PATHS if runtime_paths is None else runtime_paths
    )
    control_paths = (
        ATTEMPT_013_CONTROL_PATH_ALLOWLIST if control_paths is None else control_paths
    )
...
def _validate_wiring(repo_root: Path, failures: list[str]) -> None:
    ...
    for phrase in (
        "closed consumed successful Attempt 021 gate",
        "immutable consumed Attempts 001-021",
        "budget zero",
        "all 19 authority fields false",
        "O4/LV1-003 completion",
...
def _validate_git_bindings(repo_root: Path, failures: list[str]) -> None:
    ...
    if candidate_parent_parents != [CANDIDATE_PARENT_PARENT]:
        failures.append("O4 Attempt 020 candidate parent lineage is not exact")
