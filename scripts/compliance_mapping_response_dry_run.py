"""Exercise compliance mapping response closure without recording review."""
...
from scripts import compliance_mapping_disposition_closure_check as closure

ROOT = Path(__file__).resolve().parents[1]
DOC_REL = "docs/codex/compliance-mapping-response-dry-run.md"
DOC_NAME = "compliance-mapping-response-dry-run.md"
...
def run_dry_run(repo_root: Path) -> dict[str, Any]:
    ...
    try:
        ...
        cases["valid_response_accepts"] = (
            ...
            and valid_report["erg_009_status"] == "ready_for_architecture_decision_record"
        )
        ...
        high_finding = {
            ...
            "affected_files_functions": "docs/codex/compliance-mapping-architecture.md",
...
def _valid_response(
    *,
    ...
    reviewed_packet_hash: str = "sha256:" + "9" * 64,
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin compliance mapping response dry run",
        ...
        "architecture_planning_recorded: "
        f"{str(report['architecture_planning_recorded']).lower()}",
