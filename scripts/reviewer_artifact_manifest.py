...
BASE_GENERATED_ARTIFACTS = [
    ...
    "var/review-packets/v3/enterprise-dual-review-outbox/ENTERPRISE_DUAL_REVIEW_OUTBOX_INDEX.md",
    "var/review-packets/v3/enterprise-dual-review-outbox/enterprise-dual-review-outbox-artifact-hashes.json",
    "var/review-runs/enterprise-dual-response-inbox/ENTERPRISE_DUAL_RESPONSE_INBOX.md",
    "var/review-runs/enterprise-dual-response-inbox/enterprise-dual-response-inbox-artifact-hashes.json",
