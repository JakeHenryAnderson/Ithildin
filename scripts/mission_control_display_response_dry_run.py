"""Exercise Mission Control display response closure without recording review."""
...
DOC_NAME = "mission-control-display-response-dry-run.md"
...
def _valid_response(
    *,
    ...
    reviewed_packet_hash: str = "sha256:" + "2" * 64,
...
def render_report(report: dict[str, Any]) -> str:
    lines = [
        "Ithildin Mission Control display response dry run",
        ...
        f"erg_002_closed: {str(report['erg_002_closed']).lower()}",
