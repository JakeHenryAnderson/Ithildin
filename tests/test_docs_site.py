...
def test_default_docs_include_v02_review_packet() -> None:
    ...
    assert "docs/codex/local-v1-completion-contract.md" in DEFAULT_DOCS
    assert "docs/codex/local-v1-golden-path.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/v1.0-operator-trial-record.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/mission-control-enterprise-status-fixtures.md" in DEFAULT_DOCS
    assert "docs/codex/mission-control-enterprise-status-acceptance-matrix.md" in DEFAULT_DOCS
    assert "docs/codex/mission-control-enterprise-status-reference-validator.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/production-identity-storage-response-kit.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/siem-export-adapter-external-review-bundle.md" in DEFAULT_DOCS
    assert "docs/codex/siem-export-adapter-disposition-closure-gate.md" in DEFAULT_DOCS
    assert "docs/codex/siem-export-adapter-response-dry-run.md" in DEFAULT_DOCS
    assert "docs/codex/siem-export-adapter-response-kit.md" in DEFAULT_DOCS
    assert "docs/codex/siem-export-adapter-external-response-intake.md" in DEFAULT_DOCS
    assert "docs/codex/compliance-mapping-architecture.md" in DEFAULT_DOCS
    assert "docs/codex/compliance-mapping-disposition-packet.md" in DEFAULT_DOCS
    assert "docs/codex/compliance-mapping-external-review-bundle.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/compliance-mapping-response-kit.md" in DEFAULT_DOCS
    assert "docs/codex/compliance-mapping-external-response-intake.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/sandbox-vm-static-preflight-external-review-bundle.md" in DEFAULT_DOCS
    ...
    assert "docs/codex/trusted-host-promotion-runtime-source-review.md" in DEFAULT_DOCS
