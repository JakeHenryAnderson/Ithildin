...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 014 exact six-path, one-shot authorization gate preserving immutable Attempts 001-013, consumed Attempt 013 private digest bindings, and the reviewed terminal-health phase projection repair. The real pre-tag checkout remains fail-closed with zero effective budget and all live authority false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 014 clean exact six-path child, reviewed terminal-health repair/review-record bytes, immutable consumed Attempt 013 private evidence, exact annotated Attempt 014 tag, budget one, and exactly five bounded live authority fields. Before the tag and exact candidate exist, it reports invalid, budget zero, and all live authority false.
