...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 018 one-shot gate binding the committed mission-liveness review, exact six-path candidate, annotated review tag, budget one only after exact review, and the retained five-field maximum live-authority ceiling; Attempt 017 remains permanently consumed.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the prepared Attempt 018 exact six-path candidate, committed mission-liveness review, required annotated tag, immutable consumed Attempts 001-017, one-shot budget, five-field maximum live-authority ceiling, and immediate consumed-disposition requirement. Before the tag exists it fails closed with effective budget zero and all 19 authority fields false.
