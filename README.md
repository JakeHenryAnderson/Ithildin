...
- `make review-run-manifest-refresh` - audit exact current-candidate review bindings for staleness; executed review manifests are immutable and stale candidates require a fresh review.
...
- [docs/codex/command-center-sol-ultra-closure-review-dispatch-record-internal-source-review.md](docs/codex/command-center-sol-ultra-closure-review-dispatch-record-internal-source-review.md) -
  zero-finding Sol xhigh exact-candidate review approving only the accuracy of the durable
  non-dispatch record.
- [docs/codex/command-center-review-candidate-history-separation-internal-source-review.md](docs/codex/command-center-review-candidate-history-separation-internal-source-review.md) -
  zero-finding Sol xhigh exact-candidate review of the fail-closed current-versus-historical review
  evidence separation.
...
- [docs/codex/local-v1-lv1-003-o4-two-operation-terminal-repair-exact-review.md](docs/codex/local-v1-lv1-003-o4-two-operation-terminal-repair-exact-review.md) - zero-finding Sol-high exact review of the two-affordance deterministic terminal repair; code-only GO, 24 governed tools, and all live authority false.
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed successful Attempt 021 gate preserving immutable Attempts 001-021, budget zero, all 19 authority fields false, O4/LV1-003 completion, and the user-directed pause before LV1-004/O5.
- [docs/codex/local-v1-lv1-003-o4-attempt-021-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-021-disposition.md) - digest-safe exact consumed-success evidence for the one real constrained mission; release, UAT, production, successor attempt, and O5 authority remain false.
- [docs/codex/local-v1-lv1-004-failure-recovery.md](docs/codex/local-v1-lv1-004-failure-recovery.md) - bounded implementation and reproduction contract for the completed candidate-bound restart/replay/partition/revocation/stale-configuration/manual-rollback scenario.
- [docs/codex/local-v1-lv1-004-disposition.md](docs/codex/local-v1-lv1-004-disposition.md) - digest-only binding for the passing integrated failure-and-recovery journey that closes only O5/LV1-004 and keeps all execution, release, production, and UAT authority false.
- [docs/codex/local-v1-lv1-005-disposition.md](docs/codex/local-v1-lv1-005-disposition.md) - exact implementation binding for the keyboard-accessible Command Center comprehension path that closes only O6/LV1-005 and keeps release and UAT authority false.
- [docs/codex/local-v1-lv1-006-disposition.md](docs/codex/local-v1-lv1-006-disposition.md) - digest-only binding for the exact isolated install, backup, fixed update failure, restore, recovery, and cleanup rehearsal that closes O1/O7/LV1-006 while keeping release and UAT authority false.
- [docs/codex/local-v1-lv1-003-o4-attempt-020-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-020-disposition.md) - exact consumed Attempt 020 disposition: `gateway_run_detail_invalid`, bounded Node receipt projection, cleanup complete, no raw private identities, and no Attempt 021, repair, retry, diagnosis execution, or other execution authority.
- [docs/codex/local-v1-lv1-003-o4-attempt-019-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-019-disposition.md) - exact consumed Attempt 019 disposition: `gateway_run_detail_invalid`, terminal mission projection gate passed as control-flow evidence only, Node receipt `completion_recorded` / `runner_reported_succeeded`, cleanup complete, no raw private identities, and no Attempt 020, repair, retry, or execution authority.
- [docs/codex/local-v1-lv1-003-o4-attempt-018-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-018-disposition.md) - exact consumed Attempt 018 disposition: `gateway_mission_projection_invalid`, Gateway still `runner_reported_running`, Node receipt `completion_pending` / `failed_closed` / `bridge_disconnected`, cleanup complete, no raw private identities, and no Attempt 019 or repair authority.
- [docs/codex/local-v1-lv1-003-o4-attempt-017-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-017-disposition.md) - exact consumed Attempt 017 disposition: `gateway_mission_projection_invalid`, Gateway still `runner_reported_running`, Node receipt `completion_pending` and `failed_closed`, cleanup complete, no raw private identities, and no Attempt 018 or repair authority.
- [docs/codex/local-v1-lv1-003-o4-attempt-016-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-016-disposition.md) - exact consumed Attempt 016 disposition: `gateway_mission_projection_invalid`, identity-free projection still `runner_reported_running`, cleanup complete, no raw private identities, and no Attempt 017 or repair authority.
- [docs/codex/local-v1-lv1-003-o4-attempt-015-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-015-disposition.md) - exact consumed disposition for the single Attempt 015 invocation: `gateway_mission_projection_invalid`, cleanup complete under reviewed semantics, private identities withheld, all authority false, and the next lane limited to separately reviewed bounded source diagnosis or repair rather than a root-cause or retry claim.
- [docs/codex/local-v1-lv1-003-o4-attempt-014-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-014-disposition.md) - exact consumed disposition for the single Attempt 014 invocation: `fixed_node_start_failed`, a noncanonical exited/unhealthy observation with phase `socket_parent_validation_entered`, cleanup complete under reviewed semantics, private identities withheld, all authority false, and the next lane limited to separately reviewed bounded source diagnosis or repair rather than a root-cause or retry claim.
- [docs/codex/local-v1-lv1-003-o4-attempt-013-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-013-disposition.md) - exact consumed disposition for the single Attempt 013 invocation: `fixed_node_start_failed`, a noncanonical exited/unhealthy observation with phase `not_reported`, cleanup complete under reviewed semantics, private identities withheld, all authority false, and the next lane limited to a separately reviewed terminal-health projection repair or decision rather than a root-cause or retry claim.
- [docs/codex/local-v1-lv1-003-o4-attempt-012-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-012-disposition.md) - exact fail-closed disposition for the single consumed Attempt 012 invocation: `fixed_node_start_failed`, `fixed_node_exited_observation_noncanonical`, cleanup complete under reviewed semantics, private identities withheld, all 19 authority fields false, and the next lane limited to a separately reviewed diagnosis or repair decision rather than a retry.
- [docs/codex/local-v1-lv1-003-o4-attempt-011-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-011-disposition.md) - exact consumed disposition binding candidate/tag, run/project, normalized closed diagnostic, receipt metadata, exact-run runtime/report absence, point-in-time report-base absence, and the next separately reviewed bounded refinement or repair rather than a retry or root-cause claim.
- [docs/codex/local-v1-lv1-003-o4-fixed-node-state-projection-exact-review.md](docs/codex/local-v1-lv1-003-o4-fixed-node-state-projection-exact-review.md) - durable `GO_CODE_ONLY` C0/H0/M0/L0 review of exact `2683641`, binding the closed thirteen-key sequential state projection, a 67,200-case classifier audit, exact two-path scope, 24 tools, and zero live authority while permitting only preparation of a separately reviewed Attempt 012 control record.
- [docs/codex/local-v1-lv1-003-o4-fixed-bridge-phase-diagnostic-exact-review.md](docs/codex/local-v1-lv1-003-o4-fixed-bridge-phase-diagnostic-exact-review.md) - durable `GO_CODE_ONLY` C0/H0/M0/L0 review of exact `4972606`, binding nine fixed-adapter-only last-entered phases, the closed fourteen-key sequential, nonatomic, noncausal projection, exact six runtime/test paths, unchanged command vocabulary, the superseded `NO_GO` lineage, a 4,032-case hostile-state audit, 24 tools, and zero execution authority while permitting only preparation of the separate Attempt 013 gate.
- [docs/codex/local-v1-lv1-003-o4-fixed-node-start-diagnostic-exact-review.md](docs/codex/local-v1-lv1-003-o4-fixed-node-start-diagnostic-exact-review.md) - durable final `GO` C0/H0/M0/L0 review of exact `0aee84f`, preserving the intermediate M1/L1 findings and their fixes, binding only the producer/test runtime differences from `8cd307e`, and authorizing preparation of Attempt 011 without executing it.
- [docs/codex/local-v1-lv1-003-o4-attempt-010-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-010-disposition.md) - exact consumed disposition binding the reviewed execution candidate/tag, fresh run/project, fixed-node-start failure, bounded receipt metadata, exact-run runtime/report absence, cleanup result without generic absence claims, and the next bounded fixed-node-start diagnostic preparation rather than a speculative repair or retry.
- [docs/codex/mission-command-runner-bridge-authorization-index-reconciliation-exact-review.md](docs/codex/mission-command-runner-bridge-authorization-index-reconciliation-exact-review.md) - durable `GO_CODE_ONLY` C0/H0/M0/L0 review of exact `660309b`, binding five reviewed control paths, seven accepted runtime checkpoints, rejected `7735634`/`01a38ce` `NO_GO` candidates, zero runtime drift from `8cd307e`, 24 tools, and no live authority from the review itself.
- [docs/codex/local-v1-lv1-003-o4-attempt-009-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt-009-disposition.md) - exact bounded preflight-failure disposition preserving receipts while directing the next separately reviewed lane to the known Attempt 008 run/project only, not another O4 attempt.
- [docs/codex/local-v1-lv1-003-o4-enrollment-output-projection-repair-exact-review.md](docs/codex/local-v1-lv1-003-o4-enrollment-output-projection-repair-exact-review.md) - exact review preserving the rejected M1 lineage and final zero-finding repair disposition; it permits only preparation of the separate Attempt 009 authorization.
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - producer-and-assembler contract with the exact gate-protected module invocation, fixed command/API vocabulary, actual Gateway truth, ambiguous-enrollment and unconfirmed-revocation retention, durable report rollback, bounded-inventory requirements, and the explicit same-UID Docker-context mutation nonclaim; the producer contract itself grants no execution authority, and the consumed Attempt 008 closure grants none.
...
- `make mission-command-runner-bridge-authorization-check` - strictly compare the current MCC-007 paths to the historical reviewed runtime tip as well as validating the exact reviewed commit, parent, tree, decision digest, 32-path inventory, finding lineage, code-only disposition, and false live authority.
- `make mission-command-runner-bridge-authorization-frozen-check` - validate that same frozen historical code-only authorization without claiming the old runtime tip is the current source candidate; Local-v1 milestone aggregation uses this mode while the standalone strict check remains unchanged.
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the closed Attempt 021 consumed-success disposition, immutable consumed Attempts 001-021, exact candidate/tag and digest-safe evidence bindings, budget zero, O4/LV1-003 closure, paused LV1-004/O5, and all 19 authority fields false.
- `make local-v1-lv1-003-o4-producer-static-check` - run the fake-only producer state machine, reconciled assembler contract, and execution-gate negative tests; it performs no Docker, API, provider, Node, Hermes, network, credential, or live action.
- `make local-v1-lv1-003-o4-producer-run` - **closed consumed successful Attempt 021 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It refuses before activity with budget zero and no live authority, remains outside release, milestone, and static checks, and grants no LV1-004/O5 or successor execution authority.
- `make local-v1-failure-recovery-static-check` - run only the non-live LV1-004 report, drift, rollback, stale-configuration, and partition fixtures.
- `LOCAL_V1_FAILURE_RECOVERY_EVIDENCE=<explicit-private-root> make local-v1-failure-recovery-run` - run the clean-candidate isolated loopback LV1-004 recovery journey at exactly the selected ignored root. It starts no Docker service, runner, provider, or arbitrary process.
- `make local-v1-failure-recovery-check` - validate one explicitly selected ignored recovery root against one explicit candidate; it never searches for a latest run or starts a service.
- [docs/codex/local-v1-lv1-003-o4-attempt008-port-release-attempt-001-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt008-port-release-attempt-001-disposition.md) - consumed zero-budget Attempt 001 closure for the exact `sealed_directory_invalid` pre-Docker-command failure, bound to all three owner-only receipt hashes with no inspection, mutation, port, retry, release, or UAT claim.
- [docs/codex/local-v1-lv1-003-o4-attempt008-port-release-attempt-002-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt008-port-release-attempt-002-disposition.md) - successful consumed zero-budget Attempt 002 closure bound to the exact execution candidate and all twelve owner-only receipt hashes; it records only exact API/UI stops and point-in-time loopback availability, keeps every other target `not_targeted_by_recovery`, and grants no retry, successor O4 authority, release, or UAT claim.
- [docs/codex/local-v1-lv1-003-o4-attempt008-port-release-authorization.md](docs/codex/local-v1-lv1-003-o4-attempt008-port-release-authorization.md) - closed Attempt 002 authority record with execution unavailable, an exact seven-path closure allowlist, descriptor-anchored receipt validation against the historical execution candidate, and explicit budget-zero/no-successor semantics.
- `make local-v1-lv1-003-o4-attempt008-port-release-check` - run the fake-only closure, authorization, executable-identity, journal, immutable receipt-binding, preservation, and negative tests without Docker or live access.
- `make local-v1-lv1-003-o4-attempt008-port-release-run` - retained closed operator entrypoint that now refuses before receipt consumption, socket discovery, sealed-executable creation, or Docker access because Attempt 002 is consumed and execution availability is false.
- [docs/codex/local-v1-lv1-003-o4-attempt008-node-identity-reconciliation-authorization.md](docs/codex/local-v1-lv1-003-o4-attempt008-node-identity-reconciliation-authorization.md) - one-shot authority for a descriptor-anchored, read-only projection of the exact Attempt 008 Gateway database; it excludes credentials, adjacent runtime content, Docker, revocation, quarantine, cleanup, another O4 attempt, release, and UAT.
- `make local-v1-lv1-003-o4-attempt008-node-identity-reconciliation-check` - run the fixture-only database, descriptor-race, one-shot receipt, secret-non-emission, and fail-closed projection tests without reading retained runtime or receipts.
- `make local-v1-lv1-003-o4-attempt008-node-identity-reconciliation-run` - **live, gate-protected, read-only operator entrypoint** for the exact retained database. It consumes its one-shot budget before opening the database, prints no Node identity, and grants no quarantine, revocation, cleanup, successor O4, release, or UAT authority.
- [docs/codex/local-v1-lv1-003-o4-attempt008-quarantine-revocation-authorization.md](docs/codex/local-v1-lv1-003-o4-attempt008-quarantine-revocation-authorization.md) - separately reviewed one-shot recovery authority for exact-project quiescence and descriptor-bound offline revocation of the privately reconciled Attempt 008 Node. Live execution additionally requires the fixed reviewed-candidate Git tag and a single-active-invocation lock. It grants no start, cleanup, successor O4 attempt, release, or UAT authority.
- `make local-v1-lv1-003-o4-attempt008-quarantine-revocation-check` - run fixture-only authority, Docker allowlist, durable-journal, descriptor-alias, audit-lifecycle, revocation, resume, and secret-non-emission tests without retained-runtime or Docker access.
- `make local-v1-lv1-003-o4-attempt008-quarantine-revocation-run` - **live, gate-protected, resumable one-shot operator entrypoint** for the exact retained project and private identity receipt. It uses frozen offline dependency resolution and must not run until its exact candidate is committed, pushed, independently reviewed `GO`, and bound by the fixed review tag.
- [docs/codex/local-v1-lv1-003-o4-attempt008-quarantine-revocation-attempt-001-disposition.md](docs/codex/local-v1-lv1-003-o4-attempt008-quarantine-revocation-attempt-001-disposition.md) - consumed failed-closed closure for the incorrect four-container premise. It binds the two invocation results and exact receipt hashes, records no Docker/storage/revocation mutation, closes resume and retry, preserves the old review tag and unrelated private `uv` lock, and grants no cleanup, successor O4, release, or UAT authority.
- [docs/codex/local-v1-lv1-003-o4-attempt008-two-container-revocation-authorization.md](docs/codex/local-v1-lv1-003-o4-attempt008-two-container-revocation-authorization.md) - new one-shot authority requiring exactly the public-disposition-bound API/UI containers exited while making no generic Node/Hermes absence claim. Docker is observation-only; storage mutation remains the exact descriptor-bound Node revocation and audit transition.
- `make local-v1-lv1-003-o4-attempt008-two-container-revocation-check` - run fixture-only predecessor-closure, exact-two-container, no-Docker-mutation, storage-transition, phase-reinspection, and secret-non-emission tests.
- `make local-v1-lv1-003-o4-attempt008-two-container-revocation-run` - **live, gate-protected, resumable one-shot entrypoint** using a private in-lane Docker configuration and frozen offline dependencies. It must not run before exact commit/push, independent `GO`, and fixed review-tag binding.
...
- [docs/codex/command-center-node-governed-run-correlation-data-feasibility.md](docs/codex/command-center-node-governed-run-correlation-data-feasibility.md) - bounded authority and presentation contract for correlating Node-authenticated reads into existing Agent Runs.
- [docs/codex/command-center-node-governed-run-correlation-implementation-handoff.md](docs/codex/command-center-node-governed-run-correlation-implementation-handoff.md) - implemented Gateway provenance, fleet-to-run navigation, cockpit language, and reproducible validation evidence.
- [docs/codex/command-center-node-run-origin-evidence-parity-data-feasibility.md](docs/codex/command-center-node-run-origin-evidence-parity-data-feasibility.md) - bounded same-record comparison contract for Node run detail and redacted evidence origin.
- [docs/codex/command-center-node-run-origin-evidence-parity-implementation-handoff.md](docs/codex/command-center-node-run-origin-evidence-parity-implementation-handoff.md) - explicit match, loading, unavailable, and mismatch cockpit states without independent-attestation claims.
- [docs/codex/command-center-node-configuration-cohort-data-feasibility.md](docs/codex/command-center-node-configuration-cohort-data-feasibility.md) - bounded fleet aggregation contract for loaded desired-generation and Node storage evidence.
- [docs/codex/command-center-node-configuration-cohort-implementation-handoff.md](docs/codex/command-center-node-configuration-cohort-implementation-handoff.md) - configuration cohort cockpit behavior, deterministic ordering, tests, and enforcement non-claims.
- [docs/codex/command-center-node-version-cohort-data-feasibility.md](docs/codex/command-center-node-version-cohort-data-feasibility.md) - bounded fleet aggregation contract for desired minimum and accepted-heartbeat software-version evidence.
- [docs/codex/command-center-node-version-cohort-implementation-handoff.md](docs/codex/command-center-node-version-cohort-implementation-handoff.md) - software-version cohort drill-down, attention ordering, source labels, and lifecycle non-claims.
- [docs/codex/command-center-run-evidence-revision-integrity-data-feasibility.md](docs/codex/command-center-run-evidence-revision-integrity-data-feasibility.md) - bounded selected-detail versus evidence-snapshot revision comparison using existing fields.
- [docs/codex/command-center-run-evidence-revision-integrity-implementation-handoff.md](docs/codex/command-center-run-evidence-revision-integrity-implementation-handoff.md) - fail-visible handoff mismatch state and full existing evidence-section digests.
- [docs/codex/command-center-run-evidence-digest-verification-data-feasibility.md](docs/codex/command-center-run-evidence-digest-verification-data-feasibility.md) - browser-side canonical SHA-256 comparison contract for the four existing evidence sections.
- [docs/codex/command-center-run-evidence-digest-verification-implementation-handoff.md](docs/codex/command-center-run-evidence-digest-verification-implementation-handoff.md) - fail-visible local digest verification, mismatch handling, and explicit integrity non-claims.
...
- `make live-demo-compose-smoke-observed` - after `make compose-up`, run `compose-smoke` and record the observed result in the Compose smoke evidence artifact.
...
- `make enterprise-review-send-receipt-fill ARGS="..."` - optionally fill that ignored send
  receipt from explicit operator-provided send metadata after the human send step, then validate it;
  this records send metadata only and still does not normalize responses or close lanes.
...
- [docs/codex/siem-export-adapter-compatibility-fixtures-internal-source-review.md](docs/codex/siem-export-adapter-compatibility-fixtures-internal-source-review.md) -
  exact-candidate Sol xhigh review history and final zero-finding disposition for the static corpus.
- `make siem-export-adapter-compatibility-check` - validate the 23-case offline compatibility
...
- `make sandbox-vm-live-poc-runtime-ticket-check` - validate the draft-only `ERG-004` runtime
...
- `make sandbox-vm-live-poc-runtime-implementation-gate-check` - validate the draft-only future
...
- `make sandbox-vm-live-poc-runtime-descriptor-only-implementation-ticket-check` - validate the
  descriptor-only implementation ticket for the next ERG-004 runtime checkpoint while keeping
  runtime changes in this checkpoint, live VM/container inspection, lifecycle control, Mission
...
and may reuse a current generated send package when its commit/hash evidence matches, while still
not recording review, normalizing responses, writing raw responses, or closing either lane.
...
The completed PIS-001 planning artifact is
...
and must not relabel the exact validator as green.
...
The live sandbox/VM POC runtime ticket draft is
[docs/codex/sandbox-vm-live-poc-runtime-ticket.md](docs/codex/sandbox-vm-live-poc-runtime-ticket.md)
...
The runtime implementation gate draft is
...
The runtime descriptor-only implementation ticket is
[docs/codex/sandbox-vm-live-poc-runtime-descriptor-only-implementation-ticket.md](docs/codex/sandbox-vm-live-poc-runtime-descriptor-only-implementation-ticket.md)
and is checked with `make sandbox-vm-live-poc-runtime-descriptor-only-implementation-ticket-check`;
it narrows the future descriptor/correlation implementation sprint while keeping runtime changes in
...
The ERG-005 runtime implementation decision draft is in
[docs/codex/trusted-host-promotion-runtime-implementation-decision.md](docs/codex/trusted-host-promotion-runtime-implementation-decision.md)
...
`make review-run-manifest-refresh` is a compatibility-named, local-only staleness audit for
current-candidate bindings. It never rewrites an executed review or rebinds historical reviews to
current source; a changed candidate requires a new review record.
