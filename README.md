...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - PREPARE_REVIEW execution gate binding the fixed profile, future exact-candidate requirements, one-attempt ceiling, evidence boundary, and all-false live authority.
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - implemented producer-and-assembler candidate pending exact review and separate live disposition, with fixed command/API vocabulary, actual Gateway truth, ambiguous-enrollment and unconfirmed-revocation retention, durable report rollback, bounded-inventory requirements, and the explicit same-UID Docker-context mutation nonclaim; execution remains unauthorized.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the non-authorizing future O4 gate, fixed profile/source/provider bindings, exact-review and post-review prerequisites, one-attempt ceiling, and all-false live authority.
