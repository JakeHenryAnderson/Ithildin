...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed Attempt 016 gate preserving immutable Attempts 001-015, budget zero, all 19 authority fields false, and the bounded post-Hermes Gateway mission projection observation.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 016 exact candidate/tag, identity-free projection and digest-only receipts, immutable Attempts 001-015, budget zero, all 19 authority fields false, and the separately reviewed convergence-design next-action boundary.
...
- `make local-v1-lv1-003-o4-producer-run` - **retained closed consumed Attempt 016 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It refuses before activity because budget is zero and all live authority is false. This target remains outside release, milestone, and static checks.
