...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed Attempt 015 gate preserving immutable Attempts 001-014, digest-only private evidence bindings, budget zero, and all live authority false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 015 exact candidate/tag, digest-only retained evidence, immutable Attempts 001-014, budget zero, all 19 authority fields false, and the separately reviewed next-action boundary.
...
- `make local-v1-lv1-003-o4-producer-run` - **retained closed consumed Attempt 015 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It now refuses before activity because the budget is zero and all live authority is false. This target remains outside release, milestone, and static checks.
