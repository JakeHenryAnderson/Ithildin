...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed Attempt 020 gate preserving immutable consumed Attempts 001-020, exact reviewed candidate/tag and private receipt digests, the identity-free Node projection `completion_recorded` / `runner_reported_succeeded`, budget zero, and all 19 authority fields false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the closed consumed Attempt 020 candidate/tag binding, immutable consumed Attempts 001-020, exact private receipt digests and identity-free Node projection, budget zero, recorded immediate consumed disposition, and all 19 authority fields false.
...
- `make local-v1-lv1-003-o4-producer-run` - **closed consumed Attempt 020 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It refuses before activity with budget zero and no live authority, remains outside release, milestone, and static checks, and grants no Attempt 021, repair, retry, diagnosis execution, or other execution authority.
