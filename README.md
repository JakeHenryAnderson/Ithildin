...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed Attempt 018 gate preserving immutable Attempts 001-017, budget zero, all 19 authority fields false, and bounded identity-free Gateway and Node receipt projections including terminal reason `bridge_disconnected`.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 018 exact candidate/tag, identity-free projections and stable terminal reason, digest-only receipts, immutable Attempts 001-017, budget zero, all 19 authority fields false, and the separately reviewed bounded diagnosis next-action boundary.
...
- `make local-v1-lv1-003-o4-producer-run` - **retained closed consumed Attempt 018 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It refuses before activity because budget is zero and all live authority is false. This target remains outside release, milestone, and static checks.
