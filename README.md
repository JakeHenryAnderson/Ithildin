...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - consumed Attempt 006 closure with zero attempt budget, exact retained Attempt 001-006 and recovery evidence, successful exact-run cleanup evidence, bounded API application-exit state without a root-cause guess, and all live, recovery, evidence-deletion, release, production, promotion, credential-custody, and UAT authority false.
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - producer-and-assembler contract with the exact gate-protected module invocation, fixed command/API vocabulary, actual Gateway truth, ambiguous-enrollment and unconfirmed-revocation retention, durable report rollback, bounded-inventory requirements, and the explicit same-UID Docker-context mutation nonclaim; the producer contract itself grants no execution authority, and the consumed Attempt 006 closure grants none.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 006 exact-child closure, retained Attempt 001-006 and recovery evidence, zero attempt budget, no retry, and all-false authority.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; Attempt 006 is consumed and the current closure always refuses before live work. It is not part of release, milestone, or static checks.
