...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 020 one-shot gate binding the exact two-path AgentRun provenance repair, durable `GO` review record, exact six-path candidate, required annotated review tag, and immutable consumed Attempts 001-019; before the tag exists the effective budget is zero and all 19 authority fields are false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the prepared Attempt 020 exact six-path candidate, exact reviewed AgentRun provenance repair and durable review record, immutable consumed Attempts 001-019, required annotated tag, one-shot budget, five-field maximum live-authority ceiling, and immediate consumed-disposition requirement. Before the exact tag exists it fails closed solely for the tag with effective budget zero and all 19 authority fields false.
