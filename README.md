...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed consumed Attempt 017 gate preserving immutable Attempts 001-016, budget zero, all 19 authority fields false, and both bounded identity-free Gateway and Node receipt projections.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 017 exact candidate/tag, both identity-free projections and digest-only receipts, immutable Attempts 001-016, budget zero, all 19 authority fields false, and the separately reviewed bounded diagnosis next-action boundary.
...
- `make local-v1-lv1-003-o4-producer-run` - **retained closed consumed Attempt 017 entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`. It refuses before activity because budget is zero and all live authority is false. This target remains outside release, milestone, and static checks.
