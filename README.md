...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - Attempt 008 exact-child one-shot authorization with one attempt budget, exact retained Attempt 001-007 and recovery evidence, the reviewed image-readability repair, no retry, exactly five bounded live authority fields true, and release, production, promotion, credential-custody, new-power, new-tool, and UAT authority false.
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - producer-and-assembler contract with the exact gate-protected module invocation, fixed command/API vocabulary, actual Gateway truth, ambiguous-enrollment and unconfirmed-revocation retention, durable report rollback, bounded-inventory requirements, and the explicit same-UID Docker-context mutation nonclaim; the producer contract itself grants no execution authority, and Attempt 008 authority comes only from the separate exact gate.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 008 exact-child one-shot authorization, retained Attempt 001-007 and recovery evidence, one attempt budget, no retry, and the exact five-field bounded live authority.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; Attempt 008 permits one exact supervised child and the current gate authorizes one invocation only. It is not part of release, milestone, or static checks.
