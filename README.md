...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 013 exact six-path, one-shot authorization gate preserving immutable Attempts 001-012, consumed Attempt 012 private digest bindings, the reviewed closed fourteen-key sequential fixed-bridge phase projection, and the prior five-field maximum live-authority ceiling. The real pre-tag checkout remains fail-closed with zero effective budget and all live authority false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 013 clean exact six-path child, reviewed implementation/review-record bytes, immutable consumed Attempt 012 private evidence, closed fourteen-key phase projection, exact annotated Attempt 013 tag, budget one, and exactly five bounded live authority fields. Before the tag and exact candidate exist, it reports invalid, budget zero, and all live authority false.
