...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - consumed Attempt 008 closure with zero attempt budget, exact retained Attempt 001-008 and recovery evidence, recovery required with no cleanup or Docker-absence claim, a bounded source-level enrollment-output projection defect analysis without retained raw-stdout proof, no retry, and all 19 authority fields false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 008 exact-child closure, retained Attempt 001-008 and recovery evidence, zero attempt budget, no retry, and all-false authority.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; Attempt 008 is consumed and the current closure always refuses before live work. It is not part of release, milestone, or static checks.
