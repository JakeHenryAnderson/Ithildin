...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed Attempt 013 authorization record preserving immutable Attempts 001-012, binding the consumed exact candidate and private receipts without reproducing identities, recording the closed fourteen-key sequential fixed-bridge phase projection, and keeping all 19 authority fields false with budget zero.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 013 exact eight-path closure child, reviewed implementation/review-record bytes, immutable private receipt bindings, the closed fourteen-key phase projection with `not_reported`, exact annotated Attempt 013 tag, budget zero, and all 19 authority fields false.
