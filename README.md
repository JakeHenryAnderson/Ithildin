...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - closed Attempt 001 disposition, repaired module-entrypoint binding, zero remaining attempt budget, and all-false authority pending separate exact review and a new-attempt disposition.
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - producer-and-assembler contract with the exact gate-protected module invocation, fixed command/API vocabulary, actual Gateway truth, ambiguous-enrollment and unconfirmed-revocation retention, durable report rollback, bounded-inventory requirements, and the explicit same-UID Docker-context mutation nonclaim; execution remains unauthorized.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 001 closure, repaired entrypoint binding, fixed profile/source/provider bindings, zero attempt budget, and all-false authority.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; it currently refuses because Attempt 001 is consumed and no separately reviewed repair disposition grants a new attempt. It is not part of release, milestone, or static checks.
