...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - Attempt 009 consumed closure for the exact `required_loopback_port_unavailable` preflight failure, retained Attempt 001-009 and recovery evidence, exact Attempt 009 runtime-root absence, no port/process or general Docker/runtime claim, zero attempt budget, no retry, and all 19 authority fields false; release and UAT remain false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the consumed Attempt 009 closure, exact repair and disposition digests, retained Attempt 001-009 and recovery evidence, zero attempt budget, no retry, and all 19 authority fields false.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; Attempt 009 is consumed, its budget is zero, and the current closure always refuses execution. The producer contract itself grants no execution authority. It is not part of release, milestone, or static checks.
