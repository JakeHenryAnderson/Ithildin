...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 016 exact six-path, one-shot authorization gate preserving immutable consumed Attempts 001-015 and binding the reviewed identity-free Gateway mission projection diagnostic. The real pre-tag checkout remains fail-closed with zero effective budget and all live authority false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 016 clean exact six-path child, reviewed identity-free Gateway mission projection diagnostic/review-record bytes, immutable consumed Attempts 001-015, exact annotated Attempt 016 tag, budget one, and exactly five bounded live authority fields. Before the tag and exact candidate exist, it reports invalid, budget zero, and all live authority false.
