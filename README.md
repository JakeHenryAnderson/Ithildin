...
- [docs/codex/local-v1-lv1-003-o4-producer-contract.md](docs/codex/local-v1-lv1-003-o4-producer-contract.md) - blocked future producer contract pending mandatory assembler reconciliation, with fixed command/API vocabulary, actual Gateway truth, bounded-inventory requirements, cleanup/recovery, and runtime-only unknowns; implementation and execution remain unauthorized.
...
- `make local-v1-lv1-003-o4-producer-static-check` - run only the producer-contract and execution-gate negative tests; it performs no Docker, API, provider, Node, Hermes, network, credential, or live action.
