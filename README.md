...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - Attempt 009 exact-child one-shot authorization with one attempt budget, retained Attempt 001-008 and recovery evidence, Attempt 008 recovery required with no cleanup or Docker-absence claim and without retained raw-stdout proof, a separately reviewed enrollment-output projection repair, a new isolated attempt, not a retry, cleanup, revocation, or reconciliation, producer-generated fresh run and project identity, preflight fails closed before live work, exactly five bounded live authority fields true and the other 14 false, while release and UAT remain false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 009 exact-child one-shot authorization, exact repair digests, retained Attempt 001-008 and recovery evidence, one attempt budget, no retry, five bounded live authority fields, and 14 false authority fields.
...
- `make local-v1-lv1-003-o4-producer-run` - **live, gate-protected operator entrypoint** using `uv run python -m scripts.local_v1_lv1_003_o4_producer`; Attempt 008 remains consumed and Attempt 009 permits one new isolated supervised attempt after the separately reviewed enrollment-output projection repair. The producer contract itself grants no execution authority. It is not part of release, milestone, or static checks.
