...
- [docs/codex/local-v1-lv1-003-o4-execution-authorization.md](docs/codex/local-v1-lv1-003-o4-execution-authorization.md) - prepared Attempt 015 exact six-path, one-shot authorization gate preserving immutable Attempts 001-014, consumed Attempt 014 private digest bindings, and the reviewed socket-parent mode repair. The real pre-tag checkout remains fail-closed with zero effective budget and all live authority false.
...
- `make local-v1-lv1-003-o4-execution-authorization-check` - validate the Attempt 015 clean exact six-path child, reviewed socket-parent mode repair/review-record bytes, immutable consumed Attempt 014 private evidence, exact annotated Attempt 015 tag, budget one, and exactly five bounded live authority fields. Before the tag and exact candidate exist, it reports invalid, budget zero, and all live authority false.
